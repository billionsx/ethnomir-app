...
def page_A_roles_matrix(c):
    ...
    # Отсортировано по куратору: сначала роли 01 Евгения (7 из 11), затем 04 Архитектора (4)
    roles = [
        # Группа 01 Евгений — продукт, UX, операционный контур (7 ролей)
        ...
        ("Продуктовый аналитик",       "01", [2, 1, 2, 2, 2, 3]),
        ("Контент-стратег",            "01", [1, 2, 1, 1, 3, 2]),
        ("Проектный менеджер",         "01", [2, 2, 2, 3, 3, 3]),
        # Группа 04 Архитектор данных/ИИ — платформа, данные, безопасность (4 роли)
    ...
    curators = [
        ("01", "Евгений Иванов",         "продукт, UX/UI, операционный контур"),
        ("02", "Борис Прядкин",          "коммерция, продажи, лояльность"),
        ("03", "Кирилл Романов",         "недвижимость, проектное управление"),
        ("04", "Архитектор данных / ИИ", "платформа, бэкенд, безопасность, ML"),
    ]
    cur_w = CONTENT_W / 2
    cur_row_h = 28
    ...
    c.drawString(MARGIN_L, y - 14,
                 "Партнёр 01 курирует 7 ролей (продукт и UX), партнёр 04 — 4 роли (платформа и данные). Пик — M4–M5.")
