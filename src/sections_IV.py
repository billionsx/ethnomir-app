...
def page_IV_overview(c):
    ...
    draw_page_frame(c, 36, 50, "IV · CRM · ОБЗОР")
    c.showPage()
...
def page_IV_crm_table(c):
    ...
    draw_page_frame(c, 37, 50, "IV · CRM · РЕЕСТР")
    c.showPage()
...
def page_IV_funnel(c):
    ...
    draw_page_frame(c, 38, 50, "IV · CRM · ВОРОНКА")
    c.showPage()
...
def page_IV_operations(c):
    ...
    draw_page_frame(c, 39, 50, "IV · CRM · ОПЕРАЦИИ")
    c.showPage()
...
def page_IV_money_guest(c):
    ...
    draw_page_frame(c, 40, 50, "IV · CRM · ФИНАНСЫ")
    c.showPage()
...
def page_IV_content_staff(c):
    ...
    draw_page_frame(c, 41, 50, "IV · CRM · GOVERNANCE")
    c.showPage()
