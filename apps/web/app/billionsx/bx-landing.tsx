...
function Visual({ active, delay }) {
  ...
  return (
    <div ref={containerRef} style={{width:"100%",maxWidth:960,marginTop:DS.s[12],position:"relative"}}>
      ...
      <img src="https://static.tildacdn.com/tild6633-6561-4636-b361-316432393130/billions-x-pack-moto.png" alt="BillionsX" style={{position:"absolute",top:"50%",left:"50%",width:"90%",height:"auto",objectFit:"contain",filter:"drop-shadow(0 20px 40px rgba(0,0,0,.25))",transform:`translate(calc(-50% - 30px), -50%) translateX(${mx}px) translateY(${my}px) scale(${sc})`,transformOrigin:"center center",willChange:"transform"}} />
    </div>
  );
}
    ...
    <div style={{width:"100%",minHeight:"100dvh",background:DS.bg,position:"relative"}}>
      ...
      <div style={{position:"relative",width:"100%",background:DS.bg}}>
        <div style={{position:"relative",zIndex:1,width:"100%",maxWidth:960,padding:"96px clamp(24px,6vw,48px) 48px",margin:"0 auto",display:"flex",flexDirection:"column",alignItems:"center"}}>
          ...
          <div style={{opacity:body.opacity,transform:`translateY(${body.y}px)`,transition:"opacity 1s cubic-bezier(0.215, 0.61, 0.355, 1), transform 1s cubic-bezier(0.215, 0.61, 0.355, 1)",willChange:"transform,opacity",textAlign:"center",maxWidth:720,marginTop:DS.s[6]}}>
