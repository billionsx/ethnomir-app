...
<div style={{width:140,height:140,borderRadius:70,overflow:'hidden',margin:'20px auto 16px',boxShadow:'0 4px 24px rgba(0,0,0,.12)',border:'3px solid rgba(255,255,255,.6)'}}><img src="https://cdn.vedomosti.ru/image/2017/7h/r3153/original-z3n.jpg" alt="" style={{width:'100%',height:'100%',objectFit:'cover'}}/></div>
