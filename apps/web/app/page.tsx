...
{/* ROI CHART */}
    <div className="fr-a" style={{padding:"32px 20px 0"}}>
      <Sec color="#34C759" label={"\u0424\u0418\u041D\u0410\u041D\u0421\u042B"} title={"\u041C\u043E\u0434\u0435\u043B\u044C \u0434\u043E\u0445\u043E\u0434\u043D\u043E\u0441\u0442\u0438"}/>
      <div style={{...gcs,padding:"20px 16px",overflow:"hidden"}}>
        <div style={{display:"flex",alignItems:"flex-end",height:150,gap:3,paddingBottom:28,position:"relative"}}>
          {(fmtTab===0?[80,150,250,350,420,500,550,620,700,800]:fmtTab===1?[500,650,780,880,950,1000,1080,1120,1180,1200]:[1500,1800,2000,2200,2400,2550,2700,2800,2900,3000]).map((v:number,i:number)=>{const mx=fmtTab===0?800:fmtTab===1?1200:3000;const lbl=v>=1000?(v/1000).toFixed(1)+"M":"$"+v+"K";return(<div key={i} style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",gap:2}}><div style={{fontSize:7,fontWeight:700,color:f.c,fontFamily:"-apple-system,SF Pro Text,system-ui,sans-serif",whiteSpace:"nowrap"}}>{lbl}</div><div style={{width:"100%",minHeight:6,borderRadius:4,background:"linear-gradient(180deg,"+f.c+","+f.c+"55)",height:(v/mx*110)+"px",transition:"all .7s cubic-bezier(.2,.8,.2,1)"}}/><div style={{fontSize:8,color:"rgba(60,60,67,.3)",fontFamily:"-apple-system,SF Pro Text,system-ui,sans-serif"}}>{i+1}</div></div>);})}
        </div>
        <div style={{textAlign:"center",fontSize:10,color:"rgba(60,60,67,.35)",fontFamily:"-apple-system,SF Pro Text,system-ui,sans-serif",letterSpacing:.5,textTransform:"uppercase"}}>{"\u0413\u043E\u0434 \u2192 \u041F\u0440\u0438\u0431\u044B\u043B\u044C / \u043C\u0435\u0441\u044F\u0446"}</div>
      </div>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8,marginTop:12}}>{[["\u041A\u0443\u043C\u0443\u043B\u044F\u0442\u0438\u0432\u043D\u044B\u0439",fmtTab===0?"$28M":fmtTab===1?"$115M":"$280M","#34C759"],["\u0420\u043E\u0441\u0442 \u0430\u043A\u0442\u0438\u0432\u0430",fmtTab===0?"8.8x":fmtTab===1?"6x":"7x","#5856D6"],["MOIC",fmtTab===0?"3.5x":fmtTab===1?"4.6x":"5.6x","#FF9500"]].map(([lb,vl,cl]:any,i:number)=>(<div key={i} style={{...gc,padding:"14px 10px",textAlign:"center"}}><div style={{fontSize:22,fontWeight:700,color:cl,fontFamily:"-apple-system,SF Pro Display,system-ui,sans-serif",letterSpacing:"-1px"}}>{vl}</div><div style={{fontSize:9,color:"rgba(60,60,67,.4)",fontFamily:"-apple-system,SF Pro Text,system-ui,sans-serif",marginTop:2,textTransform:"uppercase",letterSpacing:.3}}>{lb}</div></div>))}</div>
    </div>
    {/* REVENUE STRUCTURE */}
    <div className="fr-a" style={{padding:"32px 20px 0"}}>
      <Sec color="#FF9500" label={"\u0421\u0422\u0420\u0423\u041A\u0422\u0423\u0420\u0410"} title={"\u0418\u0441\u0442\u043E\u0447\u043D\u0438\u043A\u0438 \u0434\u043E\u0445\u043E\u0434\u0430"}/>
      <div style={{...gcs,padding:16,overflow:"hidden"}}>{[["\u0411\u0438\u043B\u0435\u0442\u044B \u0438 \u043C\u0435\u0440\u043E\u043F\u0440\u0438\u044F\u0442\u0438\u044F","35%","#007AFF",35],["\u041F\u0440\u043E\u0436\u0438\u0432\u0430\u043D\u0438\u0435","25%","#34C759",25],["\u0420\u0435\u0441\u0442\u043E\u0440\u0430\u043D\u044B \u0438 \u043A\u0430\u0444\u0435","20%","#FF9500",20],["\u041C\u0430\u0441\u0442\u0435\u0440-\u043A\u043B\u0430\u0441\u0441\u044B","12%","#AF52DE",12],["\u0420\u043E\u0437\u043D\u0438\u0446\u0430 \u0438 \u0441\u0443\u0432\u0435\u043D\u0438\u0440\u044B","8%","#FF2D55",8]].map(([lb,pct,cl,w]:any,i:number)=>(<div key={i} style={{display:"flex",alignItems:"center",gap:12,padding:"10px 4px",borderBottom:i<4?".5px solid rgba(60,60,67,.06)":"none"}}><div style={{width:34,fontSize:13,fontWeight:700,color:cl,fontFamily:"-apple-system,SF Pro Display,system-ui,sans-serif",textAlign:"right"}}>{pct}</div><div style={{flex:1}}><div style={{fontSize:13,fontWeight:500,color:"#000",fontFamily:"-apple-system,SF Pro Text,system-ui,sans-serif",marginBottom:4}}>{lb}</div><div style={{height:6,borderRadius:3,background:"rgba(60,60,67,.06)",overflow:"hidden"}}><div style={{height:"100%",borderRadius:3,background:cl,width:w+"%",transition:"width 1s cubic-bezier(.2,.8,.2,1)"}}/></div></div></div>))}</div>
    </div>
    {/* PARK OBJECTS */}
    <div className="fr-a" style={{padding:"32px 20px 0"}}>
      <Sec color="#007AFF" label={"\u041E\u0411\u042A\u0415\u041A\u0422\u042B"} title={"\u0427\u0442\u043E \u0432\u0445\u043E\u0434\u0438\u0442 \u0432 \u043F\u0430\u0440\u043A"}/>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>{[["\u{1F3DB}","\u042D\u0442\u043D\u043E\u0434\u0432\u043E\u0440\u044B",fmtTab===0?"5-15":fmtTab===1?"40-60":"96+"],["\u{1F3E8}","\u042D\u0442\u043D\u043E\u043E\u0442\u0435\u043B\u0438",fmtTab===0?"1-3":fmtTab===1?"5-8":"10-13"],["\u{1F37D}","\u0420\u0435\u0441\u0442\u043E\u0440\u0430\u043D\u044B",fmtTab===0?"2-4":fmtTab===1?"6-10":"12+"],["\u{1F3AD}","\u041C\u0430\u0441\u0442\u0435\u0440\u0441\u043A\u0438\u0435",fmtTab===0?"5-10":fmtTab===1?"15-25":"40+"],["\u{1F3DB}","\u041C\u0443\u0437\u0435\u0438",fmtTab===0?"1-2":fmtTab===1?"3-5":"8+"],["\u2668\uFE0F","\u0411\u0430\u043D\u0438 \u0438 \u0421\u041F\u0410",fmtTab===0?"1":fmtTab===1?"2-3":"5+"]].map(([ic,lb,cnt]:any,i:number)=>(<div key={i} style={{...gc,padding:"16px 14px",display:"flex",alignItems:"center",gap:12}}><div style={{width:42,height:42,borderRadius:12,background:"rgba(0,122,255,.06)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:20,flexShrink:0}}>{ic}</div><div><div style={{fontSize:14,fontWeight:600,color:"#000",fontFamily:"-apple-system,SF Pro Text,system-ui,sans-serif"}}>{lb}</div><div style={{fontSize:20,fontWeight:700,color:"#007AFF",fontFamily:"-apple-system,SF Pro Display,system-ui,sans-serif"}}>{cnt}</div></div></div>))}</div>
    </div>
    {/* SUPPORT */}
    <div className="fr-a" style={{padding:"32px 20px 0"}}>
      <Sec color="#AF52DE" label={"\u041F\u041E\u0414\u0414\u0415\u0420\u0416\u041A\u0410"} title={"\u0427\u0442\u043E \u043F\u043E\u043B\u0443\u0447\u0430\u0435\u0442 \u0444\u0440\u0430\u043D\u0447\u0430\u0439\u0437\u0438"}/>
      <div style={{...gcs,overflow:"hidden"}}>{[["\u{1F4D0}","\u041F\u0440\u043E\u0435\u043A\u0442\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u0435","\u041F\u043E\u043B\u043D\u044B\u0439 \u0430\u0440\u0445\u0438\u0442\u0435\u043A\u0442\u0443\u0440\u043D\u044B\u0439 \u043F\u0440\u043E\u0435\u043A\u0442 \u043F\u0430\u0440\u043A\u0430"],["\u{1F393}","\u041E\u0431\u0443\u0447\u0435\u043D\u0438\u0435","\u041F\u043E\u0434\u0433\u043E\u0442\u043E\u0432\u043A\u0430 \u043A\u043E\u043C\u0430\u043D\u0434\u044B \u0438 \u0443\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0446\u0435\u0432"],["\u{1F4CA}","\u041C\u0430\u0440\u043A\u0435\u0442\u0438\u043D\u0433","\u0421\u0442\u0440\u0430\u0442\u0435\u0433\u0438\u044F \u043F\u0440\u043E\u0434\u0432\u0438\u0436\u0435\u043D\u0438\u044F \u0438 \u0431\u0440\u0435\u043D\u0434\u0431\u0443\u043A"],["\u{1F527}","\u0422\u0435\u0445\u043D\u043E\u043B\u043E\u0433\u0438\u0438","IT-\u043F\u043B\u0430\u0442\u0444\u043E\u0440\u043C\u0430, CRM, \u043C\u043E\u0431\u0438\u043B\u044C\u043D\u043E\u0435 \u043F\u0440\u0438\u043B\u043E\u0436\u0435\u043D\u0438\u0435"],["\u{1F30D}","\u041A\u043E\u043D\u0442\u0435\u043D\u0442","96 \u044D\u0442\u043D\u043E\u0434\u0432\u043E\u0440\u043E\u0432 \u2014 \u0433\u043E\u0442\u043E\u0432\u044B\u0435 \u043A\u043E\u043D\u0446\u0435\u043F\u0446\u0438\u0438"],["\u{1F91D}","\u041A\u0443\u0440\u0430\u0442\u043E\u0440","\u041B\u0438\u0447\u043D\u044B\u0439 \u043C\u0435\u043D\u0435\u0434\u0436\u0435\u0440 \u043F\u0440\u043E\u0435\u043A\u0442\u0430 24/7"]].map(([ic,lb,desc]:any,i:number)=>(<div key={i} style={{padding:"14px 18px",display:"flex",alignItems:"center",gap:14,borderBottom:i<5?".5px solid rgba(60,60,67,.06)":"none"}}><div style={{width:38,height:38,borderRadius:10,background:"rgba(175,82,222,.06)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,flexShrink:0}}>{ic}</div><div><div style={{fontSize:14,fontWeight:600,color:"#000",fontFamily:"-apple-system,SF Pro Text,system-ui,sans-serif"}}>{lb}</div><div style={{fontSize:12,color:"rgba(60,60,67,.5)",fontFamily:"-apple-system,SF Pro Text,system-ui,sans-serif"}}>{desc}</div></div></div>))}</div>
    </div>
    {/* GEOGRAPHY */}
    <div className="fr-a" style={{padding:"32px 20px 0"}}>
      <Sec color="#FF2D55" label={"\u0413\u0415\u041E\u0413\u0420\u0410\u0424\u0418\u042F"} title={"\u0426\u0435\u043B\u0435\u0432\u044B\u0435 \u0440\u044B\u043D\u043A\u0438"}/>
      <div style={{display:"flex",gap:8,overflowX:"auto",WebkitOverflowScrolling:"touch",paddingBottom:4,scrollbarWidth:"none"}}>{[["\u{1F1F7}\u{1F1FA}","\u0420\u043E\u0441\u0441\u0438\u044F","10+ \u0433\u043E\u0440\u043E\u0434\u043E\u0432"],["\u{1F1E6}\u{1F1EA}","\u041E\u0410\u042D","2 \u043F\u0430\u0440\u043A\u0430"],["\u{1F1F9}\u{1F1F7}","\u0422\u0443\u0440\u0446\u0438\u044F","3 \u043B\u043E\u043A\u0430\u0446\u0438\u0438"],["\u{1F1EE}\u{1F1F3}","\u0418\u043D\u0434\u0438\u044F","5 \u0433\u043E\u0440\u043E\u0434\u043E\u0432"],["\u{1F1E8}\u{1F1F3}","\u041A\u0438\u0442\u0430\u0439","3+ \u043F\u0430\u0440\u043A\u0430"],["\u{1F1E7}\u{1F1F7}","\u0411\u0440\u0430\u0437\u0438\u043B\u0438\u044F","2 \u043B\u043E\u043A\u0430\u0446\u0438\u0438"]].map(([fl,nm,cnt]:any,i:number)=>(<div key={i} style={{...gc,padding:"16px 14px",minWidth:120,textAlign:"center",flexShrink:0}}><div style={{fontSize:28,marginBottom:6}}>{fl}</div><div style={{fontSize:14,fontWeight:600,color:"#000",fontFamily:"-apple-system,SF Pro Text,system-ui,sans-serif"}}>{nm}</div><div style={{fontSize:11,color:"rgba(60,60,67,.45)",fontFamily:"-apple-system,SF Pro Text,system-ui,sans-serif",marginTop:2}}>{cnt}</div></div>))}</div>
    </div>
