...
const BL='#007AFF',AC='#D4A017',FD='"-apple-system,'SF Pro Display',system-ui,sans-serif"',FT='"-apple-system,'SF Pro Text',system-ui,sans-serif"',L2='rgba(60,60,67,.60)';
const GL={background:'rgba(255,255,255,.72)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'.5px solid rgba(255,255,255,.35)',boxShadow:'inset 0 1px 0 rgba(255,255,255,.5), inset 0 -0.5px 0 rgba(0,0,0,.05), 0 2px 12px rgba(0,0,0,.06)'};
...
const metrics=[{v:'19',l:'лет истории',c:'#007AFF'},{v:'140',l:'га территории',c:'#34C759'},{v:'96',l:'стран мира',c:'#FF9500'},{v:'1M+',l:'гостей/год',c:'#AF52DE'}];
...
const monuments=[{n:'Юрий Гагарин',c:'60+ стран'},{n:'К.Циолковский и С.Королёв',c:'Калуга, Этномир'},{n:'И.Стравинский',c:'Монтрё, Швейцария'},{n:'Маленький Принц',c:'Этномир'},{n:'М.Ломоносов',c:'Этномир'},{n:'Арина Родионовна',c:'Этномир'}];
const donut=[{l:'Этнодворы',p:35,c:'#007AFF'},{l:'Отели и СПА',p:20,c:'#34C759'},{l:'Образование',p:15,c:'#FF9500'},{l:'Рестораны',p:15,c:'#AF52DE'},{l:'Музеи',p:15,c:'#5856D6'}];
return(<div style={{flex:1,overflowY:'auto',WebkitOverflowScrolling:'touch',paddingBottom:110,background:'#F2F2F7'}}>
<div style={{position:'sticky',top:0,zIndex:10,padding:'54px 20px 12px',...GL}}><div style={{display:'flex',alignItems:'center',gap:8}}><div className="tap" onClick={onClose} style={{width:32,height:32,borderRadius:22,...GL,display:'flex',alignItems:'center',justifyContent:'center'}}><svg width="10" height="18" viewBox="0 0 10 18" fill="none"><path d="M9 1L1 9l8 8" stroke="#007AFF" strokeWidth="2" strokeLinecap="round"/></svg></div><div style={{fontSize:17,fontWeight:600,fontFamily:FT}}>Наследие Этномира</div></div></div>
<div style={{padding:'0 20px 16px'}}><div style={{borderRadius:24,background:'linear-gradient(145deg,#1a1a2e 0%,#16213e 50%,#0f3460 100%)',padding:'32px 22px',position:'relative',overflow:'hidden'}}><div style={{position:'absolute',inset:0,opacity:.06,backgroundImage:'repeating-linear-gradient(45deg,#fff 0,#fff 1px,transparent 1px,transparent 12px)'}}></div><div style={{position:'relative',zIndex:1}}><div style={{display:'inline-flex',padding:'4px 12px',borderRadius:16,...GL,background:'rgba(255,255,255,.15)',marginBottom:12}}><span style={{fontSize:12,fontWeight:600,color:'#fff',fontFamily:FT}}>С 2007 ГОДА</span></div><div style={{fontSize:28,fontWeight:700,color:'#fff',fontFamily:FD,letterSpacing:'-.6px',lineHeight:1.15,marginBottom:8}}>Наследие и история</div><div style={{fontSize:15,color:'rgba(255,255,255,.75)',fontFamily:FT,lineHeight:1.45}}>Уникальное пространство диалога культур на 140 га. Проект под эгидой ЮНЕСКО.</div></div></div></div>
