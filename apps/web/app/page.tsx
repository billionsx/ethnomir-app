...
function HomeTab({onBuyTicket,onSearch,onMap,onQR,onProfile,onFranchise,onLanding,onNav}:{onBuyTicket?:()=>void,onSearch?:()=>void,onMap?:()=>void,onQR?:()=>void,onProfile?:()=>void,onNav?:(t:string,s?:string)=>void,onFranchise?:()=>void,onLanding?:(s:string)=>void}) {
  ...
  const heroSvgs = [
    '<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="s1g" cx="65%" cy="30%"><stop offset="0%" stop-color="#FFD700" stop-opacity=".5"/><stop offset="100%" stop-color="#FFD700" stop-opacity="0"/></radialGradient><linearGradient id="s1a" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#FF6B9D" stop-opacity=".15"/><stop offset="50%" stop-color="#C084FC" stop-opacity=".1"/><stop offset="100%" stop-color="#22D3EE" stop-opacity=".15"/></linearGradient></defs><rect width="390" height="400" fill="url(#s1a)" opacity=".5"/><circle cx="310" cy="80" r="50" fill="url(#s1g)"/><circle cx="195" cy="200" r="90" fill="none" stroke="#fff" stroke-width=".8" stroke-dasharray="5 4" opacity=".25"><animateTransform attributeName="transform" type="rotate" from="0 195 200" to="360 195 200" dur="60s" repeatCount="indefinite"/></circle><circle cx="195" cy="200" r="70" fill="none" stroke="#fff" stroke-width=".6" opacity=".15"><animateTransform attributeName="transform" type="rotate" from="360 195 200" to="0 195 200" dur="45s" repeatCount="indefinite"/></circle><circle cx="195" cy="200" r="110" fill="none" stroke="#fff" stroke-width=".4" stroke-dasharray="2 6" opacity=".12"><animateTransform attributeName="transform" type="rotate" from="0 195 200" to="360 195 200" dur="80s" repeatCount="indefinite"/></circle><ellipse cx="195" cy="200" rx="90" ry="35" fill="none" stroke="#fff" stroke-width=".5" opacity=".12"/><ellipse cx="195" cy="200" rx="35" ry="90" fill="none" stroke="#fff" stroke-width=".5" opacity=".12"/><g opacity=".3"><circle cx="145" cy="165" r="4" fill="#FFD700"><animate attributeName="opacity" values=".2;.6;.2" dur="3s" repeatCount="indefinite"/></circle><circle cx="245" cy="175" r="3.5" fill="#FF6B9D"><animate attributeName="opacity" values=".3;.7;.3" dur="2.5s" repeatCount="indefinite" begin=".5s"/></circle><circle cx="175" cy="245" r="3" fill="#22D3EE"><animate attributeName="opacity" values=".2;.5;.2" dur="4s" repeatCount="indefinite" begin="1s"/></circle><circle cx="225" cy="230" r="4" fill="#C084FC"><animate attributeName="opacity" values=".3;.6;.3" dur="3.5s" repeatCount="indefinite" begin=".8s"/></circle><circle cx="195" cy="155" r="3" fill="#34D399"><animate attributeName="opacity" values=".2;.7;.2" dur="2s" repeatCount="indefinite" begin="1.5s"/></circle></g><path d="M30 340 Q60 305 100 325 Q140 280 185 310 Q225 285 265 315 Q305 290 345 320 Q365 310 390 335 L390 400 L0 400 Z" fill="#fff" opacity=".06"/><rect x="55" y="300" width="18" height="40" rx="3" fill="#fff" opacity=".07"/><path d="M50 300 L64 280 L78 300Z" fill="#fff" opacity=".06"/><rect x="130" y="305" width="25" height="35" rx="2" fill="#fff" opacity=".06"/><circle cx="142" cy="293" r="12" fill="#fff" opacity=".04"/><rect x="230" y="295" width="20" height="45" rx="2" fill="#fff" opacity=".07"/><path d="M320 340 L330 285 L340 340Z" fill="#fff" opacity=".06"/><circle cx="50" cy="100" r="1.5" fill="#fff" opacity=".4"><animate attributeName="opacity" values=".1;.5;.1" dur="4s" repeatCount="indefinite"/></circle><circle cx="120" cy="60" r="1" fill="#fff" opacity=".35"><animate attributeName="opacity" values=".15;.45;.15" dur="3s" repeatCount="indefinite" begin="1s"/></circle><circle cx="350" cy="140" r="1.5" fill="#fff" opacity=".3"><animate attributeName="opacity" values=".1;.4;.1" dur="5s" repeatCount="indefinite" begin="2s"/></circle><circle cx="70" cy="180" r="1" fill="#fff" opacity=".25"><animate attributeName="opacity" values=".1;.35;.1" dur="3.5s" repeatCount="indefinite" begin=".5s"/></circle></svg>',
    '<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="s2m" cx="82%" cy="18%"><stop offset="0%" stop-color="#E8D5B7" stop-opacity=".6"/><stop offset="100%" stop-color="#E8D5B7" stop-opacity="0"/></radialGradient><linearGradient id="s2sky" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#1a1a4a" stop-opacity=".1"/><stop offset="100%" stop-color="transparent"/></linearGradient></defs><rect width="390" height="400" fill="url(#s2sky)"/><circle cx="330" cy="65" r="20" fill="#E8D5B7" opacity=".2"/><circle cx="330" cy="65" r="35" fill="url(#s2m)"/><line x1="80" y1="50" x2="40" y2="80" stroke="#fff" stroke-width="1" opacity=".3"><animate attributeName="opacity" values="0;.5;0" dur="4s" repeatCount="indefinite" begin="2s"/><animate attributeName="x1" values="80;30" dur="4s" repeatCount="indefinite" begin="2s"/><animate attributeName="y1" values="50;85" dur="4s" repeatCount="indefinite" begin="2s"/></line><rect x="20" y="180" width="65" height="220" rx="4" fill="#fff" opacity=".06"/><rect x="25" y="220" width="55" height="2" fill="#fff" opacity=".03"/><rect x="25" y="260" width="55" height="2" fill="#fff" opacity=".03"/><g><rect x="30" y="195" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".12"><animate attributeName="opacity" values=".08;.25;.08" dur="5s" repeatCount="indefinite"/></rect><rect x="48" y="195" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".2"><animate attributeName="opacity" values=".1;.3;.1" dur="4s" repeatCount="indefinite" begin="1s"/></rect><rect x="66" y="195" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".15"/><rect x="30" y="235" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".18"><animate attributeName="opacity" values=".12;.28;.12" dur="6s" repeatCount="indefinite" begin=".5s"/></rect><rect x="48" y="235" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".1"/><rect x="66" y="235" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".22"><animate attributeName="opacity" values=".1;.3;.1" dur="3.5s" repeatCount="indefinite" begin="2s"/></rect><rect x="30" y="275" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".14"><animate attributeName="opacity" values=".08;.22;.08" dur="7s" repeatCount="indefinite" begin="1.5s"/></rect><rect x="66" y="275" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".2"/></g><rect x="110" y="150" width="60" height="250" rx="4" fill="#fff" opacity=".05"/><g><rect x="120" y="168" width="8" height="10" rx="1" fill="#FFD700" opacity=".18"><animate attributeName="opacity" values=".1;.28;.1" dur="4.5s" repeatCount="indefinite"/></rect><rect x="135" y="168" width="8" height="10" rx="1" fill="#FFD700" opacity=".12"/><rect x="150" y="168" width="8" height="10" rx="1" fill="#FFD700" opacity=".22"><animate attributeName="opacity" values=".1;.32;.1" dur="5.5s" repeatCount="indefinite" begin="1s"/></rect><rect x="120" y="195" width="8" height="10" rx="1" fill="#FFD700" opacity=".15"/><rect x="135" y="195" width="8" height="10" rx="1" fill="#FFD700" opacity=".2"><animate attributeName="opacity" values=".12;.3;.12" dur="4s" repeatCount="indefinite" begin="2s"/></rect><rect x="150" y="195" width="8" height="10" rx="1" fill="#FFD700" opacity=".1"/><rect x="120" y="222" width="8" height="10" rx="1" fill="#FFD700" opacity=".2"/><rect x="150" y="222" width="8" height="10" rx="1" fill="#FFD700" opacity=".16"><animate attributeName="opacity" values=".08;.24;.08" dur="6s" repeatCount="indefinite" begin="3s"/></rect></g><rect x="210" y="210" width="55" height="190" rx="3" fill="#fff" opacity=".05"/><g><rect x="218" y="225" width="9" height="11" rx="1" fill="#FFD700" opacity=".2"><animate attributeName="opacity" values=".1;.3;.1" dur="3s" repeatCount="indefinite" begin=".3s"/></rect><rect x="238" y="225" width="9" height="11" rx="1" fill="#FFD700" opacity=".15"/><rect x="218" y="252" width="9" height="11" rx="1" fill="#FFD700" opacity=".12"/><rect x="248" y="252" width="9" height="11" rx="1" fill="#FFD700" opacity=".22"><animate attributeName="opacity" values=".1;.32;.1" dur="5s" repeatCount="indefinite" begin="1.5s"/></rect></g><rect x="300" y="235" width="55" height="165" rx="3" fill="#fff" opacity=".05"/><g><rect x="308" y="250" width="9" height="11" rx="1" fill="#FFD700" opacity=".18"/><rect x="328" y="250" width="9" height="11" rx="1" fill="#FFD700" opacity=".14"><animate attributeName="opacity" values=".08;.24;.08" dur="4s" repeatCount="indefinite" begin="2.5s"/></rect><rect x="348" y="250" width="9" height="11" rx="1" fill="#FFD700" opacity=".2"><animate attributeName="opacity" values=".12;.28;.12" dur="3.5s" repeatCount="indefinite"/></rect><rect x="308" y="278" width="9" height="11" rx="1" fill="#FFD700" opacity=".22"><animate attributeName="opacity" values=".1;.3;.1" dur="6s" repeatCount="indefinite" begin="1s"/></rect><rect x="338" y="278" width="9" height="11" rx="1" fill="#FFD700" opacity=".15"/></g><path d="M0 385 Q50 370 100 380 Q200 365 300 378 Q350 370 390 380 L390 400 L0 400Z" fill="#fff" opacity=".04"/></svg>',
    '<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="s3g" cx="55%" cy="50%"><stop offset="0%" stop-color="#fff" stop-opacity=".1"/><stop offset="100%" stop-color="#fff" stop-opacity="0"/></radialGradient><radialGradient id="s3w" cx="50%" cy="50%"><stop offset="0%" stop-color="#FF9F43" stop-opacity=".12"/><stop offset="100%" stop-color="#FF9F43" stop-opacity="0"/></radialGradient></defs><circle cx="240" cy="210" r="100" fill="url(#s3w)"/><ellipse cx="240" cy="245" rx="75" ry="25" fill="none" stroke="#fff" stroke-width="1.2" opacity=".18"/><ellipse cx="240" cy="245" rx="55" ry="18" fill="#fff" opacity=".04"/><circle cx="240" cy="230" r="42" fill="url(#s3g)"/><g opacity=".25"><path d="M215 195 Q218 165 214 140" stroke="#fff" stroke-width="1.5" fill="none" stroke-linecap="round" opacity=".6"><animate attributeName="d" values="M215 195 Q218 165 214 140;M215 195 Q220 160 212 135;M215 195 Q218 165 214 140" dur="3s" repeatCount="indefinite"/><animate attributeName="opacity" values=".3;.7;.3" dur="3s" repeatCount="indefinite"/></path><path d="M240 190 Q243 155 238 125" stroke="#fff" stroke-width="2" fill="none" stroke-linecap="round" opacity=".7"><animate attributeName="d" values="M240 190 Q243 155 238 125;M240 190 Q245 150 236 120;M240 190 Q243 155 238 125" dur="2.5s" repeatCount="indefinite" begin=".3s"/><animate attributeName="opacity" values=".4;.8;.4" dur="2.5s" repeatCount="indefinite" begin=".3s"/></path><path d="M265 195 Q262 168 267 143" stroke="#fff" stroke-width="1.2" fill="none" stroke-linecap="round" opacity=".5"><animate attributeName="d" values="M265 195 Q262 168 267 143;M265 195 Q260 163 269 138;M265 195 Q262 168 267 143" dur="3.5s" repeatCount="indefinite" begin=".6s"/><animate attributeName="opacity" values=".25;.6;.25" dur="3.5s" repeatCount="indefinite" begin=".6s"/></path></g><circle cx="80" cy="150" r="30" fill="none" stroke="#fff" stroke-width=".8" opacity=".1"/><ellipse cx="80" cy="155" rx="22" ry="8" fill="none" stroke="#fff" stroke-width=".5" opacity=".08"/><circle cx="350" cy="170" r="22" fill="none" stroke="#fff" stroke-width=".6" opacity=".08"/><rect x="150" y="300" width="180" height="2" rx="1" fill="#fff" opacity=".06"/><rect x="135" y="280" width="2" height="40" rx="1" fill="#fff" opacity=".08"/><rect x="348" y="280" width="2" height="40" rx="1" fill="#fff" opacity=".08"/><g opacity=".15"><circle cx="120" cy="330" r="3" fill="#FF6B9D"><animate attributeName="r" values="2;4;2" dur="4s" repeatCount="indefinite"/></circle><circle cx="190" cy="340" r="2.5" fill="#FFD700"><animate attributeName="r" values="1.5;3.5;1.5" dur="3s" repeatCount="indefinite" begin="1s"/></circle><circle cx="310" cy="325" r="3" fill="#34D399"><animate attributeName="r" values="2;4;2" dur="5s" repeatCount="indefinite" begin="2s"/></circle></g></svg>',
    '<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="s4g" cx="50%" cy="50%"><stop offset="0%" stop-color="#fff" stop-opacity=".08"/><stop offset="100%" stop-color="#fff" stop-opacity="0"/></radialGradient></defs><circle cx="210" cy="210" r="85" fill="url(#s4g)"/><ellipse cx="210" cy="265" rx="60" ry="18" fill="none" stroke="#fff" stroke-width="1" opacity=".18"/><ellipse cx="210" cy="265" rx="60" ry="18" fill="none" stroke="#fff" stroke-width="3" stroke-dasharray="4 8" opacity=".08"><animateTransform attributeName="transform" type="rotate" from="0 210 265" to="360 210 265" dur="4s" repeatCount="indefinite"/></ellipse><path d="M185 265 Q188 225 192 195 Q200 170 210 165 Q220 170 228 195 Q232 225 235 265" fill="none" stroke="#fff" stroke-width="1.2" opacity=".15"/><ellipse cx="210" cy="195" rx="22" ry="7" fill="none" stroke="#fff" stroke-width=".6" opacity=".1"/><path d="M195 170 Q200 145 198 130" stroke="#fff" stroke-width=".8" fill="none" opacity=".1" stroke-linecap="round"><animate attributeName="opacity" values=".05;.15;.05" dur="4s" repeatCount="indefinite"/></path><circle cx="80" cy="100" r="30" fill="none" stroke="#fff" stroke-width="1.2" stroke-dasharray="8 5" opacity=".15"><animateTransform attributeName="transform" type="rotate" from="0 80 100" to="360 80 100" dur="15s" repeatCount="indefinite"/></circle><circle cx="80" cy="100" r="18" fill="none" stroke="#fff" stroke-width=".6" stroke-dasharray="3 4" opacity=".1"><animateTransform attributeName="transform" type="rotate" from="360 80 100" to="0 80 100" dur="10s" repeatCount="indefinite"/></circle><circle cx="340" cy="130" r="22" fill="none" stroke="#fff" stroke-width="1" stroke-dasharray="6 4" opacity=".12"><animateTransform attributeName="transform" type="rotate" from="360 340 130" to="0 340 130" dur="12s" repeatCount="indefinite"/></circle><g><circle cx="0" cy="0" r="5" fill="#C084FC" opacity=".2"><animateMotion dur="8s" repeatCount="indefinite" path="M210 200 Q280 140 320 200 Q280 260 210 200"/><animate attributeName="opacity" values=".1;.35;.1" dur="8s" repeatCount="indefinite"/></circle><circle cx="0" cy="0" r="4" fill="#FF6B9D" opacity=".15"><animateMotion dur="6s" repeatCount="indefinite" path="M210 200 Q140 260 100 200 Q140 140 210 200" begin="2s"/><animate attributeName="opacity" values=".08;.25;.08" dur="6s" repeatCount="indefinite" begin="2s"/></circle><circle cx="0" cy="0" r="3.5" fill="#FFD700" opacity=".18"><animateMotion dur="10s" repeatCount="indefinite" path="M210 200 Q260 120 330 180 Q300 280 210 200" begin="4s"/><animate attributeName="opacity" values=".1;.3;.1" dur="10s" repeatCount="indefinite" begin="4s"/></circle></g><circle cx="55" cy="280" r="10" fill="#fff" opacity=".03"/><circle cx="350" cy="310" r="14" fill="#fff" opacity=".03"/><circle cx="100" cy="180" r="6" fill="#fff" opacity=".04"><animate attributeName="opacity" values=".02;.06;.02" dur="5s" repeatCount="indefinite"/></circle></svg>',
    '<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="s5f" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#fff" stop-opacity=".06"/><stop offset="100%" stop-color="#fff" stop-opacity="0"/></linearGradient></defs><path d="M20 330 L80 290 L140 295 L200 245 L260 225 L320 170 L370 130 L370 400 L20 400Z" fill="url(#s5f)"/><polyline points="20,330 80,290 140,295 200,245 260,225 320,170 370,130" fill="none" stroke="#fff" stroke-width="2.5" opacity=".25"/><polyline points="20,345 80,320 140,322 200,290 260,278 320,240 370,210" fill="none" stroke="#fff" stroke-width="1" opacity=".08" stroke-dasharray="4 3"/><g><circle cx="80" cy="290" r="4.5" fill="#fff" opacity=".25"><animate attributeName="r" values="3;5.5;3" dur="3s" repeatCount="indefinite"/></circle><circle cx="140" cy="295" r="4" fill="#fff" opacity=".22"><animate attributeName="r" values="2.5;5;2.5" dur="3.5s" repeatCount="indefinite" begin=".5s"/></circle><circle cx="200" cy="245" r="4.5" fill="#fff" opacity=".28"><animate attributeName="r" values="3;6;3" dur="2.8s" repeatCount="indefinite" begin="1s"/></circle><circle cx="260" cy="225" r="5" fill="#fff" opacity=".3"><animate attributeName="r" values="3;6;3" dur="3s" repeatCount="indefinite" begin="1.5s"/></circle><circle cx="320" cy="170" r="5.5" fill="#fff" opacity=".32"><animate attributeName="r" values="3.5;7;3.5" dur="2.5s" repeatCount="indefinite" begin="2s"/></circle><circle cx="370" cy="130" r="6" fill="#fff" opacity=".35"><animate attributeName="r" values="4;8;4" dur="2s" repeatCount="indefinite" begin="2.5s"/></circle></g><g opacity=".3"><line x1="370" y1="130" x2="380" y2="110" stroke="#fff" stroke-width="2"><animate attributeName="y2" values="120;100;120" dur="1.5s" repeatCount="indefinite"/><animate attributeName="opacity" values=".3;.6;.3" dur="1.5s" repeatCount="indefinite"/></line><line x1="370" y1="130" x2="358" y2="115" stroke="#fff" stroke-width="1.5"><animate attributeName="y2" values="122;108;122" dur="1.5s" repeatCount="indefinite"/></line></g><g opacity=".08"><rect x="40" y="340" width="35" height="60" rx="4" fill="#fff"><animate attributeName="height" values="40;60;40" dur="4s" repeatCount="indefinite"/><animate attributeName="y" values="360;340;360" dur="4s" repeatCount="indefinite"/></rect><rect x="95" y="325" width="35" height="75" rx="4" fill="#fff"><animate attributeName="height" values="55;75;55" dur="3.5s" repeatCount="indefinite" begin=".5s"/><animate attributeName="y" values="345;325;345" dur="3.5s" repeatCount="indefinite" begin=".5s"/></rect><rect x="150" y="310" width="35" height="90" rx="4" fill="#fff"><animate attributeName="height" values="70;90;70" dur="4s" repeatCount="indefinite" begin="1s"/><animate attributeName="y" values="330;310;330" dur="4s" repeatCount="indefinite" begin="1s"/></rect></g><text x="350" y="108" fill="#fff" font-size="16" font-weight="700" font-family="system-ui" opacity=".2"><animate attributeName="opacity" values=".12;.28;.12" dur="3s" repeatCount="indefinite"/>22%</text><g opacity=".12"><path d="M260 340 Q270 305 280 340" fill="#fff"/><path d="M290 340 Q300 295 310 340" fill="#fff"/><path d="M275 340 Q287 280 300 340" fill="#fff" opacity=".8"/></g></svg>',
  ];
