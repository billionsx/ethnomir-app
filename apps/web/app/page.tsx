...
function HomeTab({onBuyTicket,onSearch,onMap,onQR,onProfile,onFranchise,onLanding,onNav}:{onBuyTicket?:()=>void,onSearch?:()=>void,onMap?:()=>void,onQR?:()=>void,onProfile?:()=>void,onNav?:(t:string,s?:string)=>void,onFranchise?:()=>void,onLanding?:(s:string)=>void}) {
  ...
  const heroSvgs = [
`<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="g1" cx="72%" cy="22%"><stop offset="0%" stop-color="#FFD700" stop-opacity=".8"/><stop offset="60%" stop-color="#FF6B35" stop-opacity=".2"/><stop offset="100%" stop-color="transparent"/></radialGradient><linearGradient id="au" x1="0" y1=".3" x2="1" y2=".7"><stop offset="0%" stop-color="#C084FC" stop-opacity=".25"/><stop offset="50%" stop-color="#22D3EE" stop-opacity=".15"/><stop offset="100%" stop-color="#FF6B9D" stop-opacity=".2"/></linearGradient></defs><rect width="390" height="400" fill="url(#au)"/><path d="M0 80 Q100 40 200 90 Q300 50 390 80 L390 130 Q300 100 200 140 Q100 90 0 130Z" fill="#C084FC" opacity=".08"><animate attributeName="d" values="M0 80 Q100 40 200 90 Q300 50 390 80 L390 130 Q300 100 200 140 Q100 90 0 130Z;M0 90 Q100 50 200 80 Q300 60 390 90 L390 140 Q300 110 200 130 Q100 100 0 140Z;M0 80 Q100 40 200 90 Q300 50 390 80 L390 130 Q300 100 200 140 Q100 90 0 130Z" dur="8s" repeatCount="indefinite"/></path><path d="M0 50 Q130 20 260 60 Q330 30 390 50 L390 90 Q330 70 260 100 Q130 60 0 90Z" fill="#22D3EE" opacity=".06"><animate attributeName="d" values="M0 50 Q130 20 260 60 Q330 30 390 50 L390 90 Q330 70 260 100 Q130 60 0 90Z;M0 60 Q130 30 260 50 Q330 40 390 60 L390 100 Q330 80 260 90 Q130 70 0 100Z;M0 50 Q130 20 260 60 Q330 30 390 50 L390 90 Q330 70 260 100 Q130 60 0 90Z" dur="10s" repeatCount="indefinite"/></path><circle cx="310" cy="70" r="80" fill="url(#g1)"/><circle cx="195" cy="190" r="140" fill="none" stroke="#fff" stroke-width="1.2" stroke-dasharray="8 5" opacity=".3"><animateTransform attributeName="transform" type="rotate" from="0 195 190" to="360 195 190" dur="40s" repeatCount="indefinite"/></circle><circle cx="195" cy="190" r="110" fill="none" stroke="#fff" stroke-width="1" stroke-dasharray="5 6" opacity=".2"><animateTransform attributeName="transform" type="rotate" from="360 195 190" to="0 195 190" dur="30s" repeatCount="indefinite"/></circle><circle cx="195" cy="190" r="170" fill="none" stroke="#fff" stroke-width=".6" stroke-dasharray="3 10" opacity=".12"><animateTransform attributeName="transform" type="rotate" from="0 195 190" to="360 195 190" dur="60s" repeatCount="indefinite"/></circle><ellipse cx="195" cy="190" rx="140" ry="55" fill="none" stroke="#fff" stroke-width=".7" opacity=".15"/><ellipse cx="195" cy="190" rx="55" ry="140" fill="none" stroke="#fff" stroke-width=".7" opacity=".15"/><ellipse cx="195" cy="190" rx="100" ry="140" fill="none" stroke="#fff" stroke-width=".4" opacity=".08" transform="rotate(25 195 190)"/><circle cx="120" cy="130" r="8" fill="#FFD700" opacity=".45"><animate attributeName="r" values="5;10;5" dur="2.5s" repeatCount="indefinite"/><animate attributeName="opacity" values=".2;.55;.2" dur="2.5s" repeatCount="indefinite"/></circle><circle cx="270" cy="155" r="7" fill="#FF6B9D" opacity=".4"><animate attributeName="r" values="4;9;4" dur="3s" repeatCount="indefinite" begin=".5s"/><animate attributeName="opacity" values=".15;.5;.15" dur="3s" repeatCount="indefinite" begin=".5s"/></circle><circle cx="155" cy="260" r="6" fill="#22D3EE" opacity=".35"><animate attributeName="r" values="4;8;4" dur="3.5s" repeatCount="indefinite" begin="1s"/></circle><circle cx="250" cy="240" r="7" fill="#C084FC" opacity=".4"><animate attributeName="r" values="4;9;4" dur="2.8s" repeatCount="indefinite" begin=".7s"/></circle><circle cx="195" cy="110" r="5" fill="#34D399" opacity=".35"><animate attributeName="r" values="3;7;3" dur="2s" repeatCount="indefinite" begin="1.5s"/></circle><circle cx="95" cy="210" r="6" fill="#FB923C" opacity=".3"><animate attributeName="r" values="3;8;3" dur="4s" repeatCount="indefinite" begin="2s"/></circle><circle cx="300" cy="220" r="5" fill="#F43F5E" opacity=".3"><animate attributeName="r" values="3;7;3" dur="3s" repeatCount="indefinite" begin="1.2s"/></circle><path d="M0 320 Q30 290 70 310 Q110 270 160 300 Q200 275 240 305 Q280 278 330 308 Q360 295 390 315 L390 400 L0 400Z" fill="#fff" opacity=".1"/><path d="M0 340 Q50 320 100 335 Q160 315 220 330 Q280 312 340 332 Q370 322 390 338 L390 400 L0 400Z" fill="#fff" opacity=".06"/><rect x="35" y="280" width="24" height="42" rx="3" fill="#fff" opacity=".12"/><path d="M27 280 L47 255 L67 280Z" fill="#fff" opacity=".1"/><rect x="115" y="275" width="32" height="50" rx="2" fill="#fff" opacity=".1"/><circle cx="131" cy="260" r="16" fill="#fff" opacity=".07"/><rect x="215" y="270" width="26" height="55" rx="3" fill="#fff" opacity=".11"/><rect x="220" y="258" width="16" height="12" rx="1" fill="#fff" opacity=".08"/><path d="M305 325 L320 265 L335 325Z" fill="#fff" opacity=".1"/><path d="M312 325 L320 280 L328 325Z" fill="#fff" opacity=".06"/><circle cx="30" cy="40" r="2.5" fill="#fff"><animate attributeName="opacity" values=".15;.6;.15" dur="2s" repeatCount="indefinite"/></circle><circle cx="140" cy="30" r="2" fill="#fff"><animate attributeName="opacity" values=".1;.55;.1" dur="3s" repeatCount="indefinite" begin=".7s"/></circle><circle cx="370" cy="130" r="2.5" fill="#fff"><animate attributeName="opacity" values=".1;.5;.1" dur="2.5s" repeatCount="indefinite" begin="1.5s"/></circle><circle cx="60" cy="150" r="2" fill="#fff"><animate attributeName="opacity" values=".1;.45;.1" dur="4s" repeatCount="indefinite" begin=".3s"/></circle><circle cx="350" cy="40" r="1.5" fill="#fff"><animate attributeName="opacity" values=".1;.5;.1" dur="3.5s" repeatCount="indefinite" begin="2s"/></circle><circle cx="10" cy="200" r="1.5" fill="#fff"><animate attributeName="opacity" values=".1;.4;.1" dur="4.5s" repeatCount="indefinite" begin="3s"/></circle><circle cx="380" cy="250" r="2" fill="#fff"><animate attributeName="opacity" values=".1;.5;.1" dur="3s" repeatCount="indefinite" begin="1s"/></circle><circle cx="200" cy="25" r="1.5" fill="#fff"><animate attributeName="opacity" values=".1;.5;.1" dur="2.8s" repeatCount="indefinite" begin="2.5s"/></circle></svg>`,
`<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="g2" cx="85%" cy="12%"><stop offset="0%" stop-color="#FDE68A" stop-opacity=".7"/><stop offset="100%" stop-color="transparent"/></radialGradient></defs><circle cx="345" cy="45" r="55" fill="url(#g2)"/><circle cx="345" cy="45" r="18" fill="#FDE68A" opacity=".3"/><line x1="100" y1="30" x2="55" y2="65" stroke="#fff" stroke-width="2" stroke-linecap="round"><animate attributeName="opacity" values="0;0;.7;0;0" dur="7s" repeatCount="indefinite" begin="3s"/></line><path d="M0 290 Q50 265 110 280 Q170 255 230 275 Q290 258 350 278 Q375 268 390 280 L390 400 L0 400Z" fill="#fff" opacity=".06"/><path d="M0 310 Q80 290 160 305 Q240 285 320 300 Q370 290 390 305 L390 400 L0 400Z" fill="#fff" opacity=".04"/><rect x="140" y="200" width="80" height="90" rx="3" fill="#fff" opacity=".1"/><path d="M130 200 L180 155 L230 200Z" fill="#fff" opacity=".12"/><rect x="170" y="165" width="4" height="20" rx="1" fill="#fff" opacity=".08"/><line x1="143" y1="215" x2="217" y2="215" stroke="#fff" stroke-width=".5" opacity=".06"/><line x1="143" y1="230" x2="217" y2="230" stroke="#fff" stroke-width=".5" opacity=".06"/><line x1="143" y1="245" x2="217" y2="245" stroke="#fff" stroke-width=".5" opacity=".06"/><line x1="143" y1="260" x2="217" y2="260" stroke="#fff" stroke-width=".5" opacity=".06"/><rect x="152" y="220" width="18" height="18" rx="2" fill="#FFD700" opacity=".3"><animate attributeName="opacity" values=".15;.4;.15" dur="4s" repeatCount="indefinite"/></rect><rect x="190" y="220" width="18" height="18" rx="2" fill="#FFD700" opacity=".25"><animate attributeName="opacity" values=".12;.38;.12" dur="5s" repeatCount="indefinite" begin="1s"/></rect><rect x="152" y="250" width="18" height="18" rx="2" fill="#FFD700" opacity=".2"><animate attributeName="opacity" values=".1;.35;.1" dur="6s" repeatCount="indefinite" begin="2s"/></rect><rect x="190" y="250" width="18" height="18" rx="2" fill="#FFD700" opacity=".28"/><rect x="173" y="265" width="14" height="25" rx="2" fill="#FFD700" opacity=".15"/><circle cx="172" cy="155" r="6" fill="#fff" opacity=".08"><animate attributeName="cy" values="155;135;120;100" dur="6s" repeatCount="indefinite"/><animate attributeName="r" values="4;7;10;14" dur="6s" repeatCount="indefinite"/><animate attributeName="opacity" values=".12;.08;.04;0" dur="6s" repeatCount="indefinite"/></circle><circle cx="172" cy="155" r="5" fill="#fff" opacity=".06"><animate attributeName="cy" values="155;140;125;105" dur="6s" repeatCount="indefinite" begin="2s"/><animate attributeName="r" values="3;6;9;13" dur="6s" repeatCount="indefinite" begin="2s"/><animate attributeName="opacity" values=".1;.06;.03;0" dur="6s" repeatCount="indefinite" begin="2s"/></circle><rect x="280" y="210" width="70" height="80" rx="4" fill="#fff" opacity=".08"/><path d="M270 210 L315 170 L360 210Z" fill="#fff" opacity=".1"/><rect x="292" y="225" width="14" height="14" rx="2" fill="#FFD700" opacity=".25"><animate attributeName="opacity" values=".12;.35;.12" dur="5.5s" repeatCount="indefinite" begin=".5s"/></rect><rect x="324" y="225" width="14" height="14" rx="2" fill="#FFD700" opacity=".2"/><rect x="292" y="255" width="14" height="14" rx="2" fill="#FFD700" opacity=".18"/><rect x="324" y="255" width="14" height="14" rx="2" fill="#FFD700" opacity=".28"><animate attributeName="opacity" values=".14;.38;.14" dur="4s" repeatCount="indefinite" begin="2.5s"/></rect><rect x="25" y="235" width="55" height="60" rx="3" fill="#fff" opacity=".08"/><path d="M18 235 L52 195 L87 235Z" fill="#fff" opacity=".1"/><rect x="35" y="248" width="12" height="12" rx="2" fill="#FFD700" opacity=".22"><animate attributeName="opacity" values=".1;.3;.1" dur="4.5s" repeatCount="indefinite" begin="1.5s"/></rect><rect x="57" y="248" width="12" height="12" rx="2" fill="#FFD700" opacity=".18"/><rect x="43" y="272" width="11" height="18" rx="2" fill="#FFD700" opacity=".12"/><path d="M370 260 L385 225 L400 260Z" fill="#fff" opacity=".07"/><circle cx="385" cy="245" r="3" fill="#FFD700" opacity=".2"><animate attributeName="opacity" values=".1;.3;.1" dur="3s" repeatCount="indefinite"/></circle><path d="M100 270 L108 240 L116 270Z" fill="#fff" opacity=".06"/><path d="M100 255 L108 230 L116 255Z" fill="#fff" opacity=".05"/><path d="M248" y="265 L254 238 L260 265Z" fill="#fff" opacity=".06"/><circle cx="60" cy="120" r="4" fill="#FFD700" opacity=".35"><animate attributeName="cy" values="120;105;125;110;120" dur="8s" repeatCount="indefinite"/><animate attributeName="opacity" values=".15;.45;.15" dur="3s" repeatCount="indefinite"/></circle><circle cx="320" cy="90" r="3.5" fill="#FFD700" opacity=".3"><animate attributeName="cy" values="90;78;95;82;90" dur="7s" repeatCount="indefinite" begin="2s"/><animate attributeName="opacity" values=".1;.4;.1" dur="2.5s" repeatCount="indefinite" begin="1s"/></circle><circle cx="200" cy="80" r="3" fill="#FFD700" opacity=".25"><animate attributeName="cy" values="80;68;85;72;80" dur="9s" repeatCount="indefinite" begin="4s"/><animate attributeName="opacity" values=".1;.35;.1" dur="4s" repeatCount="indefinite" begin="2s"/></circle><circle cx="260" cy="140" r="3" fill="#FDE68A" opacity=".2"><animate attributeName="cy" values="140;128;145;132;140" dur="6s" repeatCount="indefinite" begin="1s"/><animate attributeName="opacity" values=".1;.3;.1" dur="3s" repeatCount="indefinite" begin="3s"/></circle><circle cx="50" cy="25" r="2" fill="#fff"><animate attributeName="opacity" values=".15;.5;.15" dur="3s" repeatCount="indefinite"/></circle><circle cx="160" cy="15" r="1.5" fill="#fff"><animate attributeName="opacity" values=".1;.45;.1" dur="4s" repeatCount="indefinite" begin="1s"/></circle><circle cx="240" cy="35" r="1.5" fill="#fff"><animate attributeName="opacity" values=".1;.4;.1" dur="2.5s" repeatCount="indefinite" begin="2s"/></circle></svg>`,
`<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="g3" cx="50%" cy="40%"><stop offset="0%" stop-color="#FF9F43" stop-opacity=".25"/><stop offset="100%" stop-color="transparent"/></radialGradient></defs><circle cx="195" cy="200" r="180" fill="url(#g3)"/><ellipse cx="195" cy="260" rx="130" ry="40" fill="none" stroke="#fff" stroke-width="2" opacity=".25"/><ellipse cx="195" cy="260" rx="105" ry="30" fill="#fff" opacity=".05"/><ellipse cx="195" cy="252" rx="80" ry="22" fill="#fff" opacity=".03"/><path d="M140 220 Q145 170 138 120 Q135 80 142 40" stroke="#fff" stroke-width="4" fill="none" stroke-linecap="round" opacity=".15"><animate attributeName="d" values="M140 220 Q145 170 138 120 Q135 80 142 40;M140 220 Q148 165 135 115 Q132 72 145 30;M140 220 Q145 170 138 120 Q135 80 142 40" dur="3s" repeatCount="indefinite"/><animate attributeName="opacity" values=".08;.22;.08" dur="3s" repeatCount="indefinite"/></path><path d="M175 215 Q180 155 173 100 Q170 55 178 10" stroke="#fff" stroke-width="5" fill="none" stroke-linecap="round" opacity=".2"><animate attributeName="d" values="M175 215 Q180 155 173 100 Q170 55 178 10;M175 215 Q183 148 170 92 Q167 45 180 0;M175 215 Q180 155 173 100 Q170 55 178 10" dur="2.5s" repeatCount="indefinite" begin=".3s"/><animate attributeName="opacity" values=".1;.28;.1" dur="2.5s" repeatCount="indefinite" begin=".3s"/></path><path d="M210 210 Q214 145 207 85 Q205 40 213 0" stroke="#fff" stroke-width="6" fill="none" stroke-linecap="round" opacity=".22"><animate attributeName="d" values="M210 210 Q214 145 207 85 Q205 40 213 0;M210 210 Q218 140 204 78 Q202 30 216 -10;M210 210 Q214 145 207 85 Q205 40 213 0" dur="2.8s" repeatCount="indefinite" begin=".5s"/><animate attributeName="opacity" values=".1;.3;.1" dur="2.8s" repeatCount="indefinite" begin=".5s"/></path><path d="M245 215 Q240 160 248 105 Q252 60 245 15" stroke="#fff" stroke-width="4.5" fill="none" stroke-linecap="round" opacity=".18"><animate attributeName="d" values="M245 215 Q240 160 248 105 Q252 60 245 15;M245 215 Q238 155 250 98 Q255 50 243 5;M245 215 Q240 160 248 105 Q252 60 245 15" dur="3.2s" repeatCount="indefinite" begin=".7s"/><animate attributeName="opacity" values=".08;.25;.08" dur="3.2s" repeatCount="indefinite" begin=".7s"/></path><path d="M270 222 Q265 175 272 130 Q275 90 268 50" stroke="#fff" stroke-width="3" fill="none" stroke-linecap="round" opacity=".12"><animate attributeName="d" values="M270 222 Q265 175 272 130 Q275 90 268 50;M270 222 Q263 170 275 125 Q278 82 266 40;M270 222 Q265 175 272 130 Q275 90 268 50" dur="3.5s" repeatCount="indefinite" begin="1s"/><animate attributeName="opacity" values=".06;.18;.06" dur="3.5s" repeatCount="indefinite" begin="1s"/></path><circle cx="80" cy="150" r="8" fill="#FF6B9D" opacity=".2"><animate attributeName="cy" values="150;120;155;125;150" dur="7s" repeatCount="indefinite"/><animate attributeName="opacity" values=".1;.3;.1" dur="3s" repeatCount="indefinite"/></circle><circle cx="330" cy="120" r="7" fill="#FFD700" opacity=".2"><animate attributeName="cy" values="120;95;125;100;120" dur="6s" repeatCount="indefinite" begin="1s"/><animate attributeName="opacity" values=".1;.3;.1" dur="2.5s" repeatCount="indefinite" begin="1s"/></circle><circle cx="50" cy="90" r="6" fill="#34D399" opacity=".15"><animate attributeName="cy" values="90;70;95;75;90" dur="8s" repeatCount="indefinite" begin="2s"/></circle><circle cx="360" cy="80" r="5" fill="#C084FC" opacity=".15"><animate attributeName="cy" values="80;60;85;65;80" dur="5.5s" repeatCount="indefinite" begin="3s"/></circle><circle cx="120" cy="60" r="5" fill="#FB923C" opacity=".18"><animate attributeName="cy" values="60;40;65;45;60" dur="9s" repeatCount="indefinite" begin="1.5s"/></circle><circle cx="290" cy="50" r="6" fill="#F43F5E" opacity=".15"><animate attributeName="cy" values="50;30;55;35;50" dur="7s" repeatCount="indefinite" begin="4s"/></circle><circle cx="80" cy="340" r="30" fill="#FF9F43" opacity=".06"><animate attributeName="r" values="20;35;20" dur="5s" repeatCount="indefinite"/></circle><circle cx="320" cy="330" r="25" fill="#FF9F43" opacity=".05"><animate attributeName="r" values="18;30;18" dur="4s" repeatCount="indefinite" begin="2s"/></circle></svg>`,
`<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="g4" cx="50%" cy="48%"><stop offset="0%" stop-color="#fff" stop-opacity=".15"/><stop offset="100%" stop-color="transparent"/></radialGradient></defs><circle cx="195" cy="195" r="170" fill="url(#g4)"/><ellipse cx="195" cy="280" rx="120" ry="35" fill="none" stroke="#fff" stroke-width="2" opacity=".2"/><ellipse cx="195" cy="280" rx="120" ry="35" fill="none" stroke="#fff" stroke-width="6" stroke-dasharray="12 16" opacity=".12"><animateTransform attributeName="transform" type="rotate" from="0 195 280" to="360 195 280" dur="3s" repeatCount="indefinite"/></ellipse><ellipse cx="195" cy="280" rx="85" ry="24" fill="none" stroke="#fff" stroke-width="3" stroke-dasharray="6 10" opacity=".1"><animateTransform attributeName="transform" type="rotate" from="360 195 280" to="0 195 280" dur="2s" repeatCount="indefinite"/></ellipse><ellipse cx="195" cy="280" rx="150" ry="45" fill="none" stroke="#fff" stroke-width="1" stroke-dasharray="4 12" opacity=".06"><animateTransform attributeName="transform" type="rotate" from="0 195 280" to="360 195 280" dur="5s" repeatCount="indefinite"/></ellipse><path d="M160 280 Q165 230 170 190 Q180 155 195 145 Q210 155 220 190 Q225 230 230 280" fill="none" stroke="#fff" stroke-width="2.5" opacity=".2"/><ellipse cx="195" cy="188" rx="28" ry="9" fill="none" stroke="#fff" stroke-width="1" opacity=".12"/><circle cx="60" cy="80" r="60" fill="none" stroke="#fff" stroke-width="2" stroke-dasharray="12 8" opacity=".15"><animateTransform attributeName="transform" type="rotate" from="0 60 80" to="360 60 80" dur="10s" repeatCount="indefinite"/></circle><circle cx="60" cy="80" r="38" fill="none" stroke="#fff" stroke-width="1.2" stroke-dasharray="6 6" opacity=".1"><animateTransform attributeName="transform" type="rotate" from="360 60 80" to="0 60 80" dur="7s" repeatCount="indefinite"/></circle><circle cx="350" cy="100" r="50" fill="none" stroke="#fff" stroke-width="1.5" stroke-dasharray="10 6" opacity=".12"><animateTransform attributeName="transform" type="rotate" from="360 350 100" to="0 350 100" dur="9s" repeatCount="indefinite"/></circle><circle r="8" fill="#C084FC" opacity=".35"><animateMotion dur="6s" repeatCount="indefinite" path="M195 195 Q320 100 360 195 Q320 300 195 195"/><animate attributeName="opacity" values=".15;.45;.15" dur="6s" repeatCount="indefinite"/></circle><circle r="7" fill="#FF6B9D" opacity=".3"><animateMotion dur="5s" repeatCount="indefinite" path="M195 195 Q70 280 30 195 Q70 100 195 195" begin="1.5s"/><animate attributeName="opacity" values=".12;.4;.12" dur="5s" repeatCount="indefinite" begin="1.5s"/></circle><circle r="6" fill="#FFD700" opacity=".25"><animateMotion dur="8s" repeatCount="indefinite" path="M195 195 Q280 60 370 150 Q330 310 195 195" begin="3s"/><animate attributeName="opacity" values=".1;.35;.1" dur="8s" repeatCount="indefinite" begin="3s"/></circle><circle r="7" fill="#22D3EE" opacity=".28"><animateMotion dur="5.5s" repeatCount="indefinite" path="M195 195 Q100 70 40 160 Q80 320 195 195" begin=".8s"/><animate attributeName="opacity" values=".1;.38;.1" dur="5.5s" repeatCount="indefinite" begin=".8s"/></circle><circle r="5" fill="#34D399" opacity=".2"><animateMotion dur="7s" repeatCount="indefinite" path="M195 195 Q260 50 350 120 Q300 330 195 195" begin="4s"/></circle></svg>`,
`<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="g5" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#fff" stop-opacity=".1"/><stop offset="100%" stop-color="#fff" stop-opacity="0"/></linearGradient></defs><path d="M0 360 L60 300 L120 308 L190 245 L260 218 L330 155 L390 100 L390 400 L0 400Z" fill="url(#g5)"/><polyline points="0,360 60,300 120,308 190,245 260,218 330,155 390,100" fill="none" stroke="#fff" stroke-width="3.5" opacity=".35"/><polyline points="0,375 60,340 120,345 190,305 260,285 330,240 390,200" fill="none" stroke="#fff" stroke-width="1.2" opacity=".1" stroke-dasharray="6 4"/><circle cx="60" cy="300" r="7" fill="#fff" opacity=".35"><animate attributeName="r" values="4;9;4" dur="3s" repeatCount="indefinite"/><animate attributeName="opacity" values=".15;.45;.15" dur="3s" repeatCount="indefinite"/></circle><circle cx="120" cy="308" r="6" fill="#fff" opacity=".3"><animate attributeName="r" values="3.5;8;3.5" dur="3.5s" repeatCount="indefinite" begin=".5s"/></circle><circle cx="190" cy="245" r="7" fill="#fff" opacity=".35"><animate attributeName="r" values="4;9;4" dur="2.8s" repeatCount="indefinite" begin="1s"/></circle><circle cx="260" cy="218" r="7.5" fill="#fff" opacity=".38"><animate attributeName="r" values="4;10;4" dur="3s" repeatCount="indefinite" begin="1.5s"/></circle><circle cx="330" cy="155" r="8" fill="#fff" opacity=".4"><animate attributeName="r" values="5;11;5" dur="2.5s" repeatCount="indefinite" begin="2s"/></circle><circle cx="390" cy="100" r="9" fill="#fff" opacity=".42"><animate attributeName="r" values="5;12;5" dur="2s" repeatCount="indefinite" begin="2.5s"/></circle><g opacity=".4"><line x1="380" y1="100" x2="392" y2="70" stroke="#fff" stroke-width="3"><animate attributeName="y2" values="85;60;85" dur="1.5s" repeatCount="indefinite"/></line><line x1="380" y1="100" x2="365" y2="78" stroke="#fff" stroke-width="2.5"><animate attributeName="y2" values="88;68;88" dur="1.5s" repeatCount="indefinite"/></line></g><rect x="15" y="340" width="50" height="60" rx="6" fill="#fff" opacity=".08"><animate attributeName="height" values="35;65;35" dur="4s" repeatCount="indefinite"/><animate attributeName="y" values="365;335;365" dur="4s" repeatCount="indefinite"/></rect><rect x="80" y="320" width="50" height="80" rx="6" fill="#fff" opacity=".07"><animate attributeName="height" values="55;85;55" dur="3.5s" repeatCount="indefinite" begin=".5s"/><animate attributeName="y" values="345;315;345" dur="3.5s" repeatCount="indefinite" begin=".5s"/></rect><rect x="145" y="295" width="50" height="105" rx="6" fill="#fff" opacity=".08"><animate attributeName="height" values="75;110;75" dur="4s" repeatCount="indefinite" begin="1s"/><animate attributeName="y" values="325;290;325" dur="4s" repeatCount="indefinite" begin="1s"/></rect><text x="355" y="68" fill="#fff" font-size="22" font-weight="800" font-family="system-ui" opacity=".25"><animate attributeName="opacity" values=".12;.32;.12" dur="3s" repeatCount="indefinite"/>22%</text><path d="M260 375 L272 335 L284 375Z" fill="#fff" opacity=".06"/><path d="M285 375 L300 320 L315 375Z" fill="#fff" opacity=".055"/><path d="M275 375 L290 310 L305 375Z" fill="#fff" opacity=".04"/></svg>`,
  ];
  const heroCards = [
  ...
  return (
    <div style={{flex:1,overflowY:"auto",overflowX:"hidden",WebkitOverflowScrolling:"touch",paddingBottom:100,background:"var(--bg)"}}>
      ...
      <div style={{padding:"8px 20px"}}>
        <div style={{padding:"14px 18px",borderRadius:16,background:"var(--bg2)",border:"0.5px solid var(--sep-opaque)",display:"flex",alignItems:"center",gap:12}}>
          {weather&&<><span style={{fontSize:24}}>{W_ICO[weather.code]||"\u2600\ufe0f"}</span><div style={{fontSize:22,fontWeight:700,color:"var(--label)",fontFamily:FD,minWidth:48}}>{weather.temp}{"\u00b0"}</div></>}
          <div style={{flex:1}}>
            <div style={{fontSize:14,fontWeight:600,color:"var(--label)",fontFamily:FT}}>{(()=>{const h=new Date().getHours();return h<9?"\u0411\u0443\u0434\u0435\u0442 \u043E\u0442\u043A\u0440\u044B\u0442 \u0441 9:00":(h>=21?"\u041E\u0442\u043A\u0440\u043E\u0435\u0442\u0441\u044F \u0437\u0430\u0432\u0442\u0440\u0430 \u0432 9:00":"\u041E\u0442\u043A\u0440\u044B\u0442 \u0434\u043E 21:00");})()}</div>
            <div style={{fontSize:11,color:"var(--label3)",fontFamily:FT,marginTop:1}}>{"\u042D\u0442\u043D\u043E\u043C\u0438\u0440 \u00b7 \u041A\u0430\u043B\u0443\u0436\u0441\u043A\u0430\u044F \u043E\u0431\u043B."}</div>
          </div>
        </div>
      </div>
      ...
      <div style={{padding:"6px 20px",display:"flex",gap:10}}>
        ...
        <div className="tap" onClick={()=>onNav&&onNav("passport","offers")} style={{flex:1,borderRadius:16,overflow:"hidden",position:"relative",height:140,background:"linear-gradient(135deg,#06B6D4,#8B5CF6)"}}>
          ...
          <div style={{position:"absolute",bottom:0,left:0,right:0,padding:12}}>
            ...
            <div style={{fontSize:11,color:"rgba(255,255,255,.55)",fontFamily:FT,marginTop:2}}>Детские, корп.</div>
          </div>
        </div>
      </div>
      ...
      <div style={{padding:"6px 20px",display:"flex",gap:10}}>
        ...
        <div className="tap" onClick={()=>onNav&&onNav("services","delivery")} style={{flex:1,borderRadius:16,overflow:"hidden",position:"relative",height:140,background:"linear-gradient(135deg,#F59E0B,#FBBF24)"}}>
          ...
          <div style={{position:"absolute",bottom:0,left:0,right:0,padding:12}}>
            ...
            <div style={{fontSize:11,color:"rgba(255,255,255,.55)",fontFamily:FT,marginTop:2}}>Еда в номер</div>
          </div>
        </div>
      </div>
      ...
      {/* ═══ SHOPS + RENTAL + ROOM ═══ */}
      <div style={{padding:"6px 20px",display:"flex",gap:8}}>
        <div className="tap" onClick={()=>onNav&&onNav("services","shops")} style={{flex:1,padding:"14px 10px",borderRadius:16,background:"var(--bg2)",border:"0.5px solid var(--sep-opaque)",textAlign:"center"}}>
          <div style={{fontSize:28,marginBottom:6}}>🛍️</div>
          <div style={{fontSize:11,fontWeight:600,color:"var(--label)",fontFamily:FT}}>Магазины</div>
        </div>
        <div className="tap" onClick={()=>onNav&&onNav("services","rental")} style={{flex:1,padding:"14px 10px",borderRadius:16,background:"var(--bg2)",border:"0.5px solid var(--sep-opaque)",textAlign:"center"}}>
