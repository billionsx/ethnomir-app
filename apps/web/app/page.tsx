...
<div className="tap" onClick={()=>{if(cart&&setCart){const cid='donate-'+amounts[amt];const ex=cart.find((c:any)=>c.id===cid);if(ex){setCart(cart.map((c:any)=>c.id===cid?{...c,qty:c.qty+1}:c));}else{setCart([...cart,{id:cid,cat:'donation',itemId:'donate',name:'\u041f\u043e\u0436\u0435\u0440\u0442\u0432\u043e\u0432\u0430\u043d\u0438\u0435 \u0444\u043e\u043d\u0434\u0443',emoji:'\ud83d\udc9b',qty:1,price:amounts[amt]}]);}logActivity('donate_added',{amount:amounts[amt]});}}} style={{height:50,borderRadius:16,background:GOLD,display:'flex',alignItems:'center',justifyContent:'center',cursor:'pointer'}}><span style={{fontSize:17,fontWeight:600,color:'#fff',fontFamily:FT}}>{'\u0412 \u043a\u043e\u0440\u0437\u0438\u043d\u0443 '+amounts[amt].toLocaleString()+' \u20bd'}</span></div>
<div style={{fontSize:11,color:L2,fontFamily:FT,marginTop:10}}>{'\u041f\u043e\u0436\u0435\u0440\u0442\u0432\u043e\u0432\u0430\u043d\u0438\u0435 \u0434\u043e\u0431\u0430\u0432\u0438\u0442\u0441\u044f \u0432 \u043a\u043e\u0440\u0437\u0438\u043d\u0443'}</div>
</div></div>
{/* QUOTE */}
