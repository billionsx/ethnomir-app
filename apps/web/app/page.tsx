...
function HomeTab({onBuyTicket,onSearch,onMap,onQR,onProfile,onFranchise,onLanding,onNav}:{onBuyTicket?:()=>void,onSearch?:()=>void,onMap?:()=>void,onQR?:()=>void,onProfile?:()=>void,onNav?:(t:string,s?:string)=>void,onFranchise?:()=>void,onLanding?:(s:string)=>void,cart?:CartItem[],setCart?:(c:CartItem[])=>void,userId?:string,showCartToast?:(m:string)=>void}) {
  ...
  const heroSvgs = [
`<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" style="position:absolute;inset:0;width:100%;height:100%"><defs><radialGradient id="z1" cx="75%" cy="18%"><stop offset="0%" stop-color="#FFD700" stop-opacity=".8"/><stop offset="50%" stop-color="#FF6B35" stop-opacity=".3"/><stop offset="100%" stop-color="transparent"/></radialGradient></defs><path d="M0 30 Q100 0 200 40 Q300 10 390 30 L390 100 Q300 70 200 110 Q100 60 0 100Z" fill="#C084FC" opacity=".1"><animate attributeName="d" values="M0 30 Q100 0 200 40 Q300 10 390 30 L390 100 Q300 70 200 110 Q100 60 0 100Z;M0 40 Q100 10 200 30 Q300 20 390 40 L390 110 Q300 80 200 100 Q100 70 0 110Z;M0 30 Q100 0 200 40 Q300 10 390 30 L390 100 Q300 70 200 110 Q100 60 0 100Z" dur="8s" repeatCount="indefinite"/></path><path d="M0 60 Q130 30 260 70 Q340 40 390 60 L390 140 Q340 110 260 140 Q130 100 0 140Z" fill="#22D3EE" opacity=".07"><animate attributeName="d" values="M0 60 Q130 30 260 70 Q340 40 390 60 L390 140 Q340 110 260 140 Q130 100 0 140Z;M0 70 Q130 40 260 60 Q340 50 390 70 L390 150 Q340 120 260 130 Q130 110 0 150Z;M0 60 Q130 30 260 70 Q340 40 390 60 L390 140 Q340 110 260 140 Q130 100 0 140Z" dur="10s" repeatCount="indefinite"/></path><circle cx="320" cy="60" r="90" fill="url(#z1)"/><circle cx="195" cy="170" r="160" fill="none" stroke="#fff" stroke-width="1.5" stroke-dasharray="8 5" opacity=".3"><animateTransform attributeName="transform" type="rotate" from="0 195 170" to="360 195 170" dur="40s" repeatCount="indefinite"/></circle><circle cx="195" cy="170" r="130" fill="none" stroke="#fff" stroke-width="1" stroke-dasharray="5 6" opacity=".2"><animateTransform attributeName="transform" type="rotate" from="360 195 170" to="0 195 170" dur="28s" repeatCount="indefinite"/></circle><circle cx="195" cy="170" r="190" fill="none" stroke="#fff" stroke-width=".7" stroke-dasharray="3 10" opacity=".12"><animateTransform attributeName="transform" type="rotate" from="0 195 170" to="360 195 170" dur="55s" repeatCount="indefinite"/></circle><ellipse cx="195" cy="170" rx="160" ry="60" fill="none" stroke="#fff" stroke-width=".8" opacity=".12"/><ellipse cx="195" cy="170" rx="60" ry="160" fill="none" stroke="#fff" stroke-width=".8" opacity=".12"/><circle cx="100" cy="80" r="8" fill="#FFD700" opacity=".45"><animate attributeName="r" values="5;10;5" dur="2.5s" repeatCount="indefinite"/><animate attributeName="opacity" values=".2;.55;.2" dur="2.5s" repeatCount="indefinite"/></circle><circle cx="290" cy="100" r="7" fill="#FF6B9D" opacity=".4"><animate attributeName="r" values="4;9;4" dur="3s" repeatCount="indefinite" begin=".5s"/></circle><circle cx="70" cy="190" r="6" fill="#22D3EE" opacity=".35"><animate attributeName="r" values="4;8;4" dur="3.5s" repeatCount="indefinite" begin="1s"/></circle><circle cx="320" cy="200" r="7" fill="#C084FC" opacity=".4"><animate attributeName="r" values="4;9;4" dur="2.8s" repeatCount="indefinite" begin=".7s"/></circle><circle cx="160" cy="60" r="5" fill="#34D399" opacity=".35"><animate attributeName="r" values="3;7;3" dur="2s" repeatCount="indefinite" begin="1.5s"/></circle><circle cx="240" cy="280" r="6" fill="#FB923C" opacity=".3"><animate attributeName="r" values="3;8;3" dur="4s" repeatCount="indefinite" begin="2s"/></circle><circle cx="50" cy="300" r="5" fill="#F43F5E" opacity=".3"><animate attributeName="r" values="3;7;3" dur="3s" repeatCount="indefinite" begin="1.2s"/></circle><path d="M0 300 Q50 270 110 290 Q170 255 240 280 Q310 262 390 290 L390 400 L0 400Z" fill="#fff" opacity=".1"/><path d="M0 330 Q70 310 140 325 Q210 305 280 320 Q350 308 390 325 L390 400 L0 400Z" fill="#fff" opacity=".07"/><path d="M0 355 Q100 340 200 350 Q300 338 390 355 L390 400 L0 400Z" fill="#fff" opacity=".05"/><rect x="40" y="260" width="24" height="60" rx="3" fill="#fff" opacity=".14"/><path d="M30 260 L52 228 L74 260Z" fill="#fff" opacity=".12"/><rect x="130" y="255" width="32" height="65" rx="2" fill="#fff" opacity=".12"/><circle cx="146" cy="240" r="16" fill="#fff" opacity=".08"/><rect x="240" y="250" width="26" height="70" rx="3" fill="#fff" opacity=".13"/><rect x="246" y="238" width="14" height="12" rx="1" fill="#fff" opacity=".08"/><path d="M330" y="335 L345 275 L360 335Z" fill="#fff" opacity=".09"/><circle cx="30" cy="15" r="2.5" fill="#fff"><animate attributeName="opacity" values=".15;.6;.15" dur="2s" repeatCount="indefinite"/></circle><circle cx="150" cy="10" r="2" fill="#fff"><animate attributeName="opacity" values=".1;.55;.1" dur="3s" repeatCount="indefinite" begin=".7s"/></circle><circle cx="380" cy="30" r="2" fill="#fff"><animate attributeName="opacity" values=".1;.5;.1" dur="2.5s" repeatCount="indefinite" begin="1.5s"/></circle><circle cx="60" cy="45" r="1.5" fill="#fff"><animate attributeName="opacity" values=".1;.45;.1" dur="4s" repeatCount="indefinite" begin=".3s"/></circle><circle cx="250" cy="20" r="1.5" fill="#fff"><animate attributeName="opacity" values=".1;.5;.1" dur="3.5s" repeatCount="indefinite" begin="2s"/></circle></svg>`,
`<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" style="position:absolute;inset:0;width:100%;height:100%"><defs><radialGradient id="z2" cx="85%" cy="10%"><stop offset="0%" stop-color="#FDE68A" stop-opacity=".8"/><stop offset="100%" stop-color="transparent"/></radialGradient></defs><circle cx="345" cy="40" r="60" fill="url(#z2)"/><circle cx="345" cy="40" r="20" fill="#FDE68A" opacity=".3"/><line x1="100" y1="20" x2="55" y2="55" stroke="#fff" stroke-width="2" stroke-linecap="round"><animate attributeName="opacity" values="0;0;.7;0;0" dur="7s" repeatCount="indefinite" begin="3s"/></line><circle cx="40" cy="15" r="2" fill="#fff"><animate attributeName="opacity" values=".15;.5;.15" dur="3s" repeatCount="indefinite"/></circle><circle cx="170" cy="10" r="1.5" fill="#fff"><animate attributeName="opacity" values=".1;.45;.1" dur="4s" repeatCount="indefinite" begin="1s"/></circle><circle cx="260" cy="25" r="1.5" fill="#fff"><animate attributeName="opacity" values=".1;.4;.1" dur="2.5s" repeatCount="indefinite" begin="2s"/></circle><circle cx="70" cy="80" r="4" fill="#FFD700" opacity=".35"><animate attributeName="cy" values="80;60;90;65;80" dur="8s" repeatCount="indefinite"/><animate attributeName="opacity" values=".15;.5;.15" dur="3s" repeatCount="indefinite"/></circle><circle cx="310" cy="60" r="3.5" fill="#FFD700" opacity=".3"><animate attributeName="cy" values="60;45;70;50;60" dur="7s" repeatCount="indefinite" begin="2s"/><animate attributeName="opacity" values=".1;.45;.1" dur="2.5s" repeatCount="indefinite" begin="1s"/></circle><circle cx="200" cy="50" r="3" fill="#FFD700" opacity=".25"><animate attributeName="cy" values="50;35;58;40;50" dur="9s" repeatCount="indefinite" begin="4s"/><animate attributeName="opacity" values=".1;.4;.1" dur="4s" repeatCount="indefinite" begin="2s"/></circle><circle cx="140" cy="110" r="3" fill="#FDE68A" opacity=".2"><animate attributeName="cy" values="110;95;118;100;110" dur="6s" repeatCount="indefinite" begin="1s"/><animate attributeName="opacity" values=".1;.35;.1" dur="3s" repeatCount="indefinite" begin="3s"/></circle><path d="M0 240 Q50 210 110 228 Q170 200 230 222 Q290 205 350 225 Q375 215 390 228 L390 400 L0 400Z" fill="#fff" opacity=".07"/><path d="M0 260 Q80 240 160 255 Q240 235 320 250 Q370 240 390 255 L390 400 L0 400Z" fill="#fff" opacity=".05"/><path d="M0 290 Q100 275 200 285 Q300 272 390 288 L390 400 L0 400Z" fill="#fff" opacity=".04"/><path d="M0 330 Q100 318 200 325 Q300 315 390 330 L390 400 L0 400Z" fill="#fff" opacity=".03"/><rect x="130" y="170" width="100" height="115" rx="3" fill="#fff" opacity=".13"/><path d="M118 170 L180 110 L242 170Z" fill="#fff" opacity=".15"/><rect x="173" y="132" width="5" height="30" rx="1" fill="#fff" opacity=".1"/><line x1="138" y1="200" x2="222" y2="200" stroke="#fff" stroke-width=".7" opacity=".06"/><line x1="138" y1="218" x2="222" y2="218" stroke="#fff" stroke-width=".7" opacity=".06"/><line x1="138" y1="236" x2="222" y2="236" stroke="#fff" stroke-width=".7" opacity=".06"/><line x1="138" y1="254" x2="222" y2="254" stroke="#fff" stroke-width=".7" opacity=".06"/><rect x="150" y="200" width="20" height="20" rx="2" fill="#FFD700" opacity=".35"><animate attributeName="opacity" values=".15;.45;.15" dur="4s" repeatCount="indefinite"/></rect><rect x="190" y="200" width="20" height="20" rx="2" fill="#FFD700" opacity=".28"><animate attributeName="opacity" values=".12;.4;.12" dur="5s" repeatCount="indefinite" begin="1s"/></rect><rect x="150" y="240" width="20" height="20" rx="2" fill="#FFD700" opacity=".22"><animate attributeName="opacity" values=".1;.38;.1" dur="6s" repeatCount="indefinite" begin="2s"/></rect><rect x="190" y="240" width="20" height="20" rx="2" fill="#FFD700" opacity=".32"/><rect x="172" y="258" width="16" height="22" rx="2" fill="#FFD700" opacity=".15"/><circle cx="176" cy="120" r="7" fill="#fff" opacity=".1"><animate attributeName="cy" values="120;80;40;0" dur="5s" repeatCount="indefinite"/><animate attributeName="r" values="5;10;16;22" dur="5s" repeatCount="indefinite"/><animate attributeName="opacity" values=".15;.1;.05;0" dur="5s" repeatCount="indefinite"/></circle><circle cx="176" cy="120" r="5" fill="#fff" opacity=".08"><animate attributeName="cy" values="120;85;45;5" dur="5s" repeatCount="indefinite" begin="2s"/><animate attributeName="r" values="4;8;14;20" dur="5s" repeatCount="indefinite" begin="2s"/><animate attributeName="opacity" values=".12;.08;.04;0" dur="5s" repeatCount="indefinite" begin="2s"/></circle><rect x="280" y="195" width="75" height="85" rx="4" fill="#fff" opacity=".09"/><path d="M268 195 L318 150 L368 195Z" fill="#fff" opacity=".11"/><rect x="295" y="210" width="16" height="16" rx="2" fill="#FFD700" opacity=".28"><animate attributeName="opacity" values=".12;.38;.12" dur="5.5s" repeatCount="indefinite" begin=".5s"/></rect><rect x="330" y="210" width="16" height="16" rx="2" fill="#FFD700" opacity=".22"/><rect x="295" y="244" width="16" height="16" rx="2" fill="#FFD700" opacity=".18"/><rect x="330" y="244" width="16" height="16" rx="2" fill="#FFD700" opacity=".3"><animate attributeName="opacity" values=".14;.4;.14" dur="4s" repeatCount="indefinite" begin="2.5s"/></rect><rect x="20" y="215" width="60" height="65" rx="3" fill="#fff" opacity=".09"/><path d="M12 215 L50 175 L88 215Z" fill="#fff" opacity=".11"/><rect x="30" y="228" width="14" height="14" rx="2" fill="#FFD700" opacity=".25"><animate attributeName="opacity" values=".1;.35;.1" dur="4.5s" repeatCount="indefinite" begin="1.5s"/></rect><rect x="56" y="228" width="14" height="14" rx="2" fill="#FFD700" opacity=".2"/><path d="M100" y="255 L110 225 L120 255Z" fill="#fff" opacity=".07"/><path d="M100 240 L110 215 L120 240Z" fill="#fff" opacity=".06"/><path d="M250 260 L258 232 L266 260Z" fill="#fff" opacity=".06"/></svg>`,
...
`<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" style="position:absolute;inset:0;width:100%;height:100%"><defs><linearGradient id="z5" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#fff" stop-opacity=".1"/><stop offset="100%" stop-color="#fff" stop-opacity="0"/></linearGradient></defs><path d="M0 380 L55 320 L120 328 L190 260 L260 230 L330 150 L390 60 L390 400 L0 400Z" fill="url(#z5)"/><polyline points="0,380 55,320 120,328 190,260 260,230 330,150 390,60" fill="none" stroke="#fff" stroke-width="3.5" opacity=".35"/><polyline points="0,390 55,355 120,360 190,310 260,290 330,235 390,170" fill="none" stroke="#fff" stroke-width="1.2" opacity=".1" stroke-dasharray="6 4"/><circle cx="55" cy="320" r="7" fill="#fff" opacity=".35"><animate attributeName="r" values="4;9;4" dur="3s" repeatCount="indefinite"/></circle><circle cx="120" cy="328" r="6" fill="#fff" opacity=".3"><animate attributeName="r" values="3.5;8;3.5" dur="3.5s" repeatCount="indefinite" begin=".5s"/></circle><circle cx="190" cy="260" r="7" fill="#fff" opacity=".35"><animate attributeName="r" values="4;9;4" dur="2.8s" repeatCount="indefinite" begin="1s"/></circle><circle cx="260" cy="230" r="8" fill="#fff" opacity=".38"><animate attributeName="r" values="4;10;4" dur="3s" repeatCount="indefinite" begin="1.5s"/></circle><circle cx="330" cy="150" r="9" fill="#fff" opacity=".4"><animate attributeName="r" values="5;12;5" dur="2.5s" repeatCount="indefinite" begin="2s"/></circle><circle cx="390" cy="60" r="10" fill="#fff" opacity=".42"><animate attributeName="r" values="5;13;5" dur="2s" repeatCount="indefinite" begin="2.5s"/></circle><g opacity=".4"><line x1="385" y1="60" x2="390" y2="28" stroke="#fff" stroke-width="3"><animate attributeName="y2" values="40;18;40" dur="1.5s" repeatCount="indefinite"/></line><line x1="385" y1="60" x2="370" y2="38" stroke="#fff" stroke-width="2.5"><animate attributeName="y2" values="48;28;48" dur="1.5s" repeatCount="indefinite"/></line></g><rect x="15" y="340" width="50" height="60" rx="6" fill="#fff" opacity=".08"><animate attributeName="height" values="35;65;35" dur="4s" repeatCount="indefinite"/><animate attributeName="y" values="365;335;365" dur="4s" repeatCount="indefinite"/></rect><rect x="80" y="318" width="50" height="82" rx="6" fill="#fff" opacity=".07"><animate attributeName="height" values="55;88;55" dur="3.5s" repeatCount="indefinite" begin=".5s"/><animate attributeName="y" values="345;312;345" dur="3.5s" repeatCount="indefinite" begin=".5s"/></rect><rect x="145" y="295" width="50" height="105" rx="6" fill="#fff" opacity=".08"><animate attributeName="height" values="75;112;75" dur="4s" repeatCount="indefinite" begin="1s"/><animate attributeName="y" values="325;288;325" dur="4s" repeatCount="indefinite" begin="1s"/></rect><text x="358" y="35" fill="#fff" font-size="24" font-weight="800" font-family="system-ui" opacity=".25"><animate attributeName="opacity" values=".12;.32;.12" dur="3s" repeatCount="indefinite"/>22%</text><path d="M260 375 L275 330 L290 375Z" fill="#fff" opacity=".06"/><path d="M290 375 L308 315 L326 375Z" fill="#fff" opacity=".055"/><path d="M278 375 L295 305 L312 375Z" fill="#fff" opacity=".04"/></svg>`,
  ];
  const heroCards = [
    ...
    <div style={{flex:1,overflowY:"auto",overflowX:"hidden",WebkitOverflowScrolling:"touch",paddingBottom:100,background:"var(--bg)"}}>
      ...
      <div style={{padding:"10px 20px 0",display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
        ...
        <div className="tap" onClick={()=>onNav&&onNav("services","delivery")} style={{borderRadius:16,overflow:"hidden",position:"relative",height:150,background:"linear-gradient(135deg,#f6d365,#fda085)"}}>
          ...
          <div style={{position:"absolute",bottom:0,left:0,right:0,padding:"14px"}}>
            ...
            <div style={{fontSize:11,color:"rgba(255,255,255,.7)",fontFamily:FT}}>Еда в номер</div>
          </div>
        </div>
      </div>
      ...
      <div style={{padding:"10px 20px 0",display:"flex",gap:10,justifyContent:"space-between"}}>
        {[{e:"🛍️",l:"Магазины",s:"services",sub:"shops"},{e:"🚲",l:"Прокат",s:"services",sub:"rental"},{e:"🛎️",l:"В номер",s:"stay",sub:"guest"}].map((q,i)=>(
          <div key={i} className="tap" onClick={()=>onNav&&onNav(q.s as any,q.sub)} style={{flex:1,padding:"16px 8px",borderRadius:16,background:"var(--bg2)",border:"0.5px solid var(--sep-opaque)",textAlign:"center"}}>
...
function OrderView({code,onBack}:{code:string,onBack:()=>void}) {
  ...
  const statusMap:Record<string,{l:string,c:string}>={pending:{l:"Ожидает оплаты",c:"#FF9F0A"},confirmed:{l:"Подтверждён",c:"#34C759"},paid:{l:"Оплачен",c:"#34C759"},completed:{l:"Завершён",c:"#007AFF"},cancelled:{l:"Отменён",c:"#FF3B30"},refunded:{l:"Возврат",c:"#8E8E93"}};
  ...
  const typeLabel:Record<string,string>={hotel:"Проживание",ticket:"Входной билет",tour:"Экскурсия",masterclass:"Мастер-класс",food:"Заказ еды",delivery:"Доставка",service:"Услуга",certificate:"Сертификат",cart:"Заказ",services:"Услуга",housing:"Проживание",tickets:"Входной билет",other:"Заказ"};
  const sectionIcon:Record<string,string>={hotel:"🏨",ticket:"🎟",tour:"🧭",masterclass:"🎨",food:"🍽",delivery:"🍽",service:"🛎",certificate:"🎁",housing:"🏨",tickets:"🎟",services:"🛎",cart:"🧾"};
  ...
  const ot=order.type||order.category||"other";
  const icon=sectionIcon[ot]||"🧾";
  const label=typeLabel[ot]||"Заказ";
  const detailLabel=(ot==="hotel"||ot==="housing")?"проживания":(ot==="ticket"||ot==="tickets")?"билета":ot==="tour"?"экскурсии":ot==="masterclass"?"мастер-класса":(ot==="food"||ot==="delivery")?"заказа":ot==="certificate"?"сертификата":"заказа";
  ...
  const Row=({k,v}:{k:string,v:any})=>v?<div style={{display:"flex",justifyContent:"space-between",padding:"7px 0",borderBottom:"0.5px solid rgba(60,60,67,.06)",fontSize:13}}><span style={{color:"rgba(60,60,67,.55)"}}>{k}</span><span style={{fontWeight:500,color:"#000",textAlign:"right",maxWidth:"60%"}}>{String(v)}</span></div>:null;
  const Sec=({t}:{t:string})=><div style={{fontSize:10,fontWeight:700,color:"rgba(60,60,67,.35)",letterSpacing:"1.5px",textTransform:"uppercase",marginBottom:10}}>{t}</div>;
  const Card=({children,style}:{children:any,style?:any})=><div style={{borderRadius:16,background:"#fff",boxShadow:"0 1px 8px rgba(0,0,0,.05)",padding:16,marginBottom:8,...style}}>{children}</div>;
  return(
    <div style={{minHeight:"100vh",background:"#F2F2F7",fontFamily:FT}}>
      <div style={{background:"linear-gradient(180deg,#1a1a2e 0%,#16213e 100%)",padding:"24px 20px 20px",textAlign:"center",position:"relative"}}>
        ...
        <div style={{fontSize:12,fontWeight:600,color:"rgba(255,255,255,.5)",letterSpacing:"3px",textTransform:"uppercase",marginBottom:4}}>Этномир</div>
        <div style={{fontSize:13,color:"rgba(255,255,255,.6)",marginBottom:12}}>Электронный билет</div>
        <div style={{display:"inline-flex",alignItems:"center",gap:6,padding:"5px 14px",borderRadius:20,background:s.c+"25",border:"1px solid "+s.c+"40"}}><div style={{width:6,height:6,borderRadius:3,background:s.c}}/><span style={{fontSize:12,fontWeight:600,color:s.c}}>{s.l}</span></div>
      </div>
      <div style={{margin:"-12px 12px 0",position:"relative",zIndex:1,paddingBottom:16}}>
        ...
        <div style={{position:"relative",margin:"4px -12px 4px"}}><div style={{borderTop:"2px dashed rgba(60,60,67,.1)"}}/><div style={{position:"absolute",left:-7,top:-8,width:14,height:14,borderRadius:7,background:"#F2F2F7"}}/><div style={{position:"absolute",right:-7,top:-8,width:14,height:14,borderRadius:7,background:"#F2F2F7"}}/></div>

        {(ot==="hotel"||ot==="housing")&&(m.date_from||m.nights||m.guests)&&<Card><Sec t={"🏨 Детали "+detailLabel}/>
          <Row k="Заезд" v={m.date_from?fd(m.date_from)+(m.check_in?" в "+m.check_in:""):null}/>
          <Row k="Выезд" v={m.date_to?fd(m.date_to)+(m.check_out?" в "+m.check_out:""):null}/>
          <Row k="Ночей" v={m.nights}/>
          <Row k="Взрослые" v={m.guests}/>
          {m.children>0&&<Row k="Дети" v={m.children}/>}
          <Row k="Тип номера" v={m.room_type}/>
          <Row k="Питание" v={m.meal_plan}/>
        </Card>}

        {(ot==="ticket"||ot==="tickets")&&<Card><Sec t={"🎟 Детали "+detailLabel}/>
          <Row k="Дата посещения" v={m.visit_date}/>
          <Row k="Тип билета" v={m.ticket_type}/>
          <Row k="Категория" v={m.age_category}/>
          <Row k="Количество" v={m.quantity}/>
          <Row k="Время входа" v={m.entry_time}/>
          <Row k="Действителен до" v={m.valid_until}/>
        </Card>}

        {ot==="tour"&&<Card><Sec t={"🧭 Детали "+detailLabel}/>
          <Row k="Дата" v={m.tour_date}/>
          <Row k="Начало" v={m.start_time}/>
          <Row k="Продолжительность" v={m.duration_min?m.duration_min+" мин":null}/>
          <Row k="Маршрут" v={m.route}/>
          <Row k="Группа" v={m.group_size}/>
          <Row k="Гид" v={m.guide_name}/>
        </Card>}

        {ot==="masterclass"&&<Card><Sec t={"🎨 Детали "+detailLabel}/>
          <Row k="Дата" v={m.session_date}/>
          <Row k="Начало" v={m.start_time}/>
          <Row k="Продолжительность" v={m.duration_min?m.duration_min+" мин":null}/>
          <Row k="Мастер" v={m.master_name}/>
          <Row k="Материалы" v={m.materials_included?"Включены":"Не включены"}/>
          <Row k="Возраст" v={m.min_age?("от "+m.min_age+" лет"):null}/>
        </Card>}

        {(ot==="food"||ot==="delivery")&&<Card><Sec t={"🍽 Детали "+detailLabel}/>
          <Row k="Способ получения" v={m.delivery_method}/>
          <Row k="Номер комнаты" v={m.room_number||m.table_number}/>
          <Row k="Время доставки" v={m.delivery_time}/>
          <Row k="Ресторан" v={m.restaurant}/>
        </Card>}

        {ot==="certificate"&&<Card><Sec t={"🎁 Детали "+detailLabel}/>
          <Row k="Номинал" v={m.nominal?(m.nominal.toLocaleString("ru")+" ₽"):null}/>
          <Row k="Действителен до" v={m.valid_until}/>
          <Row k="Получатель" v={m.recipient_name}/>
          <Row k="Активирован" v={m.activated?"Да":"Нет"}/>
        </Card>}

        {(order.points_earned>0||(order.countries_unlocked&&order.countries_unlocked.filter((c:string)=>c).length>0))&&<Card><Sec t="🏆 Паспорт путешественника"/>
          {order.points_earned>0&&<div style={{display:"flex",alignItems:"center",gap:8,padding:"6px 0"}}><div style={{width:30,height:30,borderRadius:8,background:"rgba(52,199,89,.1)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:13,fontWeight:500,color:"#000"}}>+{order.points_earned} баллов</div><div style={{fontSize:11,color:"#34C759"}}>Начислено на счёт паспорта</div></div></div>}
          {order.countries_unlocked&&order.countries_unlocked.filter((c:string)=>c).map((c:string,i:number)=><div key={i} style={{display:"flex",alignItems:"center",gap:8,padding:"6px 0"}}><div style={{width:30,height:30,borderRadius:8,background:"rgba(0,122,255,.1)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:14}}>🌍</div><div><div style={{fontSize:13,fontWeight:500,color:"#000"}}>Новая страна</div><div style={{fontSize:11,color:"#007AFF"}}>«{c}» добавлена в коллекцию</div></div></div>)}
        </Card>}

        <Card><Sec t="Детали оплаты"/>
          <Row k="Способ оплаты" v={payMap[order.payment_method]||order.payment_method||"—"}/>
          {order.guest_name&&<Row k="Клиент" v={order.guest_name}/>}
          {order.guest_phone&&<Row k="Телефон" v={order.guest_phone}/>}
          {order.notes&&<Row k="Комментарий" v={order.notes}/>}
          <Row k="Тип" v={label}/>
        </Card>
...
@media print{
  ...
  .print-only-receipt div{overflow:visible!important;height:auto!important;max-height:none!important;position:static!important;flex:none!important;}
  .print-only-receipt{display:block!important;flex-direction:initial!important;}
  html,body{height:auto!important;overflow:visible!important;background:#fff!important;}
}`}</style>

        <div className="no-print" style={{display:"flex",flexDirection:"column",gap:8,paddingTop:8}}>
          <div style={{display:"flex",gap:8}}>
            <div className="tap" onClick={()=>{if(navigator.share){navigator.share({title:"Чек "+order.order_code,text:"Электронный билет на "+(order.total||0).toLocaleString("ru")+" ₽",url:"https://ethnomir.app/#order/"+order.order_code}).catch(()=>{});}else{navigator.clipboard.writeText("https://ethnomir.app/#order/"+order.order_code);alert("Ссылка скопирована!");}}} style={{flex:1,height:44,borderRadius:12,background:"rgba(0,122,255,.08)",display:"flex",alignItems:"center",justifyContent:"center",gap:6}}><svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M4 12v8a2 2 0 002 2h12a2 2 0 002-2v-8M16 6l-4-4-4 4M12 2v13" stroke="#007AFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg><span style={{fontSize:14,fontWeight:600,color:"#007AFF",fontFamily:FT}}>Отправить</span></div>
            <div className="tap" onClick={()=>{window.print();}} style={{flex:1,height:44,borderRadius:12,background:"rgba(52,199,89,.08)",display:"flex",alignItems:"center",justifyContent:"center",gap:6}}><svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v11a2 2 0 01-2 2z" stroke="#34C759" strokeWidth="2" strokeLinecap="round"/><path d="M17 21v-8H7v8M7 3v5h8" stroke="#34C759" strokeWidth="2" strokeLinecap="round"/></svg><span style={{fontSize:14,fontWeight:600,color:"#34C759",fontFamily:FT}}>Сохранить</span></div>
          </div>
          <div className="tap" onClick={onBack} style={{height:44,borderRadius:12,background:"#007AFF",display:"flex",alignItems:"center",justifyContent:"center"}}><span style={{fontSize:15,fontWeight:600,color:"#fff",fontFamily:FT}}>Закрыть</span></div>
        </div>
      </div>
    </div>
  );
