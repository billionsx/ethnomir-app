...
{deals.map((d:any,i:number)=>{const pct=d.probability||0;const pc=d.won?'#34C759':pct>=50?'#FF9500':'#007AFF';return(<div key={d.id||i}>{i>0&&<div style={{height:'0.33px',background:'rgba(60,60,67,.1)',marginLeft:16}}/>}<div style={{padding:'14px 16px'}}>
<div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:6}}>
