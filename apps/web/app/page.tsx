...
return <div style={{position:'fixed',top:0,left:'50%',right:0,bottom:84,transform:'translateX(-50%)',width:'100%',maxWidth:390,zIndex:250,background:'linear-gradient(180deg,#E8E0F0 0%,#F2F2F7 15%,#EDF5FF 40%,#F2F2F7 60%,#F0FFF4 80%,#F2F2F7 100%)',color:'#000',overflowY:'auto',WebkitOverflowScrolling:'touch'}}>
