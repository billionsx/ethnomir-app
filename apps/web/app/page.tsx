...
const BL='#007AFF',GR='#34C759',OR='#FF9500',RD='#FF3B30',IND='#5856D6';
const FD="-apple-system,'SF Pro Display',system-ui,sans-serif",FT="-apple-system,'SF Pro Text',system-ui,sans-serif";
const L2='rgba(60,60,67,.60)';
const GL={background:'rgba(255,255,255,.72)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'.5px solid rgba(255,255,255,.35)',boxShadow:'inset 0 1px 0 rgba(255,255,255,.5), inset 0 -0.5px 0 rgba(0,0,0,.05), 0 2px 12px rgba(0,0,0,.06)'};
const[openSec,setOpenSec]=(React as any).useState<number|null>(null);
const sections=[
{t:'Оператор',icon:'M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z',text:'ООО «ЭТНО-ТУР» (ИНН 4003032840), адрес: 249018, Калужская обл., Боровский район, д. Петрово, тер. ЭТНО-ДЕРЕВНЯ, ул. МИРА, зд. 6А, помещ. 1. Действует в соответствии с ФЗ от 27.07.2006 г. No 152-ФЗ «О персональных данных».'},
{t:'Какие данные',icon:'M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z',text:'Фамилия, имя, отчество; номер телефона; адрес электронной почты; дата рождения; данные документов, удостоверяющих личность; сведения о детях и сопровождающих лицах при бронировании.'},
{t:'Цели обработки',icon:'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z',text:'Регистрация на сайте и в приложении; бронирование услуг (отели, туры, мастер-классы); направление уведомлений, SMS и email (в т.ч. рекламного характера); обработка заявок и обращений; исполнение договоров; улучшение качества услуг.'},
{t:'Способы обработки',icon:'M19.14 12.94c.04-.3.06-.61.06-.94 0-.32-.02-.64-.07-.94l2.03-1.58-1.97-3.41-2.39.96c-.5-.38-1.03-.7-1.62-.94L14.71 4h-3.94l-.4 2.08c-.59.24-1.13.57-1.62.94l-2.39-.96L4.39 9.49l2.02 1.58c-.04.3-.07.62-.07.94 0 .32.02.64.07.94l-2.02 1.58 1.97 3.41 2.39-.96c.5.38 1.03.7 1.62.94l.47 2.08h3.94l.4-2.08c.59-.24 1.13-.56 1.62-.94l2.39.96 1.97-3.41-2.03-1.58zM12 15.6c-1.98 0-3.6-1.62-3.6-3.6s1.62-3.6 3.6-3.6 3.6 1.62 3.6 3.6-1.62 3.6-3.6 3.6z',text:'Сбор, систематизация, накопление, хранение, уточнение, обновление, изменение, использование, передача, обезличивание, блокирование, уничтожение. Обработка с помощью средств автоматизации и без них.'},
{t:'Срок действия',icon:'M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67V7z',text:'Согласие действует 20 (двадцать) лет с момента передачи данных Оператору. Может быть отозвано на основании письменного заявления в произвольной форме, направленного Оператору.'},
{t:'Защита данных',icon:'M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11v8.8z',text:'Оператор принимает необходимые правовые, организационные и технические меры для защиты персональных данных от неправомерного доступа, уничтожения, изменения, блокирования, копирования, распространения и иных неправомерных действий.'},
{t:'Cookies',icon:'M21.95 10.99c-1.79-.03-3.7-1.95-2.68-4.22-2.97 1-5.78-1.59-5.19-4.56C7.1.74 2 6.41 2 12c0 5.52 4.48 10 10 10 5.89 0 10.54-5.08 9.95-11.01zM8.5 15c-.83 0-1.5-.67-1.5-1.5S7.67 12 8.5 12s1.5.67 1.5 1.5S9.33 15 8.5 15zm2-5C9.67 10 9 9.33 9 8.5S9.67 7 10.5 7s1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm4.5 6c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1z',text:'Сайт и приложение используют файлы cookies для обеспечения корректной работы, персонализации контента и анализа трафика. Продолжая использование, вы соглашаетесь с применением cookies.'}
];
const rights=['Получить информацию об обработке ваших данных','Потребовать уточнения или удаления данных','Отозвать согласие письменным заявлением','Обратиться в Роскомнадзор при нарушении прав'];
return(<div style={{position:'fixed',inset:0,left:'50%',transform:'translateX(-50%)',width:'100%',maxWidth:390,zIndex:99,background:'#F2F2F7',overflowY:'auto',WebkitOverflowScrolling:'touch',paddingBottom:110}}>
<div style={{position:'sticky',top:0,zIndex:10,padding:'54px 20px 12px',...GL}}><div style={{display:'flex',alignItems:'center',gap:8}}><div className="tap" onClick={onClose} style={{width:32,height:32,borderRadius:22,...GL,display:'flex',alignItems:'center',justifyContent:'center'}}><svg width="10" height="18" viewBox="0 0 10 18" fill="none"><path d="M9 1L1 9l8 8" stroke="#007AFF" strokeWidth="2" strokeLinecap="round"/></svg></div><div style={{fontSize:17,fontWeight:600,fontFamily:FT}}>Согласие на данные</div></div></div>
<div style={{padding:'0 20px 16px'}}><div style={{borderRadius:24,background:'linear-gradient(145deg,#1C1C1E 0%,#2C2C2E 50%,#3A3A3C 100%)',padding:'32px 22px',position:'relative',overflow:'hidden'}}><div style={{position:'absolute',inset:0,opacity:.04,backgroundImage:'radial-gradient(circle at 30% 50%,#fff 1px,transparent 1px)',backgroundSize:'20px 20px'}}></div><div style={{position:'relative',zIndex:1}}><div style={{display:'inline-flex',padding:'4px 12px',borderRadius:16,background:'rgba(52,199,89,.15)',marginBottom:12}}><svg width="14" height="14" viewBox="0 0 24 24" fill="#34C759" style={{marginRight:4}}><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4z"/></svg><span style={{fontSize:12,fontWeight:600,color:GR,fontFamily:FT}}>152-ФЗ</span></div><div style={{fontSize:28,fontWeight:700,color:'#fff',fontFamily:FD,letterSpacing:'-.6px',lineHeight:1.15,marginBottom:8}}>Обработка персональных данных</div><div style={{fontSize:15,color:'rgba(255,255,255,.7)',fontFamily:FT,lineHeight:1.45}}>ООО «ЭТНО-ТУР» обрабатывает данные в соответствии с ФЗ No 152 от 27.07.2006</div></div></div></div>
<div style={{padding:'0 20px 16px',display:'grid',gridTemplateColumns:'1fr 1fr 1fr',gap:10}}>{[{v:'152-ФЗ',l:'Закон',c:BL},{v:'20 лет',l:'Срок',c:OR},{v:'24/7',l:'Защита',c:GR}].map((m:any,i:number)=>(<div key={i} style={{borderRadius:16,...GL,padding:'12px 8px',textAlign:'center'}}><div style={{fontSize:18,fontWeight:700,color:m.c,fontFamily:FD}}>{m.v}</div><div style={{fontSize:11,color:L2,fontFamily:FT,marginTop:2}}>{m.l}</div></div>))}</div>
<div style={{padding:'0 20px 16px'}}>{sections.map((s:any,i:number)=>(<div key={i} style={{marginBottom:8}}><div className="tap" onClick={()=>setOpenSec(openSec===i?null:i)} style={{borderRadius:openSec===i?'16px 16px 0 0':'16px',...GL,padding:'14px 16px',display:'flex',alignItems:'center',gap:12,transition:'border-radius .3s'}}><div style={{width:32,height:32,borderRadius:16,background:i===5?'linear-gradient(135deg,#34C759,#30D158)':i===6?'linear-gradient(135deg,#FF9500,#FF6B00)':'linear-gradient(135deg,#007AFF,#5856D6)',display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0}}><svg width="16" height="16" viewBox="0 0 24 24" fill="#fff"><path d={s.icon}/></svg></div><div style={{flex:1,fontSize:15,fontWeight:600,color:'#000',fontFamily:FT}}>{s.t}</div><svg width="12" height="12" viewBox="0 0 12 12" style={{transform:openSec===i?'rotate(180deg)':'none',transition:'transform .3s cubic-bezier(.2,.8,.2,1)'}}><path d="M2 4l4 4 4-4" stroke={L2} strokeWidth="1.5" fill="none"/></svg></div>{openSec===i&&<div style={{...GL,borderRadius:'0 0 16px 16px',borderTop:'none',padding:'0 16px 14px',marginTop:-1}}><div style={{fontSize:14,color:L2,fontFamily:FT,lineHeight:1.55}}>{s.text}</div></div>}</div>))}</div>
<div style={{padding:'0 20px 16px'}}><div style={{borderRadius:20,...GL,padding:'20px'}}><div style={{fontSize:17,fontWeight:700,fontFamily:FD,marginBottom:12}}>Ваши права</div>{rights.map((r:string,i:number)=>(<div key={i} style={{display:'flex',alignItems:'flex-start',gap:10,marginBottom:i<rights.length-1?10:0}}><svg width="18" height="18" viewBox="0 0 24 24" fill={GR} style={{flexShrink:0,marginTop:1}}><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg><div style={{fontSize:14,color:'#333',fontFamily:FT,lineHeight:1.45}}>{r}</div></div>))}</div></div>
<div style={{padding:'0 20px 16px'}}><div style={{borderRadius:20,background:'linear-gradient(135deg,rgba(0,122,255,.06),rgba(88,86,214,.04))',border:'.5px solid rgba(0,122,255,.15)',padding:'20px'}}><div style={{display:'flex',alignItems:'center',gap:8,marginBottom:10}}><svg width="20" height="20" viewBox="0 0 24 24" fill={BL}><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/></svg><div style={{fontSize:15,fontWeight:700,color:'#000',fontFamily:FD}}>Как отозвать согласие</div></div><div style={{fontSize:14,color:L2,fontFamily:FT,lineHeight:1.55}}>Направьте письменное заявление в произвольной форме на адрес: 249018, Калужская обл., Боровский район, д. Петрово, ООО «ЭТНО-ТУР», или на email: info@ethnomir.ru</div></div></div>
<div style={{padding:'0 20px 16px'}}><div style={{borderRadius:20,...GL,padding:'20px'}}><div style={{fontSize:17,fontWeight:700,fontFamily:FD,marginBottom:12}}>Документы</div>{[['ethnomir.ru/agreement','Согласие на обработку данных'],['ethnomir.ru/policy','Политика конфиденциальности'],['ethnomir.ru/rules','Правила бронирования и оказания услуг']].map(([url,label]:any,i:number)=>(<div key={i} className="tap" style={{display:'flex',alignItems:'center',gap:10,padding:'10px 0',borderBottom:i<2?'0.5px solid rgba(0,0,0,.06)':'none'}}><svg width="16" height="16" viewBox="0 0 24 24" fill={BL}><path d="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg><div style={{fontSize:14,color:BL,fontWeight:500,fontFamily:FT}}>{label}</div><span style={{fontSize:15,color:L2,marginLeft:'auto'}}>{'>'}</span></div>))}</div></div>
<div style={{padding:'0 20px 20px'}}><div style={{borderRadius:20,...GL,padding:'20px',textAlign:'center'}}><div style={{fontSize:12,color:L2,fontFamily:FT,lineHeight:1.5}}>ООО «ЭТНО-ТУР» (ИНН 4003032840, ОГРН 1084025001094)<br/>249018, Калужская обл., Боровский р-н, д. Петрово<br/>+7 (495) 023-43-49 | info@ethnomir.ru</div></div></div>
</div>);}
