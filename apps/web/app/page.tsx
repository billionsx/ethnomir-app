  ...
  return (
    <div style={{flex:1,overflowY:'auto',overflowX:'hidden',WebkitOverflowScrolling:'touch',paddingBottom:110,background:'var(--bg)',maxWidth:'100%'}}>
      ...
      {loading ? <Spinner/> : sec==='gastro' ? (
        <div style={{padding:'0 20px',background:'linear-gradient(165deg,#e8ecff 0%,#dde5f9 25%,#e9e4f6 50%,#f0ecf7 75%,#f2f2f7 100%)',borderRadius:0,minHeight:'100vh'}}>
        ...
        <div style={{padding:0}}>
          ...
          <div style={{padding:'20px'}}>
            ...
            {fullMenu.length===0 ? <div style={{padding:'20px',textAlign:'center'}}><Spinner/></div> : (
              <div style={{borderRadius:24,background:'rgba(255,255,255,.18)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'1px solid rgba(255,255,255,.7)',boxShadow:'0 8px 32px rgba(31,38,135,.1), inset 0 2px 12px rgba(255,255,255,.25)',overflow:'hidden',boxShadow:'var(--shadow-sm)'}}>
  ...
  if(view){
    ...
    return(
      <div style={{padding:'12px 0'}}>
        ...
        {view==='countries'&&(<div style={{padding:'0 20px',background:'linear-gradient(165deg,#e8ecff 0%,#dde5f9 25%,#e9e4f6 50%,#f0ecf7 75%,#f2f2f7 100%)',borderRadius:0,minHeight:'100vh'}}>{selectedCountry?(()=>{const c=selectedCountry;const v=visitedC.includes(c.id);const stamp=stampsData.find((s:any)=>s.country_id===c.id);return(<div>
...
<div style={{borderRadius:24,background:'rgba(255,255,255,.18)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'1px solid rgba(255,255,255,.7)',boxShadow:'0 8px 32px rgba(31,38,135,.1), inset 0 2px 12px rgba(255,255,255,.25)',overflow:'hidden',marginBottom:12}}>
...
<div style={{width:'100%',borderRadius:16,background:'rgba(0,122,255,.06)',border:'1px solid rgba(0,122,255,.12)',padding:14,marginTop:8}}><div style={{fontSize:13,color:'var(--label2)',fontFamily:FT,textAlign:'center'}}>📷 Сканируйте QR-коды у павильонов стран, чтобы собрать штампы · +15 баллов за каждую</div></div>
        ...
        {view==='regions'&&(<div style={{padding:'0 20px',background:'linear-gradient(165deg,#e8ecff 0%,#dde5f9 25%,#e9e4f6 50%,#f0ecf7 75%,#f2f2f7 100%)',borderRadius:0,minHeight:'100vh'}}>{selectedRegion?(()=>{const r=selectedRegion;const v=visitedR.includes(r.id);const stamp=stampsData.find((s:any)=>s.region_id===r.id);return(<div>
...
<div style={{borderRadius:24,background:'rgba(255,255,255,.18)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'1px solid rgba(255,255,255,.7)',boxShadow:'0 8px 32px rgba(31,38,135,.1), inset 0 2px 12px rgba(255,255,255,.25)',overflow:'hidden'}}>
...
<div style={{borderRadius:16,background:'rgba(0,122,255,.06)',border:'1px solid rgba(0,122,255,.12)',padding:14,marginTop:12}}><div style={{fontSize:13,color:'var(--label2)',fontFamily:FT,textAlign:'center'}}>📷 Сканируйте QR-коды у стендов регионов · от 15 до 30 баллов</div></div>
      ...
      <div style={{padding:"12px 0"}}>
        ...
        {view==='favorites'&&(
          <div style={{padding:'0 20px',background:'linear-gradient(165deg,#e8ecff 0%,#dde5f9 25%,#e9e4f6 50%,#f0ecf7 75%,#f2f2f7 100%)',borderRadius:0,minHeight:'100vh'}}>{(favs||[]).length===0?<div style={{textAlign:'center',padding:40}}><div style={{fontSize:48,marginBottom:8}}>❤️</div><div style={{fontSize:15,color:'var(--label2)',fontFamily:FT}}>Пусто</div></div>:
            <div style={{borderRadius:24,background:'rgba(255,255,255,.18)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'1px solid rgba(255,255,255,.7)',boxShadow:'0 8px 32px rgba(31,38,135,.1), inset 0 2px 12px rgba(255,255,255,.25)',overflow:'hidden'}}>{favs.map((f:any,i:number)=>(
        ...
        {view==='terms'&&(
          <div style={{padding:'0 20px',background:'linear-gradient(165deg,#e8ecff 0%,#dde5f9 25%,#e9e4f6 50%,#f0ecf7 75%,#f2f2f7 100%)',borderRadius:0,minHeight:'100vh'}}>
            <div style={{fontSize:24,fontWeight:700,color:'var(--label)',fontFamily:FD,letterSpacing:'-0.4px',marginBottom:16}}>Условия использования</div>
        ...
        {view==='privacy'&&(
          <div style={{padding:'0 20px',background:'linear-gradient(165deg,#e8ecff 0%,#dde5f9 25%,#e9e4f6 50%,#f0ecf7 75%,#f2f2f7 100%)',borderRadius:0,minHeight:'100vh'}}>
            <div style={{fontSize:24,fontWeight:700,color:'var(--label)',fontFamily:FD,letterSpacing:'-0.4px',marginBottom:16}}>Политика конфиденциальности</div>
          ...
          <div style={{padding:'0 20px',background:'linear-gradient(165deg,#e8ecff 0%,#dde5f9 25%,#e9e4f6 50%,#f0ecf7 75%,#f2f2f7 100%)',borderRadius:0,minHeight:'100vh'}}>
            {selectedLegal ? (
              <div>
                ...
                <div style={{fontSize:24,fontWeight:700,color:'var(--label)',fontFamily:FD,letterSpacing:'-0.4px',marginBottom:16}}>{_s(selectedLegal.title_ru)}</div>
            ...
            <div style={{borderRadius:24,background:'rgba(255,255,255,.18)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'1px solid rgba(255,255,255,.7)',boxShadow:'0 8px 32px rgba(31,38,135,.1), inset 0 2px 12px rgba(255,255,255,.25)',overflow:'hidden',marginTop:12}}>
        ...
        {view==='crm'&&crmRole&&(<div style={{padding:'0 20px',background:'linear-gradient(165deg,#e8ecff 0%,#dde5f9 25%,#e9e4f6 50%,#f0ecf7 75%,#f2f2f7 100%)',borderRadius:0,minHeight:'100vh'}}>
<div style={{borderRadius:20,background:'linear-gradient(135deg,rgba(0,122,255,.08),rgba(88,86,214,.06))',padding:20,marginBottom:16,border:'0.5px solid rgba(0,122,255,.15)'}}><div style={{display:'flex',alignItems:'center',justifyContent:'space-between'}}><div style={{fontSize:28,fontWeight:700,color:'var(--label)',fontFamily:FD,letterSpacing:'-0.5px'}}>CRM</div><div style={{padding:'4px 12px',borderRadius:20,background:'rgba(0,122,255,.1)',backdropFilter:'blur(20px)',WebkitBackdropFilter:'blur(20px)',border:'0.5px solid rgba(0,122,255,.15)',fontSize:12,fontWeight:600,color:'#007AFF',fontFamily:FT}}>{crmRole==='owner'?'Владелец':crmRole==='director'?'Директор':crmRole==='manager'?'Менеджер':'Сотрудник'}</div></div><div style={{fontSize:13,color:'var(--label2)',fontFamily:FT,marginTop:6}}>Этномир · {new Date().toLocaleDateString('ru',{day:'numeric',month:'long',year:'numeric'})}</div></div>
<div style={{display:'flex',gap:2,background:'var(--fill4)',position:'relative',marginBottom:12,zIndex:10}}>
<input value={crmSearch} onChange={(e:any)=>crmGlobalSearch(e.target.value)} placeholder="Поиск по CRM..." style={{width:'100%',height:36,borderRadius:10,border:'none',padding:'0 14px 0 34px',fontSize:14,fontFamily:FT,background:'rgba(255,255,255,.15)',backdropFilter:'blur(20px)',WebkitBackdropFilter:'blur(20px)',border:'1px solid rgba(255,255,255,.5)',boxShadow:'inset 0 1px 4px rgba(255,255,255,.2)',color:'var(--label)',outline:'none'}}/>
...
<div style={{display:'flex',background:'rgba(120,120,128,.08)',borderRadius:12,padding:3,marginBottom:16,overflow:'auto',WebkitOverflowScrolling:'touch',backdropFilter:'blur(20px) saturate(150%)',WebkitBackdropFilter:'blur(20px) saturate(150%)',border:'0.5px solid rgba(0,0,0,.06)',scrollbarWidth:'none'}}>{[{k:'dashboard',l:'Главная',n:0},{k:'bookings',l:'Брони',n:(crmData.bookings||[]).filter((b:any)=>b.status==='pending'||b.status==='confirmed').length},{k:'reviews',l:'Отзывы',n:(crmData.reviews||[]).length},{k:'guests',l:'Гости',n:(crmData.guests||[]).length},{k:'finance',l:'Финансы',n:0},{k:'staff',l:'Стафф',n:(crmData.staff||[]).length}].map((t:any)=>(<div key={t.k} className="tap" onClick={()=>{setCrmSection(t.k);setCrmExpanded(null);}} style={{flex:'0 0 auto',padding:'6px 12px',borderRadius:8,fontSize:12,fontWeight:crmSection===t.k?600:400,fontFamily:FT,color:crmSection===t.k?'var(--label)':'var(--label2)',background:crmSection===t.k?'var(--bg2)':'transparent',transition:'all .2s',whiteSpace:'nowrap'}}>{t.l}{t.n>0&&<span style={{marginLeft:4,fontSize:10,fontWeight:600,color:crmSection===t.k?'#007AFF':'var(--label3)'}}>{t.n}</span>}</div>))}</div>
{crmSection==='bookings'&&<div>
<div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:16}}>
<div style={{fontSize:24,fontWeight:700,color:'var(--label)',fontFamily:FD,letterSpacing:'-0.4px'}}>Бронирования</div>
...
{items.length===0?<div style={{padding:16,borderRadius:14,background:'var(--fill4)',textAlign:'center'}}><div style={{fontSize:13,color:'var(--label3)',fontFamily:FT}}>Пусто</div></div>:
...
<div style={{textAlign:'center'}}><div style={{fontSize:24,fontWeight:700,color:'var(--label)',fontFamily:FD,letterSpacing:'-0.4px'}}>{(crmData.reviews||[]).length}</div><div style={{fontSize:10,color:'var(--label3)',fontFamily:FT,marginTop:2}}>Всего</div></div>
...
<div style={{fontSize:17,fontWeight:700,color:'var(--label)',fontFamily:FD,letterSpacing:'-0.2px',marginBottom:12}}>Последние отзывы</div>
...
{crmExpanded===r.id&&!r.manager_response&&<div style={{marginTop:10,paddingTop:10,borderTop:'0.5px solid var(--sep)'}}><textarea value={crmReply} onChange={(e:any)=>setCrmReply(e.target.value)} placeholder="Ответить гостю..." style={{width:'100%',height:60,borderRadius:10,border:'0.5px solid var(--sep-opaque)',padding:'8px 12px',fontSize:13,fontFamily:FT,background:'var(--fill4)',color:'var(--label)',resize:'none',outline:'none'}} onClick={(e:any)=>e.stopPropagation()}/><div className="tap" onClick={(e:any)=>{e.stopPropagation();respondToReview(r.id,crmReply);}} style={{marginTop:8,height:36,borderRadius:10,background:crmReply.trim()?'#007AFF':'var(--fill4)',display:'flex',alignItems:'center',justifyContent:'center',fontSize:14,fontWeight:600,color:crmReply.trim()?'#fff':'var(--label3)',fontFamily:FT,opacity:crmUpdating?.5:1}}>Ответить</div></div>}
</div>))}
</div>}
{crmSection==='finance'&&<div>
<div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:16}}>
<div style={{fontSize:24,fontWeight:700,color:'var(--label)',fontFamily:FD,letterSpacing:'-0.4px'}}>Финансы</div>
...
<div style={{borderRadius:16,background:'var(--bg2)',border:'0.5px solid var(--sep-opaque)',padding:16}}>
...
<div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:12}}>
<span style={{fontSize:13,color:'var(--label3)',fontFamily:FT}}>{(crmData.guests||[]).length} всего</span>
<span style={{fontSize:13,color:'var(--label3)',fontFamily:FT}}>{(crmData.guests||[]).filter((g:any)=>g.vip_status).length} VIP</span>
</div>
...
<div style={{fontSize:24,fontWeight:700,color:'var(--label)',fontFamily:FD,letterSpacing:'-0.4px',marginBottom:16}}>Персонал</div>
...
<div style={{fontSize:17,fontWeight:700,color:'var(--label)',fontFamily:FD,letterSpacing:'-0.2px',marginBottom:12}}>Сотрудники</div>
{(crmData.staff||[]).map((s:any,i:number)=>{const rc={owner:'#FF2D55',director:'#5856D6',manager:'#FF9500',staff:'#34C759'};const rl={owner:'Владелец',director:'Директор',manager:'Менеджер',staff:'Сотрудник'};const dl={all:'Все',hotels:'Отели',restaurants:'Рестораны',tours:'Экскурсии',support:'Поддержка',masterclasses:'МК',shop:'Магазин',admin:'Admin'};return(<div key={s.id||i} style={{borderRadius:20,background:'rgba(255,255,255,.15)',backdropFilter:'blur(24px) saturate(180%)',WebkitBackdropFilter:'blur(24px) saturate(180%)',border:'1px solid rgba(255,255,255,.6)',boxShadow:'0 4px 16px rgba(31,38,135,.08), inset 0 1px 6px rgba(255,255,255,.2)',padding:'14px 16px',marginBottom:8}}>
...
{crmSection==='dashboard'&&<><div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:8,marginBottom:16}}>
...
{crmKpi&&<div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:8,marginBottom:16}}>
...
<div style={{fontSize:22,fontWeight:800,color:k.c,fontFamily:FD,letterSpacing:'-0.5px'}}>{k.fmt(k.v)}</div>
...
<div style={{marginBottom:16}}>
<div style={{fontSize:17,fontWeight:700,color:'var(--label)',fontFamily:FD,letterSpacing:'-0.2px',marginBottom:12}}>Быстрые действия</div>
<div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr 1fr',gap:8}}>
...
<div style={{fontSize:17,fontWeight:700,color:'var(--label)',fontFamily:FD,letterSpacing:'-0.2px',marginBottom:12}}>Воронка 30д</div>
...
<div style={{fontSize:17,fontWeight:700,color:'var(--label)',fontFamily:FD,letterSpacing:'-0.2px',marginBottom:12}}>Сегменты гостей</div>
...
<div style={{fontSize:17,fontWeight:700,color:'var(--label)',fontFamily:FD,letterSpacing:'-0.2px',marginBottom:12}}>Задачи <span style={{fontSize:12,fontWeight:500,color:'var(--label3)'}}>{crmTasks.filter((t:any)=>t.status==='todo'||t.status==='in_progress').length}</span></div>
<div style={{borderRadius:24,background:'rgba(255,255,255,.18)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'1px solid rgba(255,255,255,.7)',boxShadow:'0 8px 32px rgba(31,38,135,.1), inset 0 2px 12px rgba(255,255,255,.25)',overflow:'hidden',marginBottom:20}}>
...
<div style={{fontSize:17,fontWeight:700,color:'var(--label)',fontFamily:FD,letterSpacing:'-0.2px',marginBottom:12}}>Последние действия</div>
<div style={{borderRadius:24,background:'rgba(255,255,255,.18)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'1px solid rgba(255,255,255,.7)',boxShadow:'0 8px 32px rgba(31,38,135,.1), inset 0 2px 12px rgba(255,255,255,.25)',overflow:'hidden',marginBottom:20}}>
...
<div style={{fontSize:17,fontWeight:700,color:'var(--label)',fontFamily:FD,letterSpacing:'-0.2px',marginBottom:12}}>Топ гости по LTV</div>
<div style={{borderRadius:24,background:'rgba(255,255,255,.18)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'1px solid rgba(255,255,255,.7)',boxShadow:'0 8px 32px rgba(31,38,135,.1), inset 0 2px 12px rgba(255,255,255,.25)',overflow:'hidden'}}>
...
<div style={{fontSize:17,fontWeight:700,color:'var(--label)',fontFamily:FD,letterSpacing:'-0.2px',marginBottom:12}}>Журнал действий</div>
<div style={{borderRadius:24,background:'rgba(255,255,255,.18)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'1px solid rgba(255,255,255,.7)',boxShadow:'0 8px 32px rgba(31,38,135,.1), inset 0 2px 12px rgba(255,255,255,.25)',overflow:'hidden'}}>
...
<div style={{fontSize:17,fontWeight:700,color:'var(--label)',fontFamily:FD,letterSpacing:'-0.2px',marginBottom:12}}>Заметки</div>
...
{(crmNoteEdit&&crmNoteEdit!==(crmGuest.notes||''))&&<div className="tap" onClick={async(e:any)=>{e.stopPropagation();if(!session?.access_token)return;try{await fetch(SB_URL+'/rest/v1/rpc/save_guest_note',{method:'POST',headers:{'Content-Type':'application/json','Authorization':'Bearer '+session.access_token,'apikey':SB_KEY},body:JSON.stringify({p_guest_id:crmGuest.id,p_note:crmNoteEdit})});setCrmData((p:any)=>({...p,guests:(p.guests||[]).map((g:any)=>g.id===crmGuest.id?{...g,notes:crmNoteEdit}:g)}));setCrmGuest({...crmGuest,notes:crmNoteEdit});}catch(e){console.error(e);}}} style={{height:36,borderRadius:10,background:'#007AFF',display:'flex',alignItems:'center',justifyContent:'center',fontSize:14,fontWeight:600,color:'#fff',fontFamily:FT,marginBottom:16}}>Сохранить</div>}
{!(crmNoteEdit&&crmNoteEdit!==(crmGuest.notes||''))&&<div style={{height:16}}/>}
<div style={{fontSize:17,fontWeight:700,color:'var(--label)',fontFamily:FD,letterSpacing:'-0.2px',marginBottom:12}}>История</div>
{crmGuestEvts.length===0?<div style={{padding:16,borderRadius:14,background:'var(--fill4)',textAlign:'center'}}><div style={{fontSize:13,color:'var(--label3)',fontFamily:FT}}>Нет событий</div></div>:
    ...
    <div style={{paddingBottom:40}}>
      ...
      <div style={{fontSize:12,fontWeight:600,color:'var(--label3)',fontFamily:FT,textTransform:'uppercase',letterSpacing:'.5px',paddingLeft:16,marginBottom:6,marginTop:16}}>Инструменты</div>
        ...
        {showPro&&subPlans.filter((p:any)=>p.slug!=='free').length>0&&(
          <div style={{borderRadius:24,background:'rgba(255,255,255,.18)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'1px solid rgba(255,255,255,.7)',boxShadow:'0 8px 32px rgba(31,38,135,.1), inset 0 2px 12px rgba(255,255,255,.25)',overflow:'hidden',marginTop:8}}>
...
{/* TRANSPORT TABS */}
<div style={{padding:'16px 20px 0'}}><div style={{display:'flex',background:'rgba(255,255,255,.15)',backdropFilter:'blur(20px)',WebkitBackdropFilter:'blur(20px)',border:'1px solid rgba(255,255,255,.5)',boxShadow:'inset 0 1px 4px rgba(255,255,255,.2)',borderRadius:10,padding:3,gap:2}}>
...
{/* METRICS */}
<div style={{padding:'0 20px',background:'linear-gradient(165deg,#e8ecff 0%,#dde5f9 25%,#e9e4f6 50%,#f0ecf7 75%,#f2f2f7 100%)',borderRadius:0,minHeight:'100vh'}}><div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr',gap:10}}>{[{t:'1969',l:'\u0433\u043e\u0434 \u0440\u043e\u0436\u0434.',c:GOLD},{t:'500+',l:'\u043f\u0440\u043e\u0435\u043a\u0442\u043e\u0432',c:BL},{t:'60',l:'\u0441\u0442\u0440\u0430\u043d',c:G}].map((s:any,i:number)=><div key={i} style={{...GL,borderRadius:16,padding:'14px 8px',textAlign:'center'}}><div style={{fontSize:20,fontWeight:800,color:s.c,fontFamily:FD}}>{s.t}</div><div style={{fontSize:9,color:L2,fontFamily:FT,marginTop:2,textTransform:'uppercase',letterSpacing:1}}>{s.l}</div></div>)}</div></div>
{/* BIO */}
...
<div style={{display:'flex',background:'rgba(255,255,255,.15)',backdropFilter:'blur(20px)',WebkitBackdropFilter:'blur(20px)',border:'1px solid rgba(255,255,255,.5)',boxShadow:'inset 0 1px 4px rgba(255,255,255,.2)',borderRadius:10,padding:3,gap:2,marginBottom:14}}>
...
<div style={{padding:'0 16px 12px'}}><div style={{display:'flex',background:'rgba(255,255,255,.15)',backdropFilter:'blur(20px)',WebkitBackdropFilter:'blur(20px)',border:'1px solid rgba(255,255,255,.5)',boxShadow:'inset 0 1px 4px rgba(255,255,255,.2)',borderRadius:10,padding:3,gap:2}}>
