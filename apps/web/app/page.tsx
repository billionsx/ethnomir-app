      ...
      {detailSheet&&(
        <div style={{position:"fixed",inset:0,zIndex:250,background:"var(--bg)",overflow:"auto",display:"flex",justifyContent:"center"}}>
          <div style={{width:"100%",maxWidth:390}}>
            ...
            <div style={{position:"fixed",bottom:0,left:0,right:0,zIndex:300,padding:"12px 20px 34px",background:"rgba(249,249,249,0.78)",backdropFilter:"blur(50px) saturate(180%)",WebkitBackdropFilter:"blur(50px) saturate(180%)",borderTop:"0.5px solid rgba(60,60,67,0.12)",display:"flex",justifyContent:"center"}}>
