...
<div style={{width:36,height:36,borderRadius:18,background:(rc as any)[s.role]+'18',display:'flex',alignItems:'center',justifyContent:'center',fontSize:14,fontWeight:700,color:(rc as any)[s.role],fontFamily:FT,flexShrink:0}}>{((rl as any)[s.role]||'?').slice(0,1)}</div>
