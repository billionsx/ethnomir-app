...
<div style={{flex:1,minWidth:0}}><div style={{fontSize:15,fontWeight:600,color:'var(--label)',fontFamily:FT}}>{_s(ev.title)}</div>{ev.description&&<div style={{fontSize:13,color:'rgba(60,60,67,.6)',fontFamily:FT}}>{_s(ev.description)}</div>}</div>
...
<div style={{width:32,height:32,borderRadius:16,background:(ac[a.action]||'#999')+'10',display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0,marginTop:2}}><div style={{width:8,height:8,borderRadius:4,background:ac[a.action]||'#999'}}/></div>
<div style={{flex:1}}><div style={{fontSize:15,fontWeight:600,color:'var(--label)',fontFamily:FT}}>{al[a.action]||a.action}</div>{det.booking&&<div style={{fontSize:13,color:'rgba(60,60,67,.6)',fontFamily:FT}}>{_s(det.booking||det.guest||det.task||det.title||'')}</div>}{det.guest&&<div style={{fontSize:13,color:'rgba(60,60,67,.6)',fontFamily:FT}}>{_s(det.guest)}</div>}<div style={{fontSize:12,color:'rgba(60,60,67,.6)',fontFamily:FT,marginTop:3}}>{a.created_at?new Date(a.created_at).toLocaleString('ru',{day:'numeric',month:'short',hour:'2-digit',minute:'2-digit'}):''}</div></div>
</div>);})}
</div>
</div>}
