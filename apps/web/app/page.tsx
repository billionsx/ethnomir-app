...
<div style={{display:'flex',alignItems:'flex-end',gap:6,height:80}}>{(crmData.revChart||[]).slice(-7).map((r:any,i:number)=>{const mx=Math.max(...(crmData.revChart||[]).slice(-7).map((x:any)=>Number(x.value)||0),1);const h=Math.max(8,Math.round(Number(r.value||0)/mx*72));const isToday=i===(crmData.revChart||[]).slice(-7).length-1;return(<div key={i} style={{flex:1,display:'flex',flexDirection:'column',alignItems:'center',gap:4,animation:`crmCardIn .3s cubic-bezier(0.2,0.8,0.2,1) ${i*0.05}s both`}}><div style={{fontSize:11,fontWeight:600,color:'rgba(60,60,67,.6)',fontFamily:FT}}>{Math.round(Number(r.value||0)/1000)}K</div><div style={{width:'100%',height:h,borderRadius:8,background:isToday?'linear-gradient(180deg,#3898FF,#007AFF)':'rgba(0,122,255,.10)',transition:'height .4s cubic-bezier(0.2,0.8,0.2,1)',borderRadius:8}} /><div style={{fontSize:11,color:'rgba(60,60,67,.6)',fontFamily:FT}}>{r.date?.slice(8,10)||''}</div></div>);})}</div>
</div>

{/* Visitors Chart */}
<div style={{borderRadius:20,background:'rgba(255,255,255,.72)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'0.5px solid rgba(255,255,255,.6)',boxShadow:'0 0.5px 0 rgba(255,255,255,.9) inset, 0 2px 8px rgba(0,0,0,.03)',padding:'18px 18px 14px',marginBottom:12}}>
<div style={{fontSize:15,fontWeight:600,color:'rgba(60,60,67,.6)',fontFamily:FT,marginBottom:14}}>{'\u041F\u043E\u0441\u0435\u0442\u0438\u0442\u0435\u043B\u0438 7 \u0434\u043D\u0435\u0439'}</div>
<div style={{display:'flex',alignItems:'flex-end',gap:6,height:80}}>{(crmData.visChart||[]).slice(-7).map((r:any,i:number)=>{const mx=Math.max(...(crmData.visChart||[]).slice(-7).map((x:any)=>Number(x.value)||0),1);const h=Math.max(8,Math.round(Number(r.value||0)/mx*72));const isToday=i===(crmData.visChart||[]).slice(-7).length-1;return(<div key={i} style={{flex:1,display:'flex',flexDirection:'column',alignItems:'center',gap:4,animation:`crmCardIn .3s cubic-bezier(0.2,0.8,0.2,1) ${i*0.05}s both`}}><div style={{fontSize:11,fontWeight:600,color:'rgba(60,60,67,.6)',fontFamily:FT}}>{Math.round(Number(r.value||0))}</div><div style={{width:'100%',height:h,borderRadius:8,background:isToday?'linear-gradient(180deg,#4CD964,#34C759)':'rgba(52,199,89,.10)',transition:'height .4s cubic-bezier(0.2,0.8,0.2,1)',borderRadius:8}} /><div style={{fontSize:11,color:'rgba(60,60,67,.6)',fontFamily:FT}}>{r.date?.slice(8,10)||''}</div></div>);})}</div>
</div>
...
<div style={{height:8,borderRadius:4,background:'rgba(118,118,128,.06)',overflow:'hidden'}}><div style={{height:'100%',borderRadius:4,width:((crmData.kpis||[]).find((r:any)=>r.metric_type==='occupancy_rate')?.value||0)+'%',background:Number((crmData.kpis||[]).find((r:any)=>r.metric_type==='occupancy_rate')?.value||0)>70?'#34C759':Number((crmData.kpis||[]).find((r:any)=>r.metric_type==='occupancy_rate')?.value||0)>40?'#FF9500':'#FF3B30',transition:'width .5s cubic-bezier(0.2,0.8,0.2,1)'}} /></div>
</div>
...
<div style={{display:'inline-flex',alignItems:'center',justifyContent:'center',height:24,padding:'0 8px',borderRadius:12,background:(tc[c.type]||'#999')+'12',fontSize:11,fontWeight:700,color:tc[c.type]||'#999',fontFamily:FT,lineHeight:1,flexShrink:0,alignSelf:'flex-start'}}>{tl[c.type]||c.type}</div>
...
<div style={{borderRadius:20,background:'rgba(255,255,255,.72)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'0.5px solid rgba(255,255,255,.6)',boxShadow:'0 0.5px 0 rgba(255,255,255,.9) inset, 0 2px 8px rgba(0,0,0,.03)',overflow:'hidden',marginBottom:20}}>
{crmActivity.slice(0,8).map((ev:any,i:number)=>{const tc:any={visit:'#007AFF',booking:'#5856D6',purchase:'#34C759',review:'#FF9500',favorite_added:'#FF2D55'};return(<div key={ev.id||i} style={{display:'flex',alignItems:'center',gap:12,padding:'14px 18px',borderBottom:i<7?'0.33px solid rgba(60,60,67,.1)':'none',animation:`crmSlideIn .25s cubic-bezier(0.2,0.8,0.2,1) ${i*0.04}s both`}}>
