      ...
      <div style={{margin:"-16px 16px 0",position:"relative",zIndex:1}}>
        ...
        <div className="no-print" style={{padding:"0 20px 40px",display:"flex",flexDirection:"column",gap:10}}>
          <div style={{display:"flex",gap:10}}>
            ...
            <div className="tap" onClick={()=>{const r=document.querySelector(".print-only-receipt") as HTMLElement;if(!r)return;const orig=r.style.cssText;const par=r.parentElement;const sib=r.nextSibling;r.style.cssText="position:static;transform:none;width:390px;max-width:390px;height:auto;overflow:visible;background:#F2F2F7;margin:0 auto;padding:0;zoom:0.52;";document.querySelectorAll("body>*:not(script):not(style)").forEach((e:any)=>{if(e!==r&&!r.contains(e)){e.dataset.ph="1";e.style.display="none";}});document.body.appendChild(r);window.print();if(par){if(sib)par.insertBefore(r,sib);else par.appendChild(r);}r.style.cssText=orig;document.querySelectorAll("[data-ph]").forEach((e:any)=>{e.style.display="";delete e.dataset.ph;});}} style={{flex:1,height:50,borderRadius:14,background:"rgba(52,199,89,.08)",display:"flex",alignItems:"center",justifyContent:"center",gap:8}}><svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v11a2 2 0 01-2 2z" stroke="#34C759" strokeWidth="2" strokeLinecap="round"/><path d="M17 21v-8H7v8M7 3v5h8" stroke="#34C759" strokeWidth="2" strokeLinecap="round"/></svg><span style={{fontSize:15,fontWeight:600,color:"#34C759",fontFamily:FT}}>Сохранить</span></div>
          </div>
