          ...
          <div style={{padding:'0 20px'}}>
            ...
            <div style={{borderRadius:16,background:'var(--bg2)',border:'0.5px solid var(--sep-opaque)',overflow:'hidden',marginBottom:12}}>
              <div style={{padding:'14px 16px',borderBottom:'0.5px solid var(--sep)'}}>
                ...
                <input type="date" value={editBirth||profile?.birth_date||''} onChange={(e:any)=>setEditBirth(e.target.value)} style={{fontSize:17,fontFamily:FT,color:'var(--label)',background:'var(--fill4)',border:'none',outline:'none',width:'100%',padding:'12px 14px',borderRadius:12,WebkitAppearance:'auto',cursor:'pointer'}}/>
              </div>
              <div style={{padding:'14px 16px',borderBottom:'0.5px solid var(--sep)'}}>
