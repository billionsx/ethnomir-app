...
`<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" style="position:absolute;inset:0;width:100%;height:100%"><defs><linearGradient id="z5" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#fff" stop-opacity=".1"/><stop offset="100%" stop-color="#fff" stop-opacity="0"/></linearGradient></defs><path d="M0 380 L55 320 L120 328 L190 260 L260 230 L330 170 L355 110 L355 400 L0 400Z" fill="url(#z5)"/><polyline points="0,380 55,320 120,328 190,260 260,230 330,170 355,110" fill="none" stroke="#fff" stroke-width="3.5" opacity=".35"/><polyline points="0,390 55,355 120,360 190,310 260,290 330,245 355,200" fill="none" stroke="#fff" stroke-width="1.2" opacity=".1" stroke-dasharray="6 4"/><circle cx="55" cy="320" r="7" fill="#fff" opacity=".35"><animate attributeName="r" values="4;9;4" dur="3s" repeatCount="indefinite"/></circle><circle cx="120" cy="328" r="6" fill="#fff" opacity=".3"><animate attributeName="r" values="3.5;8;3.5" dur="3.5s" repeatCount="indefinite" begin=".5s"/></circle><circle cx="190" cy="260" r="7" fill="#fff" opacity=".35"><animate attributeName="r" values="4;9;4" dur="2.8s" repeatCount="indefinite" begin="1s"/></circle><circle cx="260" cy="230" r="8" fill="#fff" opacity=".38"><animate attributeName="r" values="4;10;4" dur="3s" repeatCount="indefinite" begin="1.5s"/></circle><circle cx="330" cy="150" r="9" fill="#fff" opacity=".4"><animate attributeName="r" values="5;12;5" dur="2.5s" repeatCount="indefinite" begin="2s"/></circle><circle cx="355" cy="110" r="8" fill="#fff" opacity=".42"><animate attributeName="r" values="5;10;5" dur="2s" repeatCount="indefinite" begin="2.5s"/></circle><g opacity=".35"><line x1="350" y1="110" x2="355" y2="80" stroke="#fff" stroke-width="2.5"><animate attributeName="y2" values="90;72;90" dur="1.5s" repeatCount="indefinite"/></line><line x1="350" y1="110" x2="338" y2="88" stroke="#fff" stroke-width="2"><animate attributeName="y2" values="96;80;96" dur="1.5s" repeatCount="indefinite"/></line></g><rect x="15" y="340" width="50" height="60" rx="6" fill="#fff" opacity=".08"><animate attributeName="height" values="35;65;35" dur="4s" repeatCount="indefinite"/><animate attributeName="y" values="365;335;365" dur="4s" repeatCount="indefinite"/></rect><rect x="80" y="318" width="50" height="82" rx="6" fill="#fff" opacity=".07"><animate attributeName="height" values="55;88;55" dur="3.5s" repeatCount="indefinite" begin=".5s"/><animate attributeName="y" values="345;312;345" dur="3.5s" repeatCount="indefinite" begin=".5s"/></rect><rect x="145" y="295" width="50" height="105" rx="6" fill="#fff" opacity=".08"><animate attributeName="height" values="75;112;75" dur="4s" repeatCount="indefinite" begin="1s"/><animate attributeName="y" values="325;288;325" dur="4s" repeatCount="indefinite" begin="1s"/></rect><text x="358" y="35" fill="#fff" font-size="24" font-weight="800" font-family="system-ui" opacity=".25"><animate attributeName="opacity" values=".12;.32;.12" dur="3s" repeatCount="indefinite"/>22%</text><path d="M260 375 L275 330 L290 375Z" fill="#fff" opacity=".06"/><path d="M290 375 L308 315 L326 375Z" fill="#fff" opacity=".055"/><path d="M278 375 L295 305 L312 375Z" fill="#fff" opacity=".04"/></svg>`,
  ];
  const heroCards = [
