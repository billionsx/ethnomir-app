...
{q:'\u0427\u0442\u043e \u0432\u0445\u043e\u0434\u0438\u0442 \u0432 \u0441\u0442\u043e\u0438\u043c\u043e\u0441\u0442\u044c \u0431\u0438\u043b\u0435\u0442\u0430?',a:'\u041f\u043e\u0441\u0435\u0449\u0435\u043d\u0438\u0435 \u043c\u0443\u0437\u0435\u0435\u0432, \u0432\u044b\u0441\u0442\u0430\u0432\u043e\u043a, \u043c\u0430\u0441\u0442\u0435\u0440-\u043a\u043b\u0430\u0441\u0441\u043e\u0432 \u0438 \u044d\u043a\u0441\u043a\u0443\u0440\u0441\u0438\u0439 \u043f\u043e \u043f\u0440\u043e\u0433\u0440\u0430\u043c\u043c\u0435 \u0434\u043d\u044f. \u041f\u0440\u043e\u0433\u0440\u0430\u043c\u043c\u0430 \u2014 \u0432 \u041a\u0430\u043b\u0435\u043d\u0434\u0430\u0440\u0435 \u0441\u043e\u0431\u044b\u0442\u0438\u0439.',g:1,btn:{l:'\u041f\u0440\u043e\u0433\u0440\u0430\u043c\u043c\u0430 \u0434\u043d\u044f',t:'tab:home',c:BL}},
  ...
  return (
    <>
      ...
      <div className="eth" style={{width:'100%',maxWidth:390,height:'100dvh',margin:'0 auto',display:'flex',flexDirection:'column',background:'var(--bg)',overflow:'hidden',overflowX:'hidden',position:'relative'}}>
        ...
        {landingSlug && (landingSlug==='reviews'?<ReviewsLanding onClose={()=>setLandingSlug(null)}/>:landingSlug==='franchise'?<FranchiseLandingV2 onClose={()=>setLandingSlug(null)}/>:landingSlug==='arenda'?<ArendaLandingV2 onClose={()=>setLandingSlug(null)} session={session}/>:landingSlug==='business'?<BusinessLandingV2 onClose={()=>setLandingSlug(null)} session={session}/>:landingSlug==='build'?<BuildLandingV2 onClose={()=>setLandingSlug(null)} session={session}/>:landingSlug==='directions'?<DirectionsLandingV2 onClose={()=>setLandingSlug(null)}/>:landingSlug==='faq'?<FAQLandingV2 onClose={()=>setLandingSlug(null)} go={(t:string)=>{setLandingSlug(null);if(t.startsWith('tab:'))setTab(t.split(':')[1] as any);else setTimeout(()=>setLandingSlug(t),100);}}/>:<UniversalLanding slug={landingSlug} onClose={()=>setLandingSlug(null)} onNav={(t:any,s:any)=>{setLandingSlug(null);setPendingSec(s||"");setTab(t);}} onBuy={()=>{setLandingSlug(null);setShowTickets(true);}}/>)}
