  ...
  return (
    <div style={{position:"fixed",bottom:0,left:"50%",transform:"translateX(-50%)",width:"100%",maxWidth:390,zIndex:100,padding:"0 40px 40px 40px"}} className="em-tabbar">
      <div style={{
        ...
        <div ref={_pillRef} style={{position:"absolute",top:3,bottom:3,width:(100/tabs.length)+"%",left:0,transform:"translateX("+(tabs.findIndex(t=>t[0]===active)*100)+"%)",transition:_dragging.current?"none":"transform 0.55s cubic-bezier(0.32,0.72,0,1), box-shadow 0.3s",pointerEvents:"none",zIndex:0,padding:"0 5px",boxSizing:"border-box"}}>
          <div style={{width:"100%",height:"100%",borderRadius:18,background:"rgba(255,255,255,0.35)",backdropFilter:"blur(16px) saturate(180%)",WebkitBackdropFilter:"blur(16px) saturate(180%)",boxShadow:_dragging.current?"0 0 0 3px rgba(130,220,255,0.6), 0 0 30px 12px rgba(100,180,255,0.3), 0 0 25px 8px rgba(255,120,220,0.22), 0 0 50px 16px rgba(160,100,255,0.15)":"0 0 0 1px rgba(255,255,255,0.5), 0 0 8px 2px rgba(130,200,255,0.12), 0 0 6px 2px rgba(255,140,220,0.08), inset 0 0.5px 0 rgba(255,255,255,0.7)",animation:_dragging.current?"none":"glassShimmer 3s ease-in-out infinite",transition:"background 0.3s, box-shadow 0.3s, transform 0.3s",transform:_dragging.current?"scale(1.18)":"scale(1.02)"}}/>
        </div>
