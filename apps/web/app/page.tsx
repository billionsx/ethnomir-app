...
function HomeTab({onBuyTicket,onSearch,onMap,onQR,onProfile,onFranchise,onLanding,onNav}:{onBuyTicket?:()=>void,onSearch?:()=>void,onMap?:()=>void,onQR?:()=>void,onProfile?:()=>void,onNav?:(t:string,s?:string)=>void,onFranchise?:()=>void,onLanding?:(s:string)=>void}) {
  ...
  const heroSvgs = [
    '<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg" style="position:absolute;inset:0;opacity:.22"><defs><radialGradient id="sun1" cx="75%" cy="25%"><stop offset="0%" stopColor="#FFD700" stopOpacity=".6"/><stop offset="100%" stopColor="#FFD700" stopOpacity="0"/></radialGradient><linearGradient id="sky1" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#fff" stopOpacity=".05"/><stop offset="100%" stopColor="#fff" stopOpacity="0"/></linearGradient></defs><circle cx="300" cy="85" r="55" fill="url(#sun1)"/><circle cx="195" cy="220" r="85" fill="none" stroke="#fff" strokeWidth=".8" strokeDasharray="4 3" opacity=".3"/><circle cx="195" cy="220" r="65" fill="none" stroke="#fff" strokeWidth=".5" opacity=".15"/><path d="M195 135 C230 135 260 175 260 220 C260 265 230 305 195 305 C160 305 130 265 130 220 C130 175 160 135 195 135Z" fill="none" stroke="#fff" strokeWidth=".6" opacity=".2"/><path d="M110 220 L280 220" stroke="#fff" strokeWidth=".4" opacity=".15"/><path d="M130 180 L260 180" stroke="#fff" strokeWidth=".3" opacity=".12"/><path d="M130 260 L260 260" stroke="#fff" strokeWidth=".3" opacity=".12"/><path d="M40 340 Q70 310 100 330 Q130 290 165 320 Q195 300 225 325 Q260 305 290 330 Q320 310 350 340 L390 340 L390 400 L0 400 L0 340Z" fill="#fff" opacity=".06"/><rect x="60" y="305" width="16" height="35" rx="2" fill="#fff" opacity=".08"/><path d="M55 305 L68 290 L81 305Z" fill="#fff" opacity=".07"/><rect x="130" y="310" width="22" height="30" rx="1" fill="#fff" opacity=".06"/><circle cx="141" cy="300" r="10" fill="#fff" opacity=".05"/><rect x="220" y="300" width="18" height="40" rx="2" fill="#fff" opacity=".07"/><path d="M310 340 L320 295 L330 340Z" fill="#fff" opacity=".06"/><circle cx="50" cy="120" r="2" fill="#fff" opacity=".3"/><circle cx="120" cy="80" r="1.5" fill="#fff" opacity=".25"/><circle cx="340" cy="150" r="2" fill="#fff" opacity=".2"/><circle cx="270" cy="60" r="1" fill="#fff" opacity=".3"/></svg>',
    '<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg" style="position:absolute;inset:0;opacity:.2"><defs><radialGradient id="moon2" cx="80%" cy="20%"><stop offset="0%" stopColor="#E8D5B7" stopOpacity=".5"/><stop offset="100%" stopColor="#E8D5B7" stopOpacity="0"/></radialGradient></defs><circle cx="320" cy="70" r="25" fill="url(#moon2)"/><circle cx="320" cy="70" r="14" fill="#E8D5B7" opacity=".15"/><rect x="30" y="200" width="60" height="200" rx="4" fill="#fff" opacity=".06"/><rect x="40" y="215" width="10" height="10" rx="1" fill="#FFD700" opacity=".2"/><rect x="56" y="215" width="10" height="10" rx="1" fill="#FFD700" opacity=".15"/><rect x="40" y="235" width="10" height="10" rx="1" fill="#FFD700" opacity=".18"/><rect x="56" y="235" width="10" height="10" rx="1" fill="#FFD700" opacity=".12"/><rect x="40" y="255" width="10" height="10" rx="1" fill="#FFD700" opacity=".2"/><rect x="56" y="275" width="10" height="10" rx="1" fill="#FFD700" opacity=".16"/><rect x="120" y="170" width="55" height="230" rx="4" fill="#fff" opacity=".05"/><rect x="130" y="185" width="8" height="8" rx="1" fill="#FFD700" opacity=".18"/><rect x="145" y="185" width="8" height="8" rx="1" fill="#FFD700" opacity=".14"/><rect x="160" y="185" width="8" height="8" rx="1" fill="#FFD700" opacity=".2"/><rect x="130" y="205" width="8" height="8" rx="1" fill="#FFD700" opacity=".12"/><rect x="145" y="205" width="8" height="8" rx="1" fill="#FFD700" opacity=".18"/><rect x="130" y="225" width="8" height="8" rx="1" fill="#FFD700" opacity=".16"/><rect x="160" y="225" width="8" height="8" rx="1" fill="#FFD700" opacity=".14"/><rect x="220" y="230" width="50" height="170" rx="3" fill="#fff" opacity=".04"/><rect x="230" y="245" width="8" height="8" rx="1" fill="#FFD700" opacity=".16"/><rect x="248" y="245" width="8" height="8" rx="1" fill="#FFD700" opacity=".2"/><rect x="230" y="265" width="8" height="8" rx="1" fill="#FFD700" opacity=".14"/><rect x="248" y="265" width="8" height="8" rx="1" fill="#FFD700" opacity=".18"/><rect x="310" y="250" width="45" height="150" rx="3" fill="#fff" opacity=".05"/><rect x="320" y="265" width="8" height="8" rx="1" fill="#FFD700" opacity=".18"/><rect x="338" y="265" width="8" height="8" rx="1" fill="#FFD700" opacity=".12"/><rect x="320" y="285" width="8" height="8" rx="1" fill="#FFD700" opacity=".16"/><ellipse cx="100" cy="365" rx="30" ry="12" fill="#fff" opacity=".03"/><ellipse cx="280" cy="370" rx="25" ry="10" fill="#fff" opacity=".03"/></svg>',
    '<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg" style="position:absolute;inset:0;opacity:.18"><defs><radialGradient id="glow3" cx="60%" cy="50%"><stop offset="0%" stopColor="#fff" stopOpacity=".08"/><stop offset="100%" stopColor="#fff" stopOpacity="0"/></radialGradient></defs><ellipse cx="250" cy="240" rx="80" ry="28" fill="none" stroke="#fff" strokeWidth="1.2" opacity=".15"/><ellipse cx="250" cy="240" rx="60" ry="20" fill="#fff" opacity=".03"/><circle cx="250" cy="225" r="45" fill="url(#glow3)"/><path d="M230 195 Q234 170 232 155" stroke="#fff" strokeWidth="1.2" fill="none" opacity=".12" strokeLinecap="round"/><path d="M250 190 Q252 165 248 145" stroke="#fff" strokeWidth="1.5" fill="none" opacity=".15" strokeLinecap="round"/><path d="M270 195 Q268 172 272 158" stroke="#fff" strokeWidth="1" fill="none" opacity=".1" strokeLinecap="round"/><circle cx="80" cy="140" r="30" fill="none" stroke="#fff" strokeWidth=".8" opacity=".1"/><circle cx="80" cy="140" r="20" fill="#fff" opacity=".02"/><circle cx="340" cy="160" r="22" fill="none" stroke="#fff" strokeWidth=".6" opacity=".08"/><rect x="60" y="310" width="270" height="1" fill="#fff" opacity=".06"/><rect x="45" y="290" width="2" height="50" rx="1" fill="#fff" opacity=".08"/><rect x="345" y="290" width="2" height="50" rx="1" fill="#fff" opacity=".08"/><circle cx="140" cy="330" r="3" fill="#fff" opacity=".06"/><circle cx="200" cy="340" r="2" fill="#fff" opacity=".05"/><circle cx="300" cy="325" r="4" fill="#fff" opacity=".04"/></svg>',
    '<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg" style="position:absolute;inset:0;opacity:.18"><defs><radialGradient id="glow4" cx="55%" cy="55%"><stop offset="0%" stopColor="#fff" stopOpacity=".1"/><stop offset="100%" stopColor="#fff" stopOpacity="0"/></radialGradient></defs><circle cx="220" cy="210" r="90" fill="url(#glow4)"/><ellipse cx="220" cy="260" rx="55" ry="16" fill="none" stroke="#fff" strokeWidth="1" opacity=".15"/><path d="M190 260 Q195 220 200 190 Q210 165 220 160 Q230 165 240 190 Q245 220 250 260" fill="none" stroke="#fff" strokeWidth="1.2" opacity=".12"/><ellipse cx="220" cy="190" rx="25" ry="8" fill="none" stroke="#fff" strokeWidth=".6" opacity=".1"/><circle cx="220" cy="260" r="3" fill="#fff" opacity=".08"/><circle cx="80" cy="100" r="25" fill="none" stroke="#fff" strokeWidth="1" strokeDasharray="6 4" opacity=".12"><animateTransform attributeName="transform" type="rotate" from="0 80 100" to="360 80 100" dur="20s" repeatCount="indefinite"/></circle><circle cx="340" cy="130" r="18" fill="none" stroke="#fff" strokeWidth=".8" strokeDasharray="4 3" opacity=".1"><animateTransform attributeName="transform" type="rotate" from="360 340 130" to="0 340 130" dur="15s" repeatCount="indefinite"/></circle><circle cx="60" cy="280" r="8" fill="#fff" opacity=".04"/><circle cx="100" cy="180" r="5" fill="#fff" opacity=".05"/><circle cx="330" cy="270" r="6" fill="#fff" opacity=".03"/><circle cx="350" cy="320" r="10" fill="#fff" opacity=".03"/><path d="M150 340 Q160 325 170 340 Q180 355 190 340" fill="none" stroke="#fff" strokeWidth=".8" opacity=".08"/></svg>',
    '<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg" style="position:absolute;inset:0;opacity:.2"><polyline points="30,320 80,290 140,295 200,250 260,230 320,180 370,140" fill="none" stroke="#fff" strokeWidth="2" opacity=".2"/><path d="M30 320 L80 290 L140 295 L200 250 L260 230 L320 180 L370 140 L370 400 L30 400Z" fill="#fff" opacity=".03"/><circle cx="80" cy="290" r="4" fill="#fff" opacity=".2"/><circle cx="140" cy="295" r="4" fill="#fff" opacity=".2"/><circle cx="200" cy="250" r="4" fill="#fff" opacity=".25"/><circle cx="260" cy="230" r="4" fill="#fff" opacity=".25"/><circle cx="320" cy="180" r="5" fill="#fff" opacity=".3"/><circle cx="370" cy="140" r="6" fill="#fff" opacity=".3"/><line x1="370" y1="140" x2="370" y2="130" stroke="#fff" strokeWidth="2" opacity=".35"><animate attributeName="y2" values="140;125;140" dur="2s" repeatCount="indefinite"/></line><rect x="50" y="320" width="30" height="80" rx="3" fill="#fff" opacity=".05"/><rect x="90" y="300" width="30" height="100" rx="3" fill="#fff" opacity=".04"/><rect x="130" y="280" width="35" height="120" rx="3" fill="#fff" opacity=".05"/><ellipse cx="200" cy="350" rx="40" ry="15" fill="#fff" opacity=".03"/><path d="M260 340 Q270 310 280 340" fill="#fff" opacity=".04"/><path d="M290 340 Q300 300 310 340" fill="#fff" opacity=".04"/><path d="M270 340 Q285 290 300 340" fill="#fff" opacity=".03"/><text x="350" y="115" fill="#fff" fontSize="14" fontWeight="700" fontFamily="system-ui" opacity=".2">22%</text></svg>',
  ];
  const heroCards = [
