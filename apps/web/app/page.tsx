...
const submit=async()=>{if(!nm.trim()||!ph.trim()){setErr('\u0417\u0430\u043f\u043e\u043b\u043d\u0438\u0442\u0435 \u0432\u0441\u0435 \u043f\u043e\u043b\u044f');return;}setSending(true);setErr('');const ok=await submitContactRequest('build','landing_build',nm,ph);if(ok){setSent(true);logActivity('lead_build',{name:nm,phone:ph});}else setErr('\u041e\u0448\u0438\u0431\u043a\u0430');setSending(false);};
...
{/* HERO */}
<div style={{position:'relative',height:400,borderRadius:'0 0 20px 20px',overflow:'hidden'}}>
...
<div style={{position:'absolute',inset:0,background:'linear-gradient(180deg,rgba(21,10,32,.3) 0%,rgba(21,10,32,.85) 100%)'}}/>
...
<div style={{display:'inline-flex',height:24,padding:'0 10px',borderRadius:12,lineHeight:'24px',background:'rgba(175,82,222,.85)',backdropFilter:'blur(15px)',fontSize:11,fontWeight:700,color:'#fff',fontFamily:FT,letterSpacing:2,marginBottom:10}}>{'\u0418\u041d\u0412\u0415\u0421\u0422\u0418\u0426\u0418\u0418'}</div>
<div style={{fontSize:28,fontWeight:800,color:'#fff',fontFamily:FD,letterSpacing:'-1px',lineHeight:1.05,marginBottom:8}}>{'\u041f\u043e\u0441\u0442\u0440\u043e\u0438\u0442\u044c \u043d\u043e\u0432\u044b\u0439 \u0440\u0430\u0439\u043e\u043d \u042d\u0442\u043d\u043e\u043c\u0438\u0440\u0430'}</div>
<div style={{fontSize:14,color:'rgba(255,255,255,.8)',fontFamily:FT,lineHeight:1.5}}>{'\u0418\u043d\u0432\u0435\u0441\u0442\u0438\u0440\u0443\u0439\u0442\u0435 \u0432 \u0441\u0442\u0440\u043e\u0438\u0442\u0435\u043b\u044c\u0441\u0442\u0432\u043e \u043d\u043e\u0432\u043e\u0433\u043e \u044d\u0442\u043d\u043e\u0434\u0432\u043e\u0440\u0430. \u0417\u0435\u043c\u043b\u044f, \u043f\u0440\u043e\u0435\u043a\u0442, \u0443\u043f\u0440\u0430\u0432\u043b\u0435\u043d\u0438\u0435.'}</div>
</div></div>
{/* METRICS */}
<div style={{padding:'24px 20px 0'}}><div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10}}>
{[{t:'140 \u0433\u0430',l:'\u0442\u0435\u0440\u0440\u0438\u0442\u043e\u0440\u0438\u044f \u043f\u0430\u0440\u043a\u0430',c:P},{t:'85',l:'\u044d\u0442\u043d\u043e\u0434\u0432\u043e\u0440\u043e\u0432 \u0441\u0435\u0439\u0447\u0430\u0441',c:BL},{t:'250+',l:'\u043f\u043b\u0430\u043d \u044d\u0442\u043d\u043e\u0434\u0432\u043e\u0440\u043e\u0432',c:GR},{t:'\u043e\u0442 15M',l:'\u0432\u0445\u043e\u0434 \u0432 \u043f\u0440\u043e\u0435\u043a\u0442 \u20bd',c:OR}].map((s:any,i:number)=><div key={i} style={{background:'#fff',borderRadius:16,padding:'18px 12px',textAlign:'center'}}><div style={{fontSize:22,fontWeight:800,color:s.c,fontFamily:FD}}>{s.t}</div><div style={{fontSize:10,color:L2,fontFamily:FT,marginTop:3,textTransform:'uppercase',letterSpacing:1}}>{s.l}</div></div>)}
</div></div>
{/* CONCEPT */}
<div style={{padding:'16px 20px 0'}}><div style={{background:'#fff',borderRadius:16,padding:20}}>
<div style={{fontSize:20,fontWeight:700,fontFamily:FD,marginBottom:8}}>{'\u041a\u043e\u043d\u0446\u0435\u043f\u0446\u0438\u044f'}</div>
<div style={{fontSize:15,color:L2,fontFamily:FT,lineHeight:1.6}}>{'\u042d\u0442\u043d\u043e\u043c\u0438\u0440 \u2014 \u0441\u0442\u0440\u043e\u044f\u0449\u0438\u0439\u0441\u044f \u043f\u0440\u043e\u0435\u043a\u0442. \u0421\u0435\u0439\u0447\u0430\u0441 85 \u044d\u0442\u043d\u043e\u0434\u0432\u043e\u0440\u043e\u0432, \u043f\u043b\u0430\u043d \u2014 250+. \u041a\u0430\u0436\u0434\u044b\u0439 \u0434\u0432\u043e\u0440 \u2014 \u043a\u0443\u043b\u044c\u0442\u0443\u0440\u0430 \u0441\u0442\u0440\u0430\u043d\u044b: \u0430\u0440\u0445\u0438\u0442\u0435\u043a\u0442\u0443\u0440\u0430, \u043a\u0443\u0445\u043d\u044f, \u0440\u0435\u043c\u0451\u0441\u043b\u0430, \u043e\u0442\u0435\u043b\u044c. \u0418\u043d\u0432\u0435\u0441\u0442\u043e\u0440 \u0441\u0442\u0440\u043e\u0438\u0442 \u0434\u0432\u043e\u0440 \u0438 \u043f\u043e\u043b\u0443\u0447\u0430\u0435\u0442 \u0434\u043e\u0445\u043e\u0434 \u043e\u0442 \u044d\u043a\u0441\u043f\u043b\u0443\u0430\u0442\u0430\u0446\u0438\u0438.'}</div>
</div></div>
{/* INVEST TABLE */}
<div style={{padding:'16px 20px 0'}}><div style={{background:'#fff',borderRadius:16,padding:20}}>
...
<div style={{fontSize:20,fontWeight:700,fontFamily:FD,marginBottom:16}}>{'\u0418\u0441\u0442\u043e\u0447\u043d\u0438\u043a\u0438 \u0432\u044b\u0440\u0443\u0447\u043a\u0438 \u0434\u0432\u043e\u0440\u0430'}</div>
...
<div style={{fontSize:16,fontStyle:'italic',color:'#000',fontFamily:"Georgia,serif",lineHeight:1.6}}>{'\u00ab\u041a\u0430\u0436\u0434\u044b\u0439 \u044d\u0442\u043d\u043e\u0434\u0432\u043e\u0440 \u2014 \u044d\u0442\u043e \u043d\u0435 \u0437\u0434\u0430\u043d\u0438\u0435, \u0430 \u043f\u043e\u0441\u043e\u043b\u044c\u0441\u0442\u0432\u043e \u043a\u0443\u043b\u044c\u0442\u0443\u0440\u044b. \u041a\u0430\u0436\u0434\u044b\u0439 \u0438\u043d\u0432\u0435\u0441\u0442\u043e\u0440 \u0441\u0442\u0430\u043d\u043e\u0432\u0438\u0442\u0441\u044f \u0441\u043e\u0430\u0432\u0442\u043e\u0440\u043e\u043c \u043c\u0438\u0440\u043e\u0432\u043e\u0433\u043e \u043f\u0440\u043e\u0435\u043a\u0442\u0430.\u00bb'}</div>
...
<div className="tap" onClick={submit} style={{height:50,borderRadius:16,background:P,display:'flex',alignItems:'center',justifyContent:'center',opacity:sending?.5:1}}><span style={{fontSize:17,fontWeight:600,color:'#fff',fontFamily:FT}}>{sending?'\u041e\u0442\u043f\u0440\u0430\u0432\u043a\u0430...':'\u041e\u0442\u043f\u0440\u0430\u0432\u0438\u0442\u044c'}</span></div>
</div></div>}
{/* CONTACTS */}
