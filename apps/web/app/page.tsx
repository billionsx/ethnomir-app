...
const css=`.ar-a{opacity:0;transform:translateY(24px);transition:opacity .6s cubic-bezier(.22,1,.36,1),transform .6s cubic-bezier(.22,1,.36,1)}.ar-vis{opacity:1!important;transform:translateY(0)!important}.ar-d1{transition-delay:.06s}.ar-d2/*AV2*/// ArendaLandingV2 - iOS 26.3.1 light theme
function ArendaLandingV2({onClose,session}:{onClose:()=>void,session?:any}){
