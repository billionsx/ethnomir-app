...
</div>{crmSection==='bookings'&&crmOrders.length>0&&<div style={{marginTop:24}}>
...
{crmSection==='dashboard'&&<div style={{background:'linear-gradient(180deg,rgba(100,155,255,.10) 0%,rgba(170,150,240,.05) 40%,transparent 100%)',margin:-20,padding:20,borderRadius:20}}><div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:8,marginBottom:16}}>
