...
<div style={{padding:'3px 8px',borderRadius:6,background:(tc[c.type]||'#999')+'15',fontSize:10,fontWeight:700,color:tc[c.type]||'#999',fontFamily:FT,flexShrink:0,alignSelf:'flex-start'}}>{tl[c.type]||c.type}</div>
