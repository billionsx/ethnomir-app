...
{(crmData.staff||[]).map((s:any,i:number)=>{const rc:any={owner:'#FF2D55',director:'#5856D6',manager:'#FF9500',staff:'#34C759'};const rl:any={owner:'Владелец',director:'Директор',manager:'Менеджер',staff:'Сотрудник'};const dl:any={all:'Все',hotels:'Отели',restaurants:'Рестораны',tours:'Экскурсии',support:'Поддержка',masterclasses:'МК',shop:'Магазин',admin:'Admin'};return(<div key={s.id||i} style={{borderRadius:20,background:'rgba(255,255,255,.72)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'0.5px solid rgba(255,255,255,.6)',boxShadow:'0 0.5px 0 rgba(255,255,255,.9) inset, 0 2px 8px rgba(0,0,0,.03)',padding:'14px 16px',marginBottom:8,animation:`crmCardIn .3s cubic-bezier(0.2,0.8,0.2,1) ${i*0.05}s both`}}>
