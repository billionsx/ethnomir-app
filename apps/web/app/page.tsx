      ...
      {detailSheet&&(
        <div style={{position:"fixed",inset:0,zIndex:250,background:"var(--bg)",overflow:"auto",display:"flex",justifyContent:"center"}}>
          <div style={{width:"100%",maxWidth:390}}>
            ...
            <div style={{position:"fixed",bottom:0,left:0,right:0,zIndex:300,padding:"12px 20px 34px",background:"var(--bg2)",borderTop:"0.5px solid var(--sep)",display:"flex",justifyContent:"center",zIndex:260}}>
