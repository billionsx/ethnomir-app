...
<svg viewBox="0 0 310 120" style={{width:'100%'}}><defs><linearGradient id="vf" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor={I} stopOpacity="0.3"/><stop offset="100%" stopColor={I} stopOpacity="0"/></linearGradient></defs><polyline points="10,95 65,88 120,72 175,55 230,35 285,10" fill="none" stroke={I} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/><polygon points="10,95 65,88 120,72 175,55 230,35 285,10 285,112 10,112" fill="url(#vf)"/>
{[{x:10,y:95,l:'2008',v:'5'},{x:65,y:88,l:'2012',v:'20'},{x:120,y:72,l:'2016',v:'45'},{x:175,y:55,l:'2020',v:'65'},{x:230,y:35,l:'2024',v:'85'},{x:285,y:10,l:'2030',v:'250+'}].map((p:any,i:number)=><g key={i}><circle cx={p.x} cy={p.y} r="4" fill={i===5?OR:I}/><text x={p.x} y={p.y-8} textAnchor="middle" fontSize="8" fontWeight="700" fill={i===5?OR:I} fontFamily={FT}>{p.v}</text><text x={p.x} y={118} textAnchor="middle" fontSize="7" fill="rgba(60,60,67,.4)" fontFamily={FT}>{p.l}</text></g>)}</svg></div></div>
{/* DIRECTIONS */}
