...
<div style={{flex:1}}><div style={{fontSize:18,fontWeight:700,color:'var(--label)',fontFamily:FD}}>{_s(crmGuest.display_name||'Гость')}</div><div style={{fontSize:13,color:'var(--label3)',fontFamily:FT,marginTop:2}}>{(crmGuest.tags||[]).join(' · ')||'guest'}</div></div>
