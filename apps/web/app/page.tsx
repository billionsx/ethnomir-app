...
const L2='rgba(60,60,67,.60)',SEP='rgba(60,60,67,.1)';
const[nm,setNm]=(React as any).useState('');
...
(React as any).useEffect(()=>{const el=ref.current;if(!el)return;const t=setTimeout(()=>{const o=new IntersectionObserver(en=>{en.forEach(e=>{if(e.isIntersecting){e.target.classList.add('arv');o.unobserve(e.target);}});},{threshold:0.08,rootMargin:'0px 0px -30px 0px'});el.querySelectorAll('.ara').forEach((n:any)=>o.observe(n));},100);return()=>clearTimeout(t);},[]);
...
return <div ref={ref} style={{position:'fixed',inset:0,left:'50%',transform:'translateX(-50%)',width:'100%',maxWidth:390,zIndex:99,background:'linear-gradient(180deg,#E6F2FA 0%,#F2F2F7 12%,#F2F2F7 50%,#EBF8EE 75%,#F2F2F7 100%)',color:'#000',overflowY:'auto',WebkitOverflowScrolling:'touch'}}>
<style>{'.ara{opacity:0;transform:translateY(20px);transition:opacity .6s cubic-bezier(.22,1,.36,1),transform .6s cubic-bezier(.22,1,.36,1)}.arv{opacity:1!important;transform:none!important}.ard1{transition-delay:.07s}.ard2{transition-delay:.14s}.ard3{transition-delay:.21s}'}</style>
...
<div style={{position:'absolute',bottom:0,left:0,right:0,padding:'0 20px 28px'}}>
<div style={{display:'inline-flex',height:24,padding:'0 10px',borderRadius:12,lineHeight:'24px',background:'rgba(2,132,199,.85)',backdropFilter:'blur(15px)',WebkitBackdropFilter:'blur(15px)',fontSize:11,fontWeight:700,color:'#fff',fontFamily:FT,letterSpacing:2,marginBottom:10}}>{'\u0410\u0420\u0415\u041d\u0414\u0410'}</div>
...
<div className="ara" style={{padding:'24px 20px 0'}}><div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10}}>
{[['1M','\u0433\u043e\u0441\u0442\u0435\u0439/\u0433\u043e\u0434',B],['20K','\u043c\u0430\u043a\u0441/\u0434\u0435\u043d\u044c',GR],['30K','\u043c\u00b2 \u043f\u043b\u043e\u0449\u0430\u0434\u0435\u0439',OR],['3.5M','\u043f\u043b\u0430\u043d. \u043f\u043e\u0441.',PR]].map((s:any,i:number)=><div key={i} className={'ara ard'+i} style={{background:'#fff',borderRadius:16,padding:'16px 8px',textAlign:'center'}}><div style={{fontSize:26,fontWeight:800,color:s[2],fontFamily:FD}}>{s[0]}</div><div style={{fontSize:10,color:L2,fontFamily:FT,marginTop:2,textTransform:'uppercase',letterSpacing:1}}>{s[1]}</div></div>)}
</div></div>
<div className="ara" style={{padding:'20px 20px 0'}}><div style={{background:'#fff',borderRadius:16,padding:20}}>
<div style={{fontSize:22,fontWeight:700,fontFamily:FD,marginBottom:8}}>{'\u0423\u043b\u0438\u0446\u0430 \u041c\u0438\u0440\u0430 \u2014 1,5 \u043a\u043c \u0431\u0435\u0437 \u0430\u043b\u044c\u0442\u0435\u0440\u043d\u0430\u0442\u0438\u0432\u044b'}</div>
<div style={{fontSize:15,color:L2,fontFamily:FT,lineHeight:1.6}}>{'\u041a\u0430\u0436\u0434\u044b\u0439 \u0433\u043e\u0441\u0442\u044c \u043f\u0440\u043e\u0445\u043e\u0434\u0438\u0442 \u043c\u0438\u043c\u043e \u0434\u0432\u0430\u0436\u0434\u044b. \u0412\u044b\u0439\u0442\u0438 \u0434\u0440\u0443\u0433\u0438\u043c \u043f\u0443\u0442\u0451\u043c \u043d\u0435\u0432\u043e\u0437\u043c\u043e\u0436\u043d\u043e. \u0412\u0430\u0448\u0430 \u0442\u043e\u0447\u043a\u0430 \u2014 \u043d\u0430 \u0435\u0434\u0438\u043d\u0441\u0442\u0432\u0435\u043d\u043d\u043e\u043c \u043f\u0443\u0442\u0438 \u043c\u0438\u043b\u043b\u0438\u043e\u043d\u0430 \u0447\u0435\u043b\u043e\u0432\u0435\u043a \u0432 \u0433\u043e\u0434.'}</div>
</div></div>
<div className="ara" style={{padding:'20px 20px 0'}}><div style={{background:'#fff',borderRadius:16,overflow:'hidden'}}>
<div style={{padding:'16px 16px 8px'}}><div style={{fontSize:12,fontWeight:700,color:RD,letterSpacing:2,textTransform:'uppercase',fontFamily:FT}}>{'\u0417\u041e\u041d\u042b \u0410\u0420\u0415\u041d\u0414\u042b'}</div><div style={{fontSize:20,fontWeight:700,fontFamily:FD,marginTop:4}}>{'\u043e\u0442 1 200 \u20bd/\u043c\u00b2'}</div></div>
{[['\u0423\u043b\u0438\u0446\u0430 \u041c\u0438\u0440\u0430','3 500',RD],['\u042d\u0442\u043d\u043e\u0434\u0432\u043e\u0440\u044b','2 200',OR],['\u041f\u043b\u043e\u0449\u0430\u0434\u043a\u0438','1 200',GR],['\u0420\u0435\u0441\u0442\u043e\u0440\u0430\u043d\u044b','2 800',B]].map((z:any,i:number)=><div key={i} style={{display:'flex',justifyContent:'space-between',alignItems:'center',padding:'12px 16px',borderTop:'0.5px solid '+SEP}}><div style={{fontSize:15,fontWeight:600,fontFamily:FD}}>{z[0]}</div><div style={{fontSize:15,fontWeight:700,color:z[2],fontFamily:FD}}>{z[1]+' \u20bd/\u043c\u00b2'}</div></div>)}
</div></div>
<div className="ara" style={{padding:'20px 20px 0'}}><div style={{textAlign:'center',marginBottom:12}}><div style={{fontSize:12,fontWeight:700,color:GR,letterSpacing:2,textTransform:'uppercase',fontFamily:FT}}>{'\u041f\u0423\u0422\u042c \u0410\u0420\u0415\u041d\u0414\u0410\u0422\u041e\u0420\u0410'}</div><div style={{fontSize:20,fontWeight:700,fontFamily:FD}}>{'\u041e\u0442 \u0437\u0430\u044f\u0432\u043a\u0438 \u0434\u043e \u0437\u0430\u043f\u0443\u0441\u043a\u0430 \u2014 14 \u0434\u043d\u0435\u0439'}</div></div>
<div style={{background:'#fff',borderRadius:16,overflow:'hidden'}}>
{[['1','\u0417\u0430\u044f\u0432\u043a\u0430','\u042d\u043a\u0441\u043a\u0443\u0440\u0441\u0438\u044f \u043f\u043e \u0434\u043e\u0441\u0442\u0443\u043f\u043d\u044b\u043c \u043f\u043b\u043e\u0449\u0430\u0434\u043a\u0430\u043c',B],['2','\u041f\u043e\u0434\u0431\u043e\u0440','\u0410\u043d\u0430\u043b\u0438\u0442\u0438\u043a\u0430 \u0442\u0440\u0430\u0444\u0438\u043a\u0430 \u0438 \u043b\u0443\u0447\u0448\u0430\u044f \u043b\u043e\u043a\u0430\u0446\u0438\u044f',GR],['3','\u0414\u043e\u0433\u043e\u0432\u043e\u0440','\u0424\u0438\u043a\u0441 \u0438\u043b\u0438 % \u043e\u0442 \u043e\u0431\u043e\u0440\u043e\u0442\u0430. \u041a\u043e\u043c\u043c\u0443\u043d\u0438\u043a\u0430\u0446\u0438\u0438 \u0432\u043a\u043b.',OR],['4','\u0417\u0430\u043f\u0443\u0441\u043a','\u041c\u0430\u0440\u043a\u0435\u0442\u0438\u043d\u0433 \u043f\u0430\u0440\u043a\u0430 + \u043f\u0440\u0438\u043b\u043e\u0436\u0435\u043d\u0438\u0435 \u042d\u0442\u043d\u043e\u043c\u0438\u0440',PR]].map((s:any,i:number,a:any[])=><div key={i} style={{display:'flex',gap:14,padding:'14px 16px',borderBottom:i<a.length-1?'0.5px solid '+SEP:'none'}}><div style={{width:32,height:32,borderRadius:16,background:s[3]+'15',display:'flex',alignItems:'center',justifyContent:'center',fontSize:15,fontWeight:800,color:s[3],fontFamily:FD,flexShrink:0}}>{s[0]}</div><div><div style={{fontSize:15,fontWeight:600,fontFamily:FD}}>{s[1]}</div><div style={{fontSize:13,color:L2,fontFamily:FT,lineHeight:1.4,marginTop:2}}>{s[2]}</div></div></div>)}
</div></div>
<div className="ara" style={{padding:'20px 20px 0'}}><div style={{textAlign:'center',marginBottom:12}}><div style={{fontSize:12,fontWeight:700,color:IN,letterSpacing:2,textTransform:'uppercase',fontFamily:FT}}>{'\u041f\u0420\u0415\u0418\u041c\u0423\u0429\u0415\u0421\u0422\u0412\u0410'}</div><div style={{fontSize:20,fontWeight:700,fontFamily:FD}}>{'\u041f\u043e\u0447\u0435\u043c\u0443 \u0430\u0440\u0435\u043d\u0434\u0430\u0442\u043e\u0440\u044b \u043e\u0441\u0442\u0430\u044e\u0442\u0441\u044f'}</div></div>
<div style={{background:'#fff',borderRadius:16,overflow:'hidden'}}>
{[['\ud83d\udd27','\u0418\u043d\u0444\u0440\u0430\u0441\u0442\u0440\u0443\u043a\u0442\u0443\u0440\u0430','\u0412\u043e\u0434\u0430, \u0441\u0432\u0435\u0442, Wi-Fi, \u043e\u0445\u0440\u0430\u043d\u0430 \u2014 \u0437\u0430 \u0441\u0447\u0451\u0442 \u043f\u0430\u0440\u043a\u0430'],['\ud83d\udcf1','\u041c\u0430\u0440\u043a\u0435\u0442\u0438\u043d\u0433','\u0422\u043e\u0447\u043a\u0430 \u0432 \u043f\u0440\u0438\u043b\u043e\u0436\u0435\u043d\u0438\u0438 \u0438 \u043d\u0430 \u043a\u0430\u0440\u0442\u0435 \u043f\u0430\u0440\u043a\u0430'],['\ud83e\udd1d','\u0413\u0438\u0431\u043a\u043e\u0441\u0442\u044c','\u0421\u0435\u0437\u043e\u043d/\u0434\u043e\u043b\u0433\u043e\u0441\u0440\u043e\u043a. \u0424\u0438\u043a\u0441 \u0438\u043b\u0438 % \u043e\u0431\u043e\u0440\u043e\u0442\u0430'],['\ud83c\udfdb','\u0411\u0440\u0435\u043d\u0434 \u042e\u041d\u0415\u0421\u041a\u041e','\u041a\u0443\u043b\u044c\u0442\u0443\u0440\u043d\u044b\u0439 \u043f\u0440\u043e\u0435\u043a\u0442 \u043c\u0438\u0440\u043e\u0432\u043e\u0433\u043e \u0443\u0440\u043e\u0432\u043d\u044f']].map((it:any,i:number,a:any[])=><div key={i} className={'ara ard'+i} style={{display:'flex',gap:14,padding:'14px 16px',borderBottom:i<a.length-1?'0.5px solid '+SEP:'none'}}><div style={{width:40,height:40,borderRadius:12,background:'#F2F2F7',display:'flex',alignItems:'center',justifyContent:'center',fontSize:20,flexShrink:0}}>{it[0]}</div><div><div style={{fontSize:15,fontWeight:600,fontFamily:FD}}>{it[1]}</div><div style={{fontSize:13,color:L2,fontFamily:FT,lineHeight:1.4,marginTop:2}}>{it[2]}</div></div></div>)}
</div></div>
<div className="ara" style={{padding:'20px 20px 0'}}><div style={{background:'#fff',borderRadius:16,padding:'20px 20px 20px 23px',borderLeft:'3px solid '+B}}>
<div style={{fontSize:17,fontWeight:400,color:'#000',fontFamily:"Georgia,'Times New Roman',serif",fontStyle:'italic',lineHeight:1.6}}>{'\u00ab\u041c\u043e\u044f \u043c\u0435\u0447\u0442\u0430 \u2014 \u043c\u0430\u043b\u044b\u0439 \u0438 \u0441\u0440\u0435\u0434\u043d\u0438\u0439 \u0431\u0438\u0437\u043d\u0435\u0441, \u0434\u043b\u044f \u043a\u043e\u0442\u043e\u0440\u043e\u0433\u043e \u043c\u044b \u0441\u043e\u0437\u0434\u0430\u043b\u0438 \u0432\u0441\u0435 \u0443\u0441\u043b\u043e\u0432\u0438\u044f.\u00bb'}</div>
<div style={{fontSize:13,color:'rgba(60,60,67,.30)',fontFamily:FT,marginTop:10}}>{'\u0420\u0443\u0441\u043b\u0430\u043d \u0411\u0430\u0439\u0440\u0430\u043c\u043e\u0432, \u043e\u0441\u043d\u043e\u0432\u0430\u0442\u0435\u043b\u044c \u042d\u0442\u043d\u043e\u043c\u0438\u0440\u0430'}</div>
</div></div>


<div style={{padding:'24px 20px 0'}}><div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10}}>
{[{t:'1 000 000+',l:'\u0413\u043e\u0441\u0442\u0435\u0439 / \u0433\u043e\u0434',c:B},{t:'20 000',l:'\u041c\u0430\u043a\u0441. / \u0434\u0435\u043d\u044c',c:'#34C759'},{t:'30 000 \u043c\u00b2',l:'\u041f\u043b\u043e\u0449\u0430\u0434\u0435\u0439',c:'#FF9500'},{t:'3 500 000',l:'\u041f\u043b\u0430\u043d \u043f\u043e\u0441\u0435\u0449.',c:'#AF52DE'}].map((s:any,i:number)=><div key={i} style={{background:'#fff',borderRadius:16,padding:'18px 12px',textAlign:'center'}}><div style={{fontSize:22,fontWeight:800,color:s.c,fontFamily:FD}}>{s.t}</div><div style={{fontSize:10,color:L2,fontFamily:FT,marginTop:3,textTransform:'uppercase',letterSpacing:1}}>{s.l}</div></div>)}
</div></div>
<div style={{padding:'16px 20px 0'}}><div style={{background:'#fff',borderRadius:16,padding:20}}>
<div style={{fontSize:12,fontWeight:700,color:'#FF3B30',letterSpacing:2,textTransform:'uppercase',fontFamily:FT,marginBottom:4}}>{'\u0417\u0410\u041f\u041e\u041b\u041d\u0415\u041d\u041d\u041e\u0421\u0422\u042c'}</div>
<div style={{fontSize:20,fontWeight:700,fontFamily:FD,marginBottom:16}}>{'\u0423\u0441\u043f\u0435\u0439\u0442\u0435 \u0437\u0430\u043d\u044f\u0442\u044c \u043f\u043b\u043e\u0449\u0430\u0434\u043a\u0443'}</div>
{[{p:87,c:'#FF3B30',l:'\u0423\u043b\u0438\u0446\u0430 \u041c\u0438\u0440\u0430'},{p:65,c:'#FF9500',l:'\u042d\u0442\u043d\u043e\u0434\u0432\u043e\u0440\u044b'},{p:40,c:'#34C759',l:'\u041e\u0442\u043a\u0440\u044b\u0442\u044b\u0435 \u043f\u043b\u043e\u0449\u0430\u0434\u043a\u0438'},{p:55,c:B,l:'\u0420\u0435\u0441\u0442\u043e\u0440\u0430\u043d\u044b'}].map((m:any,i:number)=><div key={i} style={{marginBottom:i<3?14:0}}><div style={{display:'flex',justifyContent:'space-between',marginBottom:4}}><span style={{fontSize:14,fontWeight:600,color:'#000',fontFamily:FD}}>{m.l}</span><span style={{fontSize:14,fontWeight:700,color:m.c,fontFamily:FD}}>{m.p}%</span></div><div style={{height:8,borderRadius:4,background:'rgba(120,120,128,.08)'}}><div style={{height:8,borderRadius:4,background:m.c,width:m.p+'%',transition:'width 1.2s cubic-bezier(0.2,0.8,0.2,1)'}}/></div></div>)}
</div></div>
...
{[{n:'\u0423\u043b\u0438\u0446\u0430',p:3500},{n:'\u0414\u0432\u043e\u0440\u044b',p:2200},{n:'\u041f\u043b\u043e\u0449.',p:1200},{n:'\u0420\u0435\u0441\u0442.',p:2800}].map((z:any,i:number)=><div key={i} className="tap" onClick={()=>setZone(i)} style={{flex:1,textAlign:'center',padding:'7px 4px',borderRadius:8,background:zone===i?'#fff':'transparent',boxShadow:zone===i?'0 1px 4px rgba(0,0,0,.08)':'none',transition:'all .25s'}}><span style={{fontSize:11,fontWeight:zone===i?700:400,color:zone===i?'#000':L2,fontFamily:FT}}>{z.n}</span></div>)}
</div></div>
...
<input type="range" min={5} max={200} value={area} onChange={(e:any)=>setArea(+e.target.value)} style={{width:'100%',accentColor:B}}/>
</div>
<div style={{borderTop:'1px solid rgba(60,60,67,.1)',padding:16,display:'flex',justifyContent:'space-between',alignItems:'center'}}><div><div style={{fontSize:11,color:L2,fontFamily:FT,textTransform:'uppercase',letterSpacing:.5}}>{'\u043e\u0442 / \u043c\u0435\u0441\u044f\u0446'}</div><div style={{fontSize:28,fontWeight:800,color:B,fontFamily:FD}}>{(area*[3500,2200,1200,2800][zone]).toLocaleString('ru')} {'\u20bd'}</div></div><div style={{fontSize:13,color:L2,fontFamily:FT,textAlign:'right'}}>{[3500,2200,1200,2800][zone].toLocaleString('ru')} {'\u20bd/\u043c\u00b2'}</div></div>
</div></div>
<div style={{padding:'16px 20px 0'}}><div style={{fontSize:12,fontWeight:700,color:'#FF9500',letterSpacing:2,textTransform:'uppercase',fontFamily:FT,textAlign:'center',marginBottom:8}}>{'\u0421\u0415\u0417\u041e\u041d\u041d\u041e\u0421\u0422\u042c'}</div>
<div style={{fontSize:22,fontWeight:800,fontFamily:FD,textAlign:'center',marginBottom:12}}>{'365 \u0434\u043d\u0435\u0439 \u0434\u043e\u0445\u043e\u0434\u0430'}</div>
{[{e:'\u2600\ufe0f',t:'\u041b\u0435\u0442\u043e',d:'\u041f\u0438\u043a. \u0424\u0435\u0441\u0442\u0438\u0432\u0430\u043b\u0438, \u0434\u043e 20K/\u0434\u0435\u043d\u044c',c:'#FF9500'},{e:'\u2744\ufe0f',t:'\u0417\u0438\u043c\u0430',d:'\u041d\u043e\u0432\u044b\u0439 \u0433\u043e\u0434 + \u041c\u0430\u0441\u043b\u0435\u043d\u0438\u0446\u0430',c:B},{e:'\ud83c\udf42',t:'\u041e\u0441\u0435\u043d\u044c+\u0412\u0435\u0441\u043d\u0430',d:'\u0428\u043a\u043e\u043b\u044b, \u043a\u043e\u0440\u043f\u043e\u0440\u0430\u0442\u0438\u0432\u044b',c:'#34C759'}].map((c:any,i:number)=><div key={i} style={{background:'#fff',borderRadius:16,padding:16,marginBottom:10,display:'flex',gap:12,alignItems:'center'}}><div style={{width:44,height:44,borderRadius:14,background:c.c+'12',display:'flex',alignItems:'center',justifyContent:'center',fontSize:22,flexShrink:0}}>{c.e}</div><div><div style={{fontSize:16,fontWeight:700,fontFamily:FD}}>{c.t}</div><div style={{fontSize:13,color:L2,fontFamily:FT,marginTop:2}}>{c.d}</div></div></div>)}
</div>
<div style={{padding:'16px 20px 0'}}><div style={{fontSize:12,fontWeight:700,color:'#34C759',letterSpacing:2,textTransform:'uppercase',fontFamily:FT,textAlign:'center',marginBottom:8}}>{'\u041f\u0423\u0422\u042c \u0410\u0420\u0415\u041d\u0414\u0410\u0422\u041e\u0420\u0410'}</div>
<div style={{fontSize:22,fontWeight:800,fontFamily:FD,textAlign:'center',marginBottom:12}}>{'\u041e\u0442 \u0437\u0430\u044f\u0432\u043a\u0438 \u0434\u043e \u043a\u043b\u0438\u0435\u043d\u0442\u0430 \u2014 14 \u0434\u043d\u0435\u0439'}</div>
<div style={{background:'#fff',borderRadius:16,overflow:'hidden'}}>
{[{n:'1',t:'\u0417\u0430\u044f\u0432\u043a\u0430',d:'\u042d\u043a\u0441\u043a\u0443\u0440\u0441\u0438\u044f \u043f\u043e \u043f\u043b\u043e\u0449\u0430\u0434\u043a\u0430\u043c',c:B},{n:'2',t:'\u041f\u043e\u0434\u0431\u043e\u0440',d:'\u0410\u043d\u0430\u043b\u0438\u0442\u0438\u043a\u0430 \u0442\u0440\u0430\u0444\u0438\u043a\u0430',c:'#34C759'},{n:'3',t:'\u0414\u043e\u0433\u043e\u0432\u043e\u0440',d:'\u0424\u0438\u043a\u0441 \u0438\u043b\u0438 % \u043e\u0442 \u043e\u0431\u043e\u0440\u043e\u0442\u0430',c:'#FF9500'},{n:'4',t:'\u0417\u0430\u043f\u0443\u0441\u043a',d:'\u041c\u0430\u0440\u043a\u0435\u0442\u0438\u043d\u0433 + \u043f\u0440\u0438\u043b\u043e\u0436\u0435\u043d\u0438\u0435',c:'#AF52DE'}].map((s:any,i:number)=><div key={i} style={{display:'flex',gap:14,padding:'14px 16px',borderBottom:i<3?'1px solid rgba(60,60,67,.1)':'none'}}><div style={{width:32,height:32,borderRadius:16,background:s.c+'12',display:'flex',alignItems:'center',justifyContent:'center',fontSize:15,fontWeight:800,color:s.c,fontFamily:FD,flexShrink:0}}>{s.n}</div><div><div style={{fontSize:16,fontWeight:700,fontFamily:FD}}>{s.t}</div><div style={{fontSize:13,color:L2,fontFamily:FT,marginTop:2}}>{s.d}</div></div></div>)}
</div></div>
<div style={{padding:'16px 20px 0'}}><div style={{fontSize:12,fontWeight:700,color:'#5856D6',letterSpacing:2,textTransform:'uppercase',fontFamily:FT,textAlign:'center',marginBottom:8}}>{'\u041f\u0420\u0415\u0418\u041c\u0423\u0429\u0415\u0421\u0422\u0412\u0410'}</div>
<div style={{background:'#fff',borderRadius:16,overflow:'hidden'}}>
{[{e:'\ud83d\udd27',t:'\u0418\u043d\u0444\u0440\u0430\u0441\u0442\u0440\u0443\u043a\u0442\u0443\u0440\u0430',d:'\u0412\u043e\u0434\u0430, \u044d\u043b\u0435\u043a\u0442\u0440\u0438\u0447\u0435\u0441\u0442\u0432\u043e, Wi-Fi, \u043e\u0445\u0440\u0430\u043d\u0430'},{e:'\ud83d\udcf1',t:'\u0426\u0438\u0444\u0440\u043e\u0432\u043e\u0439 \u043c\u0430\u0440\u043a\u0435\u0442\u0438\u043d\u0433',d:'\u0422\u043e\u0447\u043a\u0430 \u0432 \u043f\u0440\u0438\u043b\u043e\u0436\u0435\u043d\u0438\u0438 + \u043a\u0430\u0440\u0442\u0430 \u043f\u0430\u0440\u043a\u0430'},{e:'\ud83e\udd1d',t:'\u0413\u0438\u0431\u043a\u0438\u0435 \u0443\u0441\u043b\u043e\u0432\u0438\u044f',d:'\u0414\u043e\u043b\u0433\u043e\u0441\u0440\u043e\u0447\u043d\u043e \u0438\u043b\u0438 \u0441\u0435\u0437\u043e\u043d\u043d\u043e'},{e:'\ud83c\udfdb',t:'\u0411\u0440\u0435\u043d\u0434 \u042e\u041d\u0415\u0421\u041a\u041e',d:'\u041a\u0443\u043b\u044c\u0442\u0443\u0440\u043d\u044b\u0439 \u043f\u0440\u043e\u0435\u043a\u0442 \u043c\u0438\u0440\u043e\u0432\u043e\u0433\u043e \u0443\u0440\u043e\u0432\u043d\u044f'}].map((it:any,i:number)=><div key={i} style={{display:'flex',gap:14,padding:'14px 16px',borderBottom:i<3?'1px solid rgba(60,60,67,.1)':'none'}}><div style={{width:40,height:40,borderRadius:12,background:'#F2F2F7',display:'flex',alignItems:'center',justifyContent:'center',fontSize:20,flexShrink:0}}>{it.e}</div><div><div style={{fontSize:15,fontWeight:600,fontFamily:FD}}>{it.t}</div><div style={{fontSize:13,color:L2,fontFamily:FT,marginTop:2}}>{it.d}</div></div></div>)}
</div></div>
...
<div style={{fontSize:16,fontWeight:400,color:'#000',fontFamily:"Georgia,serif",fontStyle:'italic',lineHeight:1.6}}>{'\u00ab\u041c\u043e\u044f \u043c\u0435\u0447\u0442\u0430 \u2014 \u043c\u0430\u043b\u044b\u0439 \u0438 \u0441\u0440\u0435\u0434\u043d\u0438\u0439 \u0431\u0438\u0437\u043d\u0435\u0441, \u0434\u043b\u044f \u043a\u043e\u0442\u043e\u0440\u043e\u0433\u043e \u043c\u044b \u0441\u043e\u0437\u0434\u0430\u043b\u0438 \u0432\u0441\u0435 \u0443\u0441\u043b\u043e\u0432\u0438\u044f.\u00bb'}</div>
<div style={{fontSize:13,color:L2,fontFamily:FT,marginTop:8}}>{'\u0420\u0443\u0441\u043b\u0430\u043d \u0411\u0430\u0439\u0440\u0430\u043c\u043e\u0432, \u043e\u0441\u043d\u043e\u0432\u0430\u0442\u0435\u043b\u044c \u042d\u0442\u043d\u043e\u043c\u0438\u0440\u0430'}</div>
</div></div>{sent?<div style={{padding:'24px 20px 0'}}><div style={{borderRadius:16,background:'rgba(52,199,89,.06)',border:'1px solid rgba(52,199,89,.12)',padding:'28px 16px',textAlign:'center'}}><div style={{fontSize:36,marginBottom:4}}>{'\u2705'}</div><div style={{fontSize:17,fontWeight:700,color:GR,fontFamily:FD}}>{'\u041e\u0442\u043f\u0440\u0430\u0432\u043b\u0435\u043d\u043e!'}</div></div></div>
:<div style={{padding:'24px 20px 0'}}><div style={{background:'#fff',borderRadius:16,padding:20,textAlign:'center'}}>
<div style={{fontSize:22,fontWeight:800,fontFamily:FD,marginBottom:4}}>{'\u041f\u043e\u043b\u0443\u0447\u0438\u0442\u044c \u0440\u0430\u0441\u0447\u0451\u0442'}</div>
<div style={{fontSize:14,color:L2,fontFamily:FT,marginBottom:16}}>{'\u041c\u0435\u043d\u0435\u0434\u0436\u0435\u0440 \u043f\u043e\u0434\u0433\u043e\u0442\u043e\u0432\u0438\u0442 \u043f\u0440\u0435\u0434\u043b\u043e\u0436\u0435\u043d\u0438\u0435 \u0437\u0430 24 \u0447\u0430\u0441\u0430'}</div>
<div style={{textAlign:'left',marginBottom:10}}><input value={nm} onChange={(e:any)=>setNm(e.target.value)} placeholder={'\u0418\u043c\u044f'} style={{width:'100%',padding:'14px 16px',borderRadius:12,border:'1px solid '+SEP,background:'#F2F2F7',fontSize:16,fontFamily:FT,color:'#000',outline:'none',boxSizing:'border-box'}}/></div>
<div style={{textAlign:'left',marginBottom:16}}><input value={ph} onChange={(e:any)=>setPh(e.target.value)} placeholder="+7 900 123-45-67" type="tel" style={{width:'100%',padding:'14px 16px',borderRadius:12,border:'1px solid '+SEP,background:'#F2F2F7',fontSize:16,fontFamily:FT,color:'#000',outline:'none',boxSizing:'border-box'}}/></div>
{err&&<div style={{fontSize:13,color:RD,fontFamily:FT,marginBottom:8}}>{err}</div>}
<div className="tap" onClick={submit} style={{height:50,borderRadius:16,background:B,display:'flex',alignItems:'center',justifyContent:'center',opacity:sending?.5:1,boxShadow:'0 4px 16px rgba(2,132,199,.25)'}}><span style={{fontSize:17,fontWeight:600,color:'#fff',fontFamily:FT}}>{sending?'\u041e\u0442\u043f\u0440\u0430\u0432\u043a\u0430...':'\u041e\u0442\u043f\u0440\u0430\u0432\u0438\u0442\u044c \u0437\u0430\u044f\u0432\u043a\u0443'}</span></div>
</div></div>}
<div className="ara" style={{padding:'16px 20px 0'}}><div style={{background:'#fff',borderRadius:16,padding:18}}>
<div style={{fontSize:17,fontWeight:700,fontFamily:FD,marginBottom:8}}>{'\u041a\u043e\u043d\u0442\u0430\u043a\u0442\u044b \u043e\u0442\u0434\u0435\u043b\u0430 \u0430\u0440\u0435\u043d\u0434\u044b'}</div>
<div style={{fontSize:14,color:L2,fontFamily:FT,lineHeight:1.8}}>+7 495 023-81-81<br/>arenda@ethnomir.ru<br/>ethnomir.ru/arenda</div>
</div></div>
<div style={{height:80}}/>
</div>;
}
...
function ArendaLandingV2({onClose,session}:{onClose:()=>void,session?:any}){
const B='#0284C7',FD="-apple-system,'SF Pro Display',system-ui,sans-serif",FT="-apple-system,'SF Pro Text',system-ui,sans-serif";
...
<div style={{position:'relative',height:360,borderRadius:'0 0 20px 20px',overflow:'hidden'}}>
<img src="https://ethnomir.ru/upload/iblock/f94/1.jpg" alt="" style={{width:'100%',height:'100%',objectFit:'cover',position:'absolute',inset:0}}/>
<div style={{position:'absolute',inset:0,background:'linear-gradient(180deg,transparent 0%,rgba(0,0,0,.7) 100%)'}}/>
<div className="tap" onClick={onClose} style={{position:'absolute',top:54,left:16,width:36,height:36,borderRadius:22,background:'rgba(255,255,255,.18)',backdropFilter:'blur(20px)',WebkitBackdropFilter:'blur(20px)',display:'flex',alignItems:'center',justifyContent:'center',cursor:'pointer'}}><svg width="10" height="17" viewBox="0 0 10 17" fill="none"><path d="M9 1L1.5 8.5L9 16" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></div>
<div style={{position:'absolute',bottom:0,left:0,right:0,padding:'0 20px 28px'}}>
<div style={{fontSize:32,fontWeight:800,color:'#fff',fontFamily:FD,letterSpacing:'-1px',lineHeight:1.05,marginBottom:8}}>{'\u0410\u0440\u0435\u043d\u0434\u0430 \u043f\u043b\u043e\u0449\u0430\u0434\u0435\u0439'}</div>
...
<div style={{fontSize:22,fontWeight:700,fontFamily:FD,marginBottom:8}}>{'\u041f\u043e\u0447\u0435\u043c\u0443 \u042d\u0442\u043d\u043e\u043c\u0438\u0440?'}</div>
<div style={{fontSize:15,color:L2,fontFamily:FT,lineHeight:1.6}}>{'\u0411\u043e\u043b\u0435\u0435 1 \u043c\u043b\u043d \u0433\u043e\u0441\u0442\u0435\u0439 \u0432 \u0433\u043e\u0434. \u0423\u043b\u0438\u0446\u0430 \u041c\u0438\u0440\u0430 \u2014 1,5 \u043a\u043c \u0431\u0435\u0437 \u0430\u043b\u044c\u0442\u0435\u0440\u043d\u0430\u0442\u0438\u0432\u044b. \u0413\u043e\u0442\u043e\u0432\u0430\u044f \u0438\u043d\u0444\u0440\u0430\u0441\u0442\u0440\u0443\u043a\u0442\u0443\u0440\u0430, \u0446\u0438\u0444\u0440\u043e\u0432\u043e\u0439 \u043c\u0430\u0440\u043a\u0435\u0442\u0438\u043d\u0433, \u0433\u0438\u0431\u043a\u0438\u0435 \u0443\u0441\u043b\u043e\u0432\u0438\u044f.'}</div>
</div></div>
...
<div style={{fontSize:16,fontWeight:400,color:'#000',fontFamily:"Georgia,serif",fontStyle:'italic',lineHeight:1.6}}>{'\u00ab\u041c\u043e\u044f \u043c\u0435\u0447\u0442\u0430 \u2014 \u043c\u0430\u043b\u044b\u0439 \u0438 \u0441\u0440\u0435\u0434\u043d\u0438\u0439 \u0431\u0438\u0437\u043d\u0435\u0441, \u0434\u043b\u044f \u043a\u043e\u0442\u043e\u0440\u043e\u0433\u043e \u043c\u044b \u0441\u043e\u0437\u0434\u0430\u043b\u0438 \u0432\u0441\u0435 \u0443\u0441\u043b\u043e\u0432\u0438\u044f.\u00bb'}</div>
<div style={{fontSize:13,color:L2,fontFamily:FT,marginTop:8}}>{'\u0420\u0443\u0441\u043b\u0430\u043d \u0411\u0430\u0439\u0440\u0430\u043c\u043e\u0432, \u043e\u0441\u043d\u043e\u0432\u0430\u0442\u0435\u043b\u044c \u042d\u0442\u043d\u043e\u043c\u0438\u0440\u0430'}</div>
</div></div>{sent?<div style={{padding:'24px 20px 0'}}><div style={{borderRadius:16,background:'rgba(52,199,89,.06)',border:'1px solid rgba(52,199,89,.12)',padding:'28px 16px',textAlign:'center'}}><div style={{fontSize:36,marginBottom:4}}>{'\u2705'}</div><div style={{fontSize:17,fontWeight:700,color:'#34C759',fontFamily:FD}}>{'\u041e\u0442\u043f\u0440\u0430\u0432\u043b\u0435\u043d\u043e!'}</div><div style={{fontSize:13,color:L2,fontFamily:FT,marginTop:4}}>{'\u041c\u044b \u0441\u0432\u044f\u0436\u0435\u043c\u0441\u044f \u0441 \u0432\u0430\u043c\u0438.'}</div></div></div>
:<div style={{padding:'24px 20px 0'}}><div style={{background:'#fff',borderRadius:16,padding:20,textAlign:'center'}}>
<div style={{fontSize:22,fontWeight:800,fontFamily:FD,marginBottom:16}}>{'\u041e\u0441\u0442\u0430\u0432\u0438\u0442\u044c \u0437\u0430\u044f\u0432\u043a\u0443'}</div>
...
<div className="tap" onClick={submit} style={{height:50,borderRadius:16,background:B,display:'flex',alignItems:'center',justifyContent:'center',opacity:sending?.5:1}}><span style={{fontSize:17,fontWeight:600,color:'#fff',fontFamily:FT}}>{sending?'\u041e\u0442\u043f\u0440\u0430\u0432\u043a\u0430...':'\u041e\u0442\u043f\u0440\u0430\u0432\u0438\u0442\u044c \u0437\u0430\u044f\u0432\u043a\u0443'}</span></div>
</div></div>}
