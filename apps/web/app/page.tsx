...
function HomeTab({onBuyTicket,onSearch,onMap,onQR,onProfile,onFranchise,onLanding,onNav}:{onBuyTicket?:()=>void,onSearch?:()=>void,onMap?:()=>void,onQR?:()=>void,onProfile?:()=>void,onNav?:(t:string,s?:string)=>void,onFranchise?:()=>void,onLanding?:(s:string)=>void}) {
  ...
  const heroSvgs = [
`<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="a1" cx="70%" cy="25%"><stop offset="0%" stop-color="#FFD700" stop-opacity=".7"/><stop offset="100%" stop-color="transparent"/></radialGradient><linearGradient id="a2" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#FF6B9D" stop-opacity=".2"/><stop offset="50%" stop-color="#C084FC" stop-opacity=".15"/><stop offset="100%" stop-color="#22D3EE" stop-opacity=".2"/></linearGradient></defs><rect width="390" height="400" fill="url(#a2)"/><circle cx="310" cy="75" r="70" fill="url(#a1)"/><circle cx="195" cy="195" r="120" fill="none" stroke="#fff" stroke-width="1" stroke-dasharray="6 4" opacity=".3"><animateTransform attributeName="transform" type="rotate" from="0 195 195" to="360 195 195" dur="50s" repeatCount="indefinite"/></circle><circle cx="195" cy="195" r="95" fill="none" stroke="#fff" stroke-width=".8" stroke-dasharray="4 5" opacity=".2"><animateTransform attributeName="transform" type="rotate" from="360 195 195" to="0 195 195" dur="35s" repeatCount="indefinite"/></circle><circle cx="195" cy="195" r="145" fill="none" stroke="#fff" stroke-width=".5" stroke-dasharray="2 8" opacity=".15"><animateTransform attributeName="transform" type="rotate" from="0 195 195" to="360 195 195" dur="70s" repeatCount="indefinite"/></circle><ellipse cx="195" cy="195" rx="120" ry="50" fill="none" stroke="#fff" stroke-width=".6" opacity=".15"/><ellipse cx="195" cy="195" rx="50" ry="120" fill="none" stroke="#fff" stroke-width=".6" opacity=".15"/><ellipse cx="195" cy="195" rx="85" ry="120" fill="none" stroke="#fff" stroke-width=".4" opacity=".1" transform="rotate(30 195 195)"/><circle cx="140" cy="155" r="6" fill="#FFD700" opacity=".4"><animate attributeName="opacity" values=".2;.6;.2" dur="2.5s" repeatCount="indefinite"/><animate attributeName="r" values="4;7;4" dur="2.5s" repeatCount="indefinite"/></circle><circle cx="255" cy="170" r="5" fill="#FF6B9D" opacity=".35"><animate attributeName="opacity" values=".15;.55;.15" dur="3s" repeatCount="indefinite" begin=".5s"/><animate attributeName="r" values="3;6;3" dur="3s" repeatCount="indefinite" begin=".5s"/></circle><circle cx="170" cy="250" r="5" fill="#22D3EE" opacity=".3"><animate attributeName="opacity" values=".15;.5;.15" dur="3.5s" repeatCount="indefinite" begin="1s"/></circle><circle cx="240" cy="230" r="6" fill="#C084FC" opacity=".4"><animate attributeName="opacity" values=".2;.55;.2" dur="2.8s" repeatCount="indefinite" begin=".7s"/></circle><circle cx="195" cy="140" r="4" fill="#34D399" opacity=".35"><animate attributeName="opacity" values=".15;.55;.15" dur="2s" repeatCount="indefinite" begin="1.5s"/></circle><circle cx="120" cy="210" r="5" fill="#FB923C" opacity=".3"><animate attributeName="opacity" values=".1;.45;.1" dur="4s" repeatCount="indefinite" begin="2s"/></circle><path d="M0 330 Q40 300 80 320 Q120 280 170 310 Q210 285 250 312 Q290 288 340 315 Q365 305 390 325 L390 400 L0 400Z" fill="#fff" opacity=".08"/><rect x="45" y="290" width="20" height="40" rx="3" fill="#fff" opacity=".1"/><path d="M38 290 L55 268 L72 290Z" fill="#fff" opacity=".08"/><rect x="120" y="295" width="28" height="35" rx="2" fill="#fff" opacity=".08"/><circle cx="134" cy="282" r="14" fill="#fff" opacity=".06"/><rect x="230" y="288" width="22" height="42" rx="3" fill="#fff" opacity=".09"/><path d="M310 330 L322 275 L334 330Z" fill="#fff" opacity=".08"/><circle cx="40" cy="60" r="2" fill="#fff" opacity=".5"><animate attributeName="opacity" values=".2;.7;.2" dur="3s" repeatCount="indefinite"/></circle><circle cx="130" cy="45" r="1.5" fill="#fff" opacity=".4"><animate attributeName="opacity" values=".15;.6;.15" dur="4s" repeatCount="indefinite" begin="1s"/></circle><circle cx="360" cy="120" r="2" fill="#fff" opacity=".45"><animate attributeName="opacity" values=".1;.55;.1" dur="2.5s" repeatCount="indefinite" begin="2s"/></circle><circle cx="80" cy="130" r="1.5" fill="#fff" opacity=".35"><animate attributeName="opacity" values=".1;.5;.1" dur="5s" repeatCount="indefinite" begin=".5s"/></circle><circle cx="350" cy="50" r="1" fill="#fff" opacity=".3"><animate attributeName="opacity" values=".1;.5;.1" dur="3.5s" repeatCount="indefinite" begin="1.5s"/></circle><circle cx="20" cy="180" r="1.5" fill="#fff" opacity=".3"><animate attributeName="opacity" values=".1;.4;.1" dur="4.5s" repeatCount="indefinite" begin="3s"/></circle></svg>`,
`<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="b1" cx="82%" cy="15%"><stop offset="0%" stop-color="#E8D5B7" stop-opacity=".7"/><stop offset="100%" stop-color="transparent"/></radialGradient></defs><circle cx="335" cy="55" r="22" fill="#E8D5B7" opacity=".25"/><circle cx="335" cy="55" r="45" fill="url(#b1)"/><line x1="90" y1="40" x2="50" y2="70" stroke="#fff" stroke-width="1.5" stroke-linecap="round"><animate attributeName="opacity" values="0;0;.6;0;0" dur="6s" repeatCount="indefinite" begin="2s"/><animate attributeName="x1" values="90;40" dur="6s" repeatCount="indefinite" begin="2s"/><animate attributeName="y1" values="40;75" dur="6s" repeatCount="indefinite" begin="2s"/></line><rect x="15" y="160" width="70" height="240" rx="4" fill="#fff" opacity=".07"/><rect x="25" y="178" width="12" height="14" rx="2" fill="#FFD700" opacity=".15"><animate attributeName="opacity" values=".08;.3;.08" dur="4s" repeatCount="indefinite"/></rect><rect x="45" y="178" width="12" height="14" rx="2" fill="#FFD700" opacity=".25"><animate attributeName="opacity" values=".12;.35;.12" dur="5s" repeatCount="indefinite" begin="1s"/></rect><rect x="65" y="178" width="12" height="14" rx="2" fill="#FFD700" opacity=".18"/><rect x="25" y="205" width="12" height="14" rx="2" fill="#FFD700" opacity=".22"><animate attributeName="opacity" values=".1;.32;.1" dur="6s" repeatCount="indefinite" begin=".5s"/></rect><rect x="45" y="205" width="12" height="14" rx="2" fill="#FFD700" opacity=".12"/><rect x="65" y="205" width="12" height="14" rx="2" fill="#FFD700" opacity=".28"><animate attributeName="opacity" values=".12;.38;.12" dur="3.5s" repeatCount="indefinite" begin="2s"/></rect><rect x="25" y="232" width="12" height="14" rx="2" fill="#FFD700" opacity=".16"><animate attributeName="opacity" values=".08;.25;.08" dur="7s" repeatCount="indefinite" begin="1.5s"/></rect><rect x="65" y="232" width="12" height="14" rx="2" fill="#FFD700" opacity=".22"/><rect x="45" y="259" width="12" height="14" rx="2" fill="#FFD700" opacity=".2"><animate attributeName="opacity" values=".1;.3;.1" dur="4.5s" repeatCount="indefinite" begin="3s"/></rect><rect x="105" y="130" width="65" height="270" rx="4" fill="#fff" opacity=".06"/><rect x="115" y="148" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".2"><animate attributeName="opacity" values=".1;.3;.1" dur="4s" repeatCount="indefinite"/></rect><rect x="133" y="148" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".14"/><rect x="151" y="148" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".26"><animate attributeName="opacity" values=".12;.36;.12" dur="5.5s" repeatCount="indefinite" begin="1s"/></rect><rect x="115" y="175" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".18"/><rect x="133" y="175" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".24"><animate attributeName="opacity" values=".1;.34;.1" dur="4s" repeatCount="indefinite" begin="2s"/></rect><rect x="151" y="175" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".12"/><rect x="115" y="202" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".22"><animate attributeName="opacity" values=".1;.3;.1" dur="6s" repeatCount="indefinite" begin="3s"/></rect><rect x="151" y="202" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".18"/><rect x="195" y="190" width="58" height="210" rx="3" fill="#fff" opacity=".055"/><rect x="205" y="208" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".22"><animate attributeName="opacity" values=".1;.32;.1" dur="3s" repeatCount="indefinite" begin=".3s"/></rect><rect x="225" y="208" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".16"/><rect x="205" y="238" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".14"/><rect x="235" y="238" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".24"><animate attributeName="opacity" values=".1;.34;.1" dur="5s" repeatCount="indefinite" begin="1.5s"/></rect><rect x="275" y="215" width="55" height="185" rx="3" fill="#fff" opacity=".06"/><rect x="285" y="232" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".2"/><rect x="305" y="232" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".16"><animate attributeName="opacity" values=".08;.28;.08" dur="4s" repeatCount="indefinite" begin="2.5s"/></rect><rect x="315" y="260" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".22"><animate attributeName="opacity" values=".1;.32;.1" dur="3.5s" repeatCount="indefinite"/></rect><rect x="285" y="260" width="10" height="12" rx="1.5" fill="#FFD700" opacity=".18"/><rect x="350" y="245" width="40" height="155" rx="3" fill="#fff" opacity=".05"/><rect x="358" y="260" width="8" height="10" rx="1" fill="#FFD700" opacity=".2"><animate attributeName="opacity" values=".1;.3;.1" dur="5s" repeatCount="indefinite" begin="1s"/></rect><rect x="374" y="260" width="8" height="10" rx="1" fill="#FFD700" opacity=".15"/><circle cx="180" cy="120" r="3" fill="#FFD700" opacity=".3"><animate attributeName="cy" values="120;110;125;115;120" dur="8s" repeatCount="indefinite"/><animate attributeName="opacity" values=".15;.45;.15" dur="3s" repeatCount="indefinite"/></circle><circle cx="280" cy="100" r="2.5" fill="#FFD700" opacity=".25"><animate attributeName="cy" values="100;90;105;95;100" dur="7s" repeatCount="indefinite" begin="2s"/><animate attributeName="opacity" values=".1;.4;.1" dur="2.5s" repeatCount="indefinite" begin="1s"/></circle><circle cx="50" cy="100" r="2" fill="#FFD700" opacity=".2"><animate attributeName="cy" values="100;92;108;96;100" dur="9s" repeatCount="indefinite" begin="4s"/><animate attributeName="opacity" values=".1;.35;.1" dur="4s" repeatCount="indefinite" begin="2s"/></circle><path d="M0 380 Q100 365 200 375 Q300 365 390 378 L390 400 L0 400Z" fill="#fff" opacity=".04"/></svg>`,
`<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="c1" cx="55%" cy="45%"><stop offset="0%" stop-color="#FF9F43" stop-opacity=".2"/><stop offset="100%" stop-color="transparent"/></radialGradient></defs><circle cx="220" cy="210" r="140" fill="url(#c1)"/><ellipse cx="220" cy="255" rx="90" ry="30" fill="none" stroke="#fff" stroke-width="1.5" opacity=".25"/><ellipse cx="220" cy="255" rx="70" ry="22" fill="#fff" opacity=".05"/><ellipse cx="220" cy="248" rx="50" ry="15" fill="#fff" opacity=".03"/><path d="M185 210 Q190 175 184 140 Q180 115 186 90" stroke="#fff" stroke-width="3" fill="none" stroke-linecap="round" opacity=".2"><animate attributeName="d" values="M185 210 Q190 175 184 140 Q180 115 186 90;M185 210 Q192 170 182 135 Q178 108 188 82;M185 210 Q190 175 184 140 Q180 115 186 90" dur="3s" repeatCount="indefinite"/><animate attributeName="opacity" values=".1;.3;.1" dur="3s" repeatCount="indefinite"/></path><path d="M220 200 Q224 160 218 120 Q215 90 222 60" stroke="#fff" stroke-width="4" fill="none" stroke-linecap="round" opacity=".25"><animate attributeName="d" values="M220 200 Q224 160 218 120 Q215 90 222 60;M220 200 Q228 155 215 115 Q212 82 225 52;M220 200 Q224 160 218 120 Q215 90 222 60" dur="2.5s" repeatCount="indefinite" begin=".4s"/><animate attributeName="opacity" values=".12;.35;.12" dur="2.5s" repeatCount="indefinite" begin=".4s"/></path><path d="M255 210 Q250 178 258 145 Q262 118 256 88" stroke="#fff" stroke-width="2.5" fill="none" stroke-linecap="round" opacity=".18"><animate attributeName="d" values="M255 210 Q250 178 258 145 Q262 118 256 88;M255 210 Q248 172 260 140 Q265 110 254 80;M255 210 Q250 178 258 145 Q262 118 256 88" dur="3.5s" repeatCount="indefinite" begin=".8s"/><animate attributeName="opacity" values=".08;.28;.08" dur="3.5s" repeatCount="indefinite" begin=".8s"/></path><ellipse cx="65" cy="180" rx="40" ry="14" fill="none" stroke="#fff" stroke-width=".8" opacity=".12"/><ellipse cx="360" cy="195" rx="35" ry="12" fill="none" stroke="#fff" stroke-width=".8" opacity=".1"/><circle cx="140" cy="160" r="4" fill="#FF6B9D" opacity=".2"><animate attributeName="cy" values="160;148;165;152;160" dur="6s" repeatCount="indefinite"/><animate attributeName="opacity" values=".1;.3;.1" dur="3s" repeatCount="indefinite"/></circle><circle cx="300" cy="140" r="3.5" fill="#FFD700" opacity=".2"><animate attributeName="cy" values="140;130;145;135;140" dur="5s" repeatCount="indefinite" begin="1s"/><animate attributeName="opacity" values=".1;.3;.1" dur="2.5s" repeatCount="indefinite" begin="1s"/></circle><circle cx="100" cy="110" r="3" fill="#34D399" opacity=".15"><animate attributeName="cy" values="110;100;115;105;110" dur="7s" repeatCount="indefinite" begin="2s"/></circle><circle cx="330" cy="120" r="3" fill="#C084FC" opacity=".18"><animate attributeName="cy" values="120;108;125;112;120" dur="5.5s" repeatCount="indefinite" begin="3s"/></circle><circle cx="170" cy="90" r="2.5" fill="#FB923C" opacity=".2"><animate attributeName="cy" values="90;80;95;85;90" dur="8s" repeatCount="indefinite" begin="1.5s"/></circle><circle cx="260" cy="80" r="2" fill="#F43F5E" opacity=".15"><animate attributeName="cy" values="80;70;85;75;80" dur="6s" repeatCount="indefinite" begin="4s"/></circle><circle cx="120" cy="320" r="20" fill="#FF9F43" opacity=".06"><animate attributeName="r" values="15;25;15" dur="5s" repeatCount="indefinite"/></circle><circle cx="320" cy="310" r="18" fill="#FF9F43" opacity=".05"><animate attributeName="r" values="12;22;12" dur="4s" repeatCount="indefinite" begin="2s"/></circle></svg>`,
`<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="d1" cx="50%" cy="50%"><stop offset="0%" stop-color="#fff" stop-opacity=".12"/><stop offset="100%" stop-color="transparent"/></radialGradient></defs><circle cx="200" cy="200" r="120" fill="url(#d1)"/><ellipse cx="200" cy="270" rx="80" ry="24" fill="none" stroke="#fff" stroke-width="1.5" opacity=".2"/><ellipse cx="200" cy="270" rx="80" ry="24" fill="none" stroke="#fff" stroke-width="4" stroke-dasharray="8 12" opacity=".12"><animateTransform attributeName="transform" type="rotate" from="0 200 270" to="360 200 270" dur="3s" repeatCount="indefinite"/></ellipse><ellipse cx="200" cy="270" rx="55" ry="16" fill="none" stroke="#fff" stroke-width="2" stroke-dasharray="5 8" opacity=".1"><animateTransform attributeName="transform" type="rotate" from="360 200 270" to="0 200 270" dur="2s" repeatCount="indefinite"/></ellipse><path d="M175 270 Q178 230 182 200 Q190 175 200 168 Q210 175 218 200 Q222 230 225 270" fill="none" stroke="#fff" stroke-width="1.8" opacity=".2"/><ellipse cx="200" cy="198" rx="20" ry="6" fill="none" stroke="#fff" stroke-width=".8" opacity=".12"/><circle cx="80" cy="100" r="45" fill="none" stroke="#fff" stroke-width="1.5" stroke-dasharray="10 6" opacity=".15"><animateTransform attributeName="transform" type="rotate" from="0 80 100" to="360 80 100" dur="12s" repeatCount="indefinite"/></circle><circle cx="80" cy="100" r="28" fill="none" stroke="#fff" stroke-width="1" stroke-dasharray="5 5" opacity=".1"><animateTransform attributeName="transform" type="rotate" from="360 80 100" to="0 80 100" dur="8s" repeatCount="indefinite"/></circle><circle cx="340" cy="120" r="35" fill="none" stroke="#fff" stroke-width="1.2" stroke-dasharray="8 5" opacity=".12"><animateTransform attributeName="transform" type="rotate" from="360 340 120" to="0 340 120" dur="10s" repeatCount="indefinite"/></circle><circle r="6" fill="#C084FC" opacity=".3"><animateMotion dur="7s" repeatCount="indefinite" path="M200 200 Q300 130 340 200 Q300 280 200 200"/><animate attributeName="opacity" values=".15;.4;.15" dur="7s" repeatCount="indefinite"/></circle><circle r="5" fill="#FF6B9D" opacity=".25"><animateMotion dur="5.5s" repeatCount="indefinite" path="M200 200 Q100 270 60 200 Q100 120 200 200" begin="2s"/><animate attributeName="opacity" values=".1;.35;.1" dur="5.5s" repeatCount="indefinite" begin="2s"/></circle><circle r="4" fill="#FFD700" opacity=".2"><animateMotion dur="9s" repeatCount="indefinite" path="M200 200 Q270 100 350 170 Q320 300 200 200" begin="4s"/><animate attributeName="opacity" values=".1;.3;.1" dur="9s" repeatCount="indefinite" begin="4s"/></circle><circle r="5" fill="#22D3EE" opacity=".2"><animateMotion dur="6s" repeatCount="indefinite" path="M200 200 Q130 100 80 180 Q120 300 200 200" begin="1s"/><animate attributeName="opacity" values=".1;.3;.1" dur="6s" repeatCount="indefinite" begin="1s"/></circle><circle cx="50" cy="300" r="12" fill="#fff" opacity=".04"/><circle cx="350" cy="320" r="16" fill="#fff" opacity=".04"/><circle cx="300" cy="60" r="8" fill="#fff" opacity=".03"/></svg>`,
`<svg viewBox="0 0 390 400" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="e1" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#fff" stop-opacity=".08"/><stop offset="100%" stop-color="#fff" stop-opacity="0"/></linearGradient></defs><path d="M10 340 L70 295 L130 300 L195 248 L260 225 L325 168 L380 120 L390 115 L390 400 L0 400Z" fill="url(#e1)"/><polyline points="10,340 70,295 130,300 195,248 260,225 325,168 380,120" fill="none" stroke="#fff" stroke-width="3" opacity=".3"/><polyline points="10,355 70,330 130,332 195,298 260,282 325,245 380,215" fill="none" stroke="#fff" stroke-width="1" opacity=".1" stroke-dasharray="5 4"/><circle cx="70" cy="295" r="5" fill="#fff" opacity=".3"><animate attributeName="r" values="3;7;3" dur="3s" repeatCount="indefinite"/><animate attributeName="opacity" values=".15;.4;.15" dur="3s" repeatCount="indefinite"/></circle><circle cx="130" cy="300" r="4.5" fill="#fff" opacity=".25"><animate attributeName="r" values="3;6;3" dur="3.5s" repeatCount="indefinite" begin=".5s"/></circle><circle cx="195" cy="248" r="5" fill="#fff" opacity=".3"><animate attributeName="r" values="3;7;3" dur="2.8s" repeatCount="indefinite" begin="1s"/></circle><circle cx="260" cy="225" r="5.5" fill="#fff" opacity=".32"><animate attributeName="r" values="3.5;7.5;3.5" dur="3s" repeatCount="indefinite" begin="1.5s"/></circle><circle cx="325" cy="168" r="6" fill="#fff" opacity=".35"><animate attributeName="r" values="4;8;4" dur="2.5s" repeatCount="indefinite" begin="2s"/></circle><circle cx="380" cy="120" r="7" fill="#fff" opacity=".38"><animate attributeName="r" values="4;9;4" dur="2s" repeatCount="indefinite" begin="2.5s"/></circle><g opacity=".35"><line x1="380" y1="120" x2="390" y2="95" stroke="#fff" stroke-width="2.5"><animate attributeName="y2" values="105;85;105" dur="1.5s" repeatCount="indefinite"/></line><line x1="380" y1="120" x2="365" y2="102" stroke="#fff" stroke-width="2"><animate attributeName="y2" values="110;95;110" dur="1.5s" repeatCount="indefinite"/></line></g><rect x="30" y="350" width="40" height="50" rx="5" fill="#fff" opacity=".08"><animate attributeName="height" values="30;55;30" dur="4s" repeatCount="indefinite"/><animate attributeName="y" values="370;345;370" dur="4s" repeatCount="indefinite"/></rect><rect x="85" y="335" width="40" height="65" rx="5" fill="#fff" opacity=".07"><animate attributeName="height" values="45;70;45" dur="3.5s" repeatCount="indefinite" begin=".5s"/><animate attributeName="y" values="355;330;355" dur="3.5s" repeatCount="indefinite" begin=".5s"/></rect><rect x="140" y="318" width="40" height="82" rx="5" fill="#fff" opacity=".08"><animate attributeName="height" values="60;88;60" dur="4s" repeatCount="indefinite" begin="1s"/><animate attributeName="y" values="340;312;340" dur="4s" repeatCount="indefinite" begin="1s"/></rect><text x="360" y="95" fill="#fff" font-size="18" font-weight="700" font-family="system-ui" opacity=".22"><animate attributeName="opacity" values=".12;.3;.12" dur="3s" repeatCount="indefinite"/>22%</text><path d="M255 370 Q265 335 275 370" fill="#fff" opacity=".06"/><path d="M280 370 Q292 325 304 370" fill="#fff" opacity=".05"/><path d="M268 370 Q282 310 296 370" fill="#fff" opacity=".04"/></svg>`,
  ];
  const heroCards = [
