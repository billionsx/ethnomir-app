...
function CharityLandingV2({onClose}:{onClose:()=>void}){
...
<div style={{position:'relative',height:380,borderRadius:'0 0 20px 20px',overflow:'hidden'}}><img src="https://ethnomir.ru/upload/iblock/f94/1.jpg" alt="" style={{width:'100%',height:'100%',objectFit:'cover',position:'absolute',inset:0}}/><div style={{position:'absolute',inset:0,background:'linear-gradient(180deg,rgba(40,20,0,.2) 0%,rgba(30,10,0,.82) 100%)'}}/><div className="tap" onClick={onClose} style={{position:'absolute',top:54,left:16,width:36,height:36,borderRadius:22,...GL,display:'flex',alignItems:'center',justifyContent:'center',cursor:'pointer'}}><svg width="10" height="17" viewBox="0 0 10 17" fill="none"><path d="M9 1L1.5 8.5L9 16" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></div><div style={{position:'absolute',bottom:0,left:0,right:0,padding:'0 20px 28px'}}><div style={{display:'inline-flex',height:24,padding:'0 10px',borderRadius:12,lineHeight:'24px',...GL,background:'rgba(212,160,23,.75)',fontSize:11,fontWeight:700,color:'#fff',fontFamily:FT,letterSpacing:2,marginBottom:10}}>{'\u0424\u041e\u041d\u0414'}</div><div style={{fontSize:28,fontWeight:800,color:'#fff',fontFamily:FD,letterSpacing:'-1px',lineHeight:1.05,marginBottom:8}}>{'\u0414\u0438\u0430\u043b\u043e\u0433 \u041a\u0443\u043b\u044c\u0442\u0443\u0440 \u2014 \u0415\u0434\u0438\u043d\u044b\u0439 \u041c\u0438\u0440'}</div><div style={{fontSize:14,color:'rgba(255,255,255,.8)',fontFamily:FT,lineHeight:1.5}}>{'\u041c\u0435\u0436\u0434\u0443\u043d\u0430\u0440\u043e\u0434\u043d\u044b\u0439 \u0431\u043b\u0430\u0433\u043e\u0442\u0432\u043e\u0440\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0439 \u0444\u043e\u043d\u0434. \u0421 2005 \u0433\u043e\u0434\u0430.'}</div></div></div>
{/* METRICS */}
...
{/* DONATE */}
<div style={{padding:'16px 20px 0'}}><div style={{...GL,borderRadius:20,padding:20,textAlign:'center'}}><div style={{fontSize:32,marginBottom:4}}>{'\ud83d\udc9b'}</div><div style={{fontSize:22,fontWeight:800,fontFamily:FD,marginBottom:6}}>{'\u041f\u043e\u0434\u0434\u0435\u0440\u0436\u0430\u0442\u044c \u0444\u043e\u043d\u0434'}</div><div style={{fontSize:13,color:L2,fontFamily:FT,marginBottom:16}}>{'\u0412\u0430\u0448\u0435 \u043f\u043e\u0436\u0435\u0440\u0442\u0432\u043e\u0432\u0430\u043d\u0438\u0435 \u043f\u043e\u043c\u043e\u0433\u0430\u0435\u0442 \u0441\u043e\u0445\u0440\u0430\u043d\u044f\u0442\u044c \u043a\u0443\u043b\u044c\u0442\u0443\u0440\u044b \u043d\u0430\u0440\u043e\u0434\u043e\u0432 \u043c\u0438\u0440\u0430.'}</div>
<div style={{display:'flex',gap:8,justifyContent:'center',flexWrap:'wrap',marginBottom:16}}>{amounts.map((a:number,i:number)=><div key={i} className="tap" onClick={()=>setAmt(i)} style={{height:36,padding:'0 16px',borderRadius:12,lineHeight:'36px',fontSize:15,fontWeight:amt===i?700:400,fontFamily:FD,...(amt===i?{background:GOLD,color:'#fff'}:{...GL,color:L2}),cursor:'pointer',transition:'all .25s'}}>{a.toLocaleString()+' \u20bd'}</div>)}</div>
<div className="tap" onClick={()=>window.open('https://ethnoworld.ru/','_blank')} style={{height:50,borderRadius:16,background:GOLD,display:'flex',alignItems:'center',justifyContent:'center',cursor:'pointer'}}><span style={{fontSize:17,fontWeight:600,color:'#fff',fontFamily:FT}}>{'\u041f\u043e\u0436\u0435\u0440\u0442\u0432\u043e\u0432\u0430\u0442\u044c '+amounts[amt].toLocaleString()+' \u20bd'}</span></div>
<div style={{fontSize:11,color:L2,fontFamily:FT,marginTop:10}}>{'\u041f\u0435\u0440\u0435\u0445\u043e\u0434 \u043d\u0430 \u0441\u0430\u0439\u0442 \u0444\u043e\u043d\u0434\u0430 ethnoworld.ru'}</div>
</div></div>
{/* QUOTE */}
