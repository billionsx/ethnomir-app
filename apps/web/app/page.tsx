...
{/* BUTTON TO STAY TAB */}
<div style={{padding:'16px 20px 0'}}>{go&&<div className="tap" onClick={()=>go('tab:stay')} style={{...GL,borderRadius:20,padding:'16px 20px',display:'flex',alignItems:'center',gap:12,cursor:'pointer'}}><div style={{width:40,height:40,borderRadius:12,background:G+'12',display:'flex',alignItems:'center',justifyContent:'center',fontSize:20,flexShrink:0}}>{'\ud83c\udfe8'}</div><div style={{flex:1}}><div style={{fontSize:15,fontWeight:600,fontFamily:FD}}>{'\u0421\u043c\u043e\u0442\u0440\u0435\u0442\u044c \u043e\u0442\u0435\u043b\u0438 \u043f\u0430\u0440\u043a\u0430'}</div><div style={{fontSize:12,color:L2,fontFamily:FT,marginTop:1}}>{'\u0416\u0438\u043b\u044c\u0451 \u2192 \u041e\u0442\u0435\u043b\u0438'}</div></div><svg width="8" height="14" viewBox="0 0 8 14" fill="none"><path d="M1 1l6 6-6 6" stroke="rgba(60,60,67,.3)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></div>}</div>
{/* CTA */}
