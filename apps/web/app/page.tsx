        ...
        <div style={{padding:0}}>
          ...
          <div style={{padding:'20px'}}>
            ...
            {fullMenu.length===0 ? <div style={{padding:'20px',textAlign:'center'}}><Spinner/></div> : (
              <div style={{borderRadius:20,background:'rgba(255,255,255,.55)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'0.5px solid rgba(255,255,255,.4)',boxShadow:'0 0.5px 0 rgba(255,255,255,.7) inset, 0 2px 10px rgba(0,0,0,.04)',overflow:'hidden',boxShadow:'var(--shadow-sm)'}}>
...
<div style={{borderRadius:20,background:'rgba(255,255,255,.55)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'0.5px solid rgba(255,255,255,.4)',boxShadow:'0 0.5px 0 rgba(255,255,255,.7) inset, 0 2px 10px rgba(0,0,0,.04)',overflow:'hidden',marginBottom:12}}>
...
<div style={{borderRadius:20,background:'rgba(255,255,255,.55)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'0.5px solid rgba(255,255,255,.4)',boxShadow:'0 0.5px 0 rgba(255,255,255,.7) inset, 0 2px 10px rgba(0,0,0,.04)',overflow:'hidden'}}>
      ...
      <div style={{padding:"12px 0"}}>
        ...
        {view==='favorites'&&(
          <div style={{padding:'0 20px'}}>{(favs||[]).length===0?<div style={{textAlign:'center',padding:40}}><div style={{fontSize:48,marginBottom:8}}>❤️</div><div style={{fontSize:15,color:'var(--label2)',fontFamily:FT}}>Пусто</div></div>:
            <div style={{borderRadius:20,background:'rgba(255,255,255,.55)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'0.5px solid rgba(255,255,255,.4)',boxShadow:'0 0.5px 0 rgba(255,255,255,.7) inset, 0 2px 10px rgba(0,0,0,.04)',overflow:'hidden'}}>{favs.map((f:any,i:number)=>(
        ...
        {view==='settings'&&(
          <div style={{padding:'0 20px'}}>
            ...
            <div style={{borderRadius:20,background:'rgba(255,255,255,.55)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'0.5px solid rgba(255,255,255,.4)',boxShadow:'0 0.5px 0 rgba(255,255,255,.7) inset, 0 2px 10px rgba(0,0,0,.04)',overflow:'hidden',marginTop:12}}>
...
<input value={crmSearch} onChange={(e:any)=>crmGlobalSearch(e.target.value)} placeholder="Поиск по CRM..." style={{width:'100%',height:40,borderRadius:14,border:'0.5px solid rgba(255,255,255,.4)',padding:'0 14px 0 36px',fontSize:14,fontFamily:FT,background:'rgba(120,120,128,.06)',backdropFilter:'blur(20px)',WebkitBackdropFilter:'blur(20px)',color:'var(--label)',outline:'none'}}/>
...
<div style={{background:'rgba(120,120,128,.08)',borderRadius:12,padding:3,marginBottom:16,overflow:'auto',WebkitOverflowScrolling:'touch',backdropFilter:'blur(20px) saturate(150%)',WebkitBackdropFilter:'blur(20px) saturate(150%)',border:'0.5px solid rgba(0,0,0,.04)'}}>{[{k:'dashboard',l:'Главная',n:0},{k:'bookings',l:'Брони',n:(crmData.bookings||[]).filter((b:any)=>b.status==='pending'||b.status==='confirmed').length},{k:'reviews',l:'Отзывы',n:(crmData.reviews||[]).length},{k:'guests',l:'Гости',n:(crmData.guests||[]).length},{k:'finance',l:'Финансы',n:0},{k:'staff',l:'Стафф',n:(crmData.staff||[]).length}].map((t:any)=>(<div key={t.k} className="tap" onClick={()=>{setCrmSection(t.k);setCrmExpanded(null);}} style={{flex:'0 0 auto',padding:'6px 12px',borderRadius:8,fontSize:12,fontWeight:crmSection===t.k?600:400,fontFamily:FT,color:crmSection===t.k?'var(--label)':'var(--label2)',background:crmSection===t.k?'var(--bg2)':'transparent',transition:'all .2s',whiteSpace:'nowrap'}}>{t.l}{t.n>0&&<span style={{marginLeft:4,fontSize:10,fontWeight:600,color:crmSection===t.k?'#007AFF':'var(--label3)'}}>{t.n}</span>}</div>))}</div>
...
{(crmData.staff||[]).map((s:any,i:number)=>{const rc={owner:'#FF2D55',director:'#5856D6',manager:'#FF9500',staff:'#34C759'};const rl={owner:'Владелец',director:'Директор',manager:'Менеджер',staff:'Сотрудник'};const dl={all:'Все',hotels:'Отели',restaurants:'Рестораны',tours:'Экскурсии',support:'Поддержка',masterclasses:'МК',shop:'Магазин',admin:'Admin'};return(<div key={s.id||i} style={{borderRadius:20,background:'rgba(255,255,255,.55)',backdropFilter:'blur(30px) saturate(150%)',WebkitBackdropFilter:'blur(30px) saturate(150%)',border:'0.5px solid rgba(255,255,255,.4)',boxShadow:'0 1px 4px rgba(0,0,0,.03)',padding:'14px 16px',marginBottom:8}}>
...
<div style={{borderRadius:20,background:'rgba(255,255,255,.55)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'0.5px solid rgba(255,255,255,.4)',boxShadow:'0 0.5px 0 rgba(255,255,255,.7) inset, 0 2px 10px rgba(0,0,0,.04)',overflow:'hidden',marginBottom:16}}>
...
<div style={{borderRadius:20,background:'rgba(255,255,255,.55)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'0.5px solid rgba(255,255,255,.4)',boxShadow:'0 0.5px 0 rgba(255,255,255,.7) inset, 0 2px 10px rgba(0,0,0,.04)',overflow:'hidden',marginBottom:20}}>
    ...
    <div style={{paddingBottom:40}}>
      ...
      <div style={{fontSize:12,fontWeight:600,color:'var(--label3)',fontFamily:FT,textTransform:'uppercase',letterSpacing:'.5px',paddingLeft:16,marginBottom:6,marginTop:16}}>Инструменты</div>
        ...
        {showPro&&subPlans.filter((p:any)=>p.slug!=='free').length>0&&(
          <div style={{borderRadius:20,background:'rgba(255,255,255,.55)',backdropFilter:'blur(40px) saturate(180%)',WebkitBackdropFilter:'blur(40px) saturate(180%)',border:'0.5px solid rgba(255,255,255,.4)',boxShadow:'0 0.5px 0 rgba(255,255,255,.7) inset, 0 2px 10px rgba(0,0,0,.04)',overflow:'hidden',marginTop:8}}>
